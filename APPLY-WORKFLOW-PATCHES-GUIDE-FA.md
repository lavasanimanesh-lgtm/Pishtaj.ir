...
> ⚠️ **این راهنما منسوخ است (۲۰۲۶-۰۸-۲۸، v34.8.35).** نسخهٔ به‌روز و کامل‌تر:
> `WORKFLOW-T0-GATES-APPLY-GUIDE-2026-08-28.md` + پچ `_tools/PENDING-workflow-t0-gates-v34.8.35.patch`.
> گام «PHP syntax lint» که اینجا خواسته شده، همین حالا روی هر دو workflow وجود دارد؛
> آنچه مانده اجرای `run-ci-gate.js` + arch-guard **قبل از FTP** و بررسی صحت استقرار **بعد از FTP** است.
> متن زیر فقط برای تاریخچه نگه داشته شده است.
