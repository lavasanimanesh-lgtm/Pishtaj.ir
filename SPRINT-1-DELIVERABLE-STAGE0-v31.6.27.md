...
## الحاقیه hardening backup v31.6.27
...
## الحاقیه hardening Go-Live reset v31.6.27
...
## الحاقیه hardening codegen/AI/storage v31.6.27
...
## الحاقیه P0 CODEGEN-OFFER-SERVER

- offerSerial دیگر local max scan نیست؛
- server existing offers را برای counter scan می‌کند؛
- TMP به‌عنوان کد رسمی offer ذخیره نمی‌شود؛
- duplicate audit فقط خواندنی است؛
- repair کدهای موجود نیازمند backup و approval مستقل است.
