...
- `node --check crm/oppo.js`, `salesfiles.js`, `offers.js`, `procurement-link.js`, `surplus.js`, `backup.js`, `golive.js`, `salesfiles.js`, `fx.js`, `procurement-link.js`, `supplier-finance.js`: PASS
...
| regression evidence | PASS — ۱۵۳ فایل، ۳۷۵۲ چک، صفر FAIL |
...
## الحاقیه hardening backup v31.6.21
...
## الحاقیه hardening Go-Live reset v31.6.21
