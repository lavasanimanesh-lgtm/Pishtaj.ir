...
1. `BACKLOG-PRIORITIZED-CURRENT-v31.6.2.md`
   - backlog یکپارچه؛
   - خانواده‌بندی؛
   - شدت P0 تا P3؛
   - وضعیت واقعی بر اساس source و regression.
2. `STAGE-0-FIXTURE-SPEC-v31.6.2.json`
   - کاربران و دادهٔ مصنوعی؛
   - بدون secret و دادهٔ واقعی.
3. `STAGE-0-BASELINE-MANIFEST-v31.6.2.txt`
   - SHA-256 فایل‌های حساس baseline.
4. `REGRESSION-REPORT-CURRENT-v31.6.2.md`
