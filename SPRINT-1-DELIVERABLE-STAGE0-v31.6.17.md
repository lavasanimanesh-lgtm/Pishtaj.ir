...
- `node --check crm/oppo.js`, `salesfiles.js`, `offers.js`, `procurement-link.js`, `surplus.js`: PASS
...
| regression evidence | PASS — ۱۴۹ فایل، ۳۷۲۰ چک، صفر FAIL |
