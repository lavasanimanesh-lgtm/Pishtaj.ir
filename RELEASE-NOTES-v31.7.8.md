...
| 9 | `crm/index.html` | bump نسخه به v31.7.8 (71 cache-bust) | — |
| 10 | `crm/sw.js` | CACHE → `ptf-crm-v31.7.8` | — |
...
- `crm/index.html` — saveSet() merge, server-side auth_login for user login, version bump to v31.7.8
- `crm/sw.js` — cache name to ptf-crm-v31.7.8
