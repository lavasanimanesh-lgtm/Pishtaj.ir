# Current Regression Evidence — v31.6.2
...
- checks FAIL: 0
- runner exit code: 0
- runner-reported version: v31.6.2
- prebroken: none
- hung: none
...
`Done/Fixed` for the current release gate: **PASS candidate**.  
Production release of FIN-WF-001/auth changes remains blocked by Stage-0 policy/staging rules; this release does not advance that scope.  
Production ZIP: `pishtaj-release-v31.6.2.zip`.
