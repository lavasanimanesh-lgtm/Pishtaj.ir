...
- `node --check crm/oppo.js`, `salesfiles.js`, `offers.js`, `procurement-link.js`, `surplus.js`, `backup.js`, `golive.js`, `salesfiles.js`: PASS
...
| regression evidence | PASS — ۱۵۲ فایل، ۳۷۴۱ چک، صفر FAIL |
...
## الحاقیه hardening backup v31.6.20
...
## الحاقیه hardening Go-Live reset v31.6.20
