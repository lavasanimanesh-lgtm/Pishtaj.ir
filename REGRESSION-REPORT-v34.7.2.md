# گزارش رگرسیون کامل — v34.7.2

**تاریخ اجرا:** 2026-08-15T10:54:11.223Z
**نسخه کد:** v34.7.2
...
⚠️ **بدهی تاریخی سوئیت کامل پابرجاست؛ نسبت به baseline v34.7.1 شکست جدیدی ایجاد نشده است. گیت متمرکز ریلیز مستقل و سبز است.**

## تعهد بعدی

گیت متمرکز v34.7.2 (`run-ci-gate.js`) باید 26/26 سبز بماند؛ FAILهای تاریخی سوئیت کامل جداگانه باید نوسازی شوند.