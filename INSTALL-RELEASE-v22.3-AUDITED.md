# Install Guide — v22.3 Audited Flat Package
...
8. Open AI Workbench and confirm:
   ...
   - Technical Proposal Composer panel appears under the technical case when Gate conditions are satisfied
...
## Notes
- This release adds proposal draft generation and versioning.
- PDF output is through the internal print-preview / browser save-PDF flow.
- DOCX output is provided through a dedicated server export endpoint.
