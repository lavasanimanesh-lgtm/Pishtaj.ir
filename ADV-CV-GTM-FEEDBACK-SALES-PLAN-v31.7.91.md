...
## تکمیل اجرایی v31.7.91

داشبورد KPI قیف ابزار کنترل ولو اضافه شد. این داشبورد فعلاً داده‌های server-side feedback/draft/license را تحلیل می‌کند و برای page_view/click server sync نیازمند فاز privacy-aware metrics است.
