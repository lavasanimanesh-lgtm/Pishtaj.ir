# گزارش رگرسیون کامل — v34.7.4

**تاریخ اجرا:** 2026-08-15T12:34:38.236Z
**نسخه کد:** v34.7.4
...
⚠️ **بدهی تاریخی سوئیت کامل پابرجاست؛ نسبت به baseline v34.7.3 شکست جدیدی ایجاد نشده است. گیت متمرکز ریلیز مستقل و سبز است.**

## تعهد بعدی

گیت متمرکز v34.7.4 (`run-ci-gate.js`) باید 28/28 سبز بماند؛ FAILهای تاریخی سوئیت کامل جداگانه باید نوسازی شوند.