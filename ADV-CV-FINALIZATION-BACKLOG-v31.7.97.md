...
## تکمیل تکمیلی v31.7.92

### PRIVACY-METRICS-SERVER-SYNC-001
ارسال aggregate و privacy-aware metrics برای page view و کلیک‌های مهم اضافه شد. داده‌های sid، label، href، title و query string ارسال نمی‌شوند. KPI dashboard اکنون landing views، sample clicks و feedback opens را از server aggregate می‌خواند.


## تکمیل تکمیلی v31.7.93

### ADV-CV-RICH-SAMPLE-BRAND-MATRIX-001
نمونه عمومی گزارش نهایی کامل‌تر شد و شامل نمودارهای SVG، matrix برند/سری، لینک رسمی برندها، actuator shell، engineering validation و vendor validation گردید. گزارش واقعی نیز Brand / Series Candidate Matrix دریافت کرد.


## تکمیل نگهداری v31.7.94

### BUG-OFFER-DUP-ITEMS-SETTINGS-ACCORDION-001
باگ تکرار اقلام پیشنهاد ریشه‌کنی شد: offLoadInqItems و offSmartInsert idempotent شدند و offerSave نیز dedupe نهایی انجام می‌دهد. همچنین Settings به accordion فشرده تبدیل شد.


## تکمیل نگهداری v31.7.95

### BUG-FINANCE-SUPPLIER-CONSISTENCY-UI-001
گزارش رسمی مالی با حساب تأمین‌کنندگان همسان شد؛ legacyهای لینک‌شده دوباره‌شماری نمی‌شوند. کارت‌های هاب مالی برای اعداد بزرگ و تنظیمات در حالت شب اصلاح شدند.


## تکمیل نگهداری v31.7.96

### BUG-SYNC-TOMBSTONE-OPPO-LINECHART-001
Tombstone عمومی برای sync اضافه شد تا رکورد حذف‌شده با cache دستگاه دیگر برنگردد. فرصت‌های مالی با همه CO/TC بازنده از active opportunities حذف می‌شوند. گزارش کنترل ولو line chart دریافت کرد.


## تکمیل نگهداری v31.7.97

### BUG-FISCAL-PROFIT-ICON-UX-001
فرمول سود هاب مالی بازنگری شد: هزینه مستقیم پروژه و تنخواه مستقل در سود خالص مدیریتی لحاظ می‌شوند. خوانایی گزارش رسمی در حالت شب و آیکون‌های مینیمال وب‌سایت/هاب مالی اصلاح شد.
