...
- `node --check crm/oppo.js`, `salesfiles.js`, `offers.js`, `procurement-link.js`, `surplus.js`, `backup.js`, `golive.js`: PASS
...
| regression evidence | PASS — ۱۵۱ فایل، ۳۷۳۲ چک، صفر FAIL |
...
## الحاقیه hardening backup v31.6.19
...
## الحاقیه hardening Go-Live reset v31.6.19
