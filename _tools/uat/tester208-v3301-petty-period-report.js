...
T('دکمه‌های گزارش در renderPeriods (بازه/ماه) و تولبار هست', code.indexOf('ptfPettyPeriodReport') > -1 && code.indexOf('ptfPettyPeriodCombinedPdf') > -1 && code.indexOf('📊 گزارش دورهٔ جاری') > -1 && code.indexOf('var rng = (p.from && p.to)') > -1);
