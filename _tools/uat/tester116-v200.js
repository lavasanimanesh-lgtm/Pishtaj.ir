...
SECTION('نسخه و ثبت');
T('نسخه v20.0+', (function () { var m = idx.match(/window.PTF_CRM_RELEASE = 'v([0-9.]+)'/); return m && parseFloat(m[1]) >= 20.0; })());
T('کش sw >= v20.0', (function () { var m = sw.match(/var RELEASE = 'v([0-9.]+)'/); return m && parseFloat(m[1]) >= 20.0; })());
