...
SECTION('نسخه و ثبت');
T('نسخه v20.1+', (function () { var m = idx.match(/window.PTF_CRM_RELEASE = 'v([0-9.]+)'/); return m && parseFloat(m[1]) >= 20.1; })());
T('کش sw >= v20.1', (function () { var m = sw.match(/var RELEASE = 'v([0-9.]+)'/); return m && parseFloat(m[1]) >= 20.1; })());
