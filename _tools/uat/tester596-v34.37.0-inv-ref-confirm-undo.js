#!/usr/bin/env node
'use strict';
/* ═══ tester596 — v34.37.2 (INV-REF-CONFIRM + INV-REF-UNDO) ═══
...
/* v34.37.2: پنل زندهٔ فاکتورها official-invoice-v2.js است (rbac.js بازنویسی می‌شود).
   دکمه در v34.37.2 اشتباهاً در کد مردهٔ rbac.js گذاشته شده بود و دیده نمی‌شد. */
...
console.log('\n— tester596 (v34.37.2: تایید پیش از ارجاع فاکتور + لغو ارجاع) —');
