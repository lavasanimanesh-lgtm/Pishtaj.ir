#!/usr/bin/env node
'use strict';
/* tester584 — v34.38.0 (FX-RIAL-REF): «پرونده‌ای که پیشنهاد برنده‌اش ارزی است و یک
...
/* ── برش خود تابع ارجاع (از تعریف تا کامیتِ موفقیتِ مسیر عادی) ──
   v34.38.0 (INV-REF-CONFIRM): منطق حل‌وفصل به sfInvoiceRefPlan منتقل شد و
...
(function () {
  ...
  /* v34.38.0: انتخاب سند ریالی «تاییدِ ارجاع» نیست — مودال تایید با همان شماره باز
