#!/usr/bin/env node
'use strict';
/* tester584 — v34.37.8 (FX-RIAL-REF): «پرونده‌ای که پیشنهاد برنده‌اش ارزی است و یک
...
/* ── برش خود تابع ارجاع (از تعریف تا کامیتِ موفقیتِ مسیر عادی) ──
   v34.37.8 (INV-REF-CONFIRM): منطق حل‌وفصل به sfInvoiceRefPlan منتقل شد و
...
(function () {
  ...
  /* v34.37.8: انتخاب سند ریالی «تاییدِ ارجاع» نیست — مودال تایید با همان شماره باز
