#!/usr/bin/env node
'use strict';
/* tester520 — v34.8.19 (T0/T1 قراردادهای رودمپ نازک‌سازی):
...
T('نسخهٔ UI = v34.8.19', /window\.PTF_CRM_RELEASE = 'v34\.8\.19'/.test(idx));
var swv = read('crm/sw.js');
T('قرارداد sw/index هم‌نسخه', /CACHE = 'ptf-crm-v34\.8\.19'/.test(swv) && idx.indexOf('?v=34.8.19') > -1);

console.log('\n— tester520 (v34.8.19: T0/T1 thin-client contracts) —');
