/* tester355 — v34.4.61 petty period sort + combined attachments */
(function () {
  var fs = require('fs');
  ...
  ok(ver.crm_version === 'v34.4.61', 'VERSION ' + ver.crm_version);
  ok(idx.indexOf("PTF_CRM_RELEASE = 'v34.4.61'") > -1, 'index release');
