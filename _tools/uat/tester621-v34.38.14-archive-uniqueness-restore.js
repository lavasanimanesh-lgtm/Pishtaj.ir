'use strict';
/* ─────────────────────────────────────────────────────────────────────────────
   tester621 — v34.38.16 (ARCHIVE-UNIQUENESS + RESTORE)
...
setTimeout(function () {
  ...
  test('نسخهٔ انتشار هم‌تراز است', version === 'v34.38.20', version);
  test('cache-buster در index.html به‌روز است', indexHtml.indexOf('salesfiles.js?v=34.38.20') > -1);
  test('Service Worker به‌روز است', sw.indexOf("v34.38.20") > -1);

  console.log('');
  if (failures) { console.log('=== tester621: ' + failures + ' FAIL ==='); process.exit(1); }
  console.log('PASS tester621-v34.38.16-archive-uniqueness-restore');
}, 60);
