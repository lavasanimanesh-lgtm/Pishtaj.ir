...
setTimeout(function () {
  ...
  test('نسخهٔ انتشار هم‌تراز است', version === 'v34.39.21', version);
  test('cache-buster در index.html به‌روز است', indexHtml.indexOf('salesfiles.js?v=34.39.21') > -1);
  test('Service Worker به‌روز است', sw.indexOf("v34.39.21") > -1);
