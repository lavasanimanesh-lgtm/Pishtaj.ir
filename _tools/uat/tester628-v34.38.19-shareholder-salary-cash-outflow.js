/* tester628 — v34.39.21 (SH-SALARY-CASH-OUTFLOW): پرداخت واقعی حقوق (draw با
...
console.log('── salary cash-outflow contract (v34.39.21) ──');
/* قرارداد استاتیک کد */
...
console.log('PASS tester628 v34.39.21 shareholder salary cash outflow');
