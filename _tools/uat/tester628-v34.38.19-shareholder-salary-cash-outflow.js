/* tester628 — v34.39.0 (SH-SALARY-CASH-OUTFLOW): پرداخت واقعی حقوق (draw با
...
console.log('── salary cash-outflow contract (v34.39.0) ──');
/* قرارداد استاتیک کد */
...
console.log('PASS tester628 v34.39.0 shareholder salary cash outflow');
