#!/usr/bin/env node
'use strict';
/* v34.7.86 — ورود اجباری با توکن سرور (AUTH-TOKEN-REQUIRED).
...
T('inqreader.js cache-bust 34.7.86', /inqreader\.js\?v=34\.7\.86/.test(idx));
...
T('tester486 در گیت CI', gate.indexOf('tester486-v34.7.86-auth-token-required.js') > -1);

console.log('\n— tester486 (v34.7.86: ورود اجباری توکن سرور — AUTH-TOKEN-REQUIRED) —');
