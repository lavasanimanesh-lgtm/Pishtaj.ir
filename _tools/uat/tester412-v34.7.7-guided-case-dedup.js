...
T('تعارض هویت درخواست/مشتری/ارز fail-closed است',merge.indexOf('case_identity_conflict')>-1&&(merge.indexOf('sd_case_identity_conflict')>-1||api.indexOf("['inqNo','buyerCd','currency']")>-1));
