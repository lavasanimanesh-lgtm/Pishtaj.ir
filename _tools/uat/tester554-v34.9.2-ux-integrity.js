#!/usr/bin/env node
'use strict';
/* tester554 — v34.16.0: اصلاحات یکپارچگی داده + UX (درخواست مالک ۲۰۲۶-۰۸-۳۱)
...
T('D: ردیف پیشنهاد نام انگلیسی زیر خریدار', of.indexOf("ptfCustEnByCd(o.buyerCd) : ''; return (en && en !== o.buyerCo)") > -1);
