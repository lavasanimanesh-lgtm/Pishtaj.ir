#!/usr/bin/env node
'use strict';
/* tester554 — v34.29.3: اصلاحات یکپارچگی داده + UX (درخواست مالک ۲۰۲۶-۰۸-۳۱)
...
T('D: ردیف پیشنهاد نام انگلیسی زیر خریدار', of.indexOf('ptfCustNamePair(o.buyerCd, o.buyerCo)') > -1 && of.indexOf('ptfCustCellHtml(p.fa, p.en, o.buyerCd)') > -1); /* v34.29.3: سلول دوگانه فارسی+انگلیسی */
