...
if (!phpBin) {
  ...
  // v34.39.20: خودکفایی محیطی — secret به مسیر کنترل‌شدهٔ همین تست (نه بقیه‌ماندهٔ /tmp):
  ...
  (async function () {
    try {
      ...
      /* v34.39.20: قرارداد runtime — auth_login رمز متن‌ساده می‌گیرد (فیلد password) و
