#!/usr/bin/env node
'use strict';
/* tester558 — v34.35.0: S2-id مولد صفحهٔ عمومی + فیکس‌های توسعه‌ای سئو + زیرمنوی مدیریت سایت
...
/* v34.35.0: رندر به cms_render_public_page منتقل شد (مشترک با زمان‌بند S4) — پنجرهٔ انکر هم‌مسیر شد */
...
T('GEN: قالب از اسکلت مرکز دانش', PG.indexOf('cms_kc_skeleton($ROOT)') > -1); /* v34.35.0: هِلپر مشترک */
