...
T('window.VER هم >= v18.1', (function(){var m=idx.match(/window\.PTF_CRM_RELEASE = 'v([0-9.]+)'/),v=idx.match(/window\.VER = (?:window\.PTF_CRM_RELEASE|'v([0-9.]+)')/);return m&&parseFloat(m[1])>=18.1&&v&&idx.indexOf('var VER = window.PTF_CRM_RELEASE')>-1;})());
