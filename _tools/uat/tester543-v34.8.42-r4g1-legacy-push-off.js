#!/usr/bin/env node
'use strict';
/* tester543 — v34.14.0 (R4-گام۱ — RETIRE-LEGACY-SYNC): پرچم PTF_LEGACY_PUSH_OFF
...
function makeCtx() {
  ...
  var ctx = {
    ...
    ptfAuthToken: function () { return 'tok'; }, ptfAuthOk: function () { return true; }, /* v34.14.0 (R5/T4-1b): لایهٔ نشست جدید */
...
function finish() {
  console.log('\n— tester543 (v34.14.0: R4-گام۱ — پرچم PTF_LEGACY_PUSH_OFF + داشبورد تصمیم) —');
