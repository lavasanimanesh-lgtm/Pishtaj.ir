...
T('۵.۱ VERSION.json = v34.38.9', ver.crm_version === 'v34.38.9', ver.crm_version);
T('۵.۲ tester612 در run-ci-gate.js ثبت است', gate.indexOf('tester612-v34.38.5-shareholder-salary-official.js') > -1);
T('۵.۳ قرارداد UI/sw = 34.38.9',
  /window\.PTF_CRM_RELEASE = 'v34\.38\.9'/.test(idx) &&
  /CACHE = 'ptf-crm-v34\.38\.9'/.test(read('crm/sw.js')));
T('۵.۴ SD_SERVICE_VERSION = 34.38.9', /SD_SERVICE_VERSION = '34\.38\.9'/.test(php));
