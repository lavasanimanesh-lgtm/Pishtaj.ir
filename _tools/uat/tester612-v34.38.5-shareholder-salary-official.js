...
T('۵.۱ VERSION.json = v34.38.8', ver.crm_version === 'v34.38.8', ver.crm_version);
T('۵.۲ tester612 در run-ci-gate.js ثبت است', gate.indexOf('tester612-v34.38.5-shareholder-salary-official.js') > -1);
T('۵.۳ قرارداد UI/sw = 34.38.8',
  /window\.PTF_CRM_RELEASE = 'v34\.38\.8'/.test(idx) &&
  /CACHE = 'ptf-crm-v34\.38\.8'/.test(read('crm/sw.js')));
T('۵.۴ SD_SERVICE_VERSION = 34.38.8', /SD_SERVICE_VERSION = '34\.38\.8'/.test(php));
