...
/* tester496 — UAT پایانی «ارزش افزوده فصلی» (VAT-LEDGER-003)
   معرفی‌شده در v34.7.94؛ در v34.7.101 با بامپ پین نسخه هم‌روز شد.
...
/* ============ E2: تاریخ ISO میلادی خام باید کاملاً رد شود (VAT-LEDGER-004) ============
   قبل از v34.7.101: تاریخ '2026-06-15T10:00:00Z' به year='2026-06-15T10:00:00Z'
   و season=2 map می‌شد — یک سال جعلی که در گزارش سال ۱۴۰۵ گم می‌شد (باگ خاموش).
   بعد از v34.7.101: null برمی‌گرداند — رفتار قابل پیش‌بینی. */
reset();
sb = makeSb();
...
console.log('\n— tester496 (v34.7.101: UAT پایانی VAT فصلی — VAT-LEDGER-003) —');
