...
T('index.html PTF_CRM_RELEASE = v34.8.34', /window\.PTF_CRM_RELEASE = 'v34\.8\.34'/.test(read('crm/index.html')));
T('sw.js RELEASE = v34.8.34', /RELEASE = 'v34\.8\.34'/.test(read('crm/sw.js')));
