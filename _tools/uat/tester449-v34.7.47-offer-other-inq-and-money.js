#!/usr/bin/env node
'use strict';
/* v34.8.5 — دکمهٔ مجزای «بارگذاری از درخواست دیگر» + جداکننده هزارگان /
...
T('index.html PTF_CRM_RELEASE = v34.8.5', /window\.PTF_CRM_RELEASE = 'v34\.8\.5'/.test(read('crm/index.html')));
T('sw.js RELEASE = v34.8.5', /RELEASE = 'v34\.8\.5'/.test(read('crm/sw.js')));
...
console.log('\n— tester449 (v34.8.5: درخواست دیگر + مبالغ مودال پیشنهاد) —');
