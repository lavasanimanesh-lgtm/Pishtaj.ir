#!/usr/bin/env node
'use strict';
/* v34.7.86 — دکمهٔ مجزای «بارگذاری از درخواست دیگر» + جداکننده هزارگان /
...
T('index.html PTF_CRM_RELEASE = v34.7.86', /window\.PTF_CRM_RELEASE = 'v34\.7\.86'/.test(read('crm/index.html')));
T('sw.js RELEASE = v34.7.86', /RELEASE = 'v34\.7\.86'/.test(read('crm/sw.js')));
...
console.log('\n— tester449 (v34.7.86: درخواست دیگر + مبالغ مودال پیشنهاد) —');
