#!/usr/bin/env node
'use strict';
/* v34.8.16 — دکمهٔ مجزای «بارگذاری از درخواست دیگر» + جداکننده هزارگان /
...
T('index.html PTF_CRM_RELEASE = v34.8.16', /window\.PTF_CRM_RELEASE = 'v34\.8\.16'/.test(read('crm/index.html')));
T('sw.js RELEASE = v34.8.16', /RELEASE = 'v34\.8\.16'/.test(read('crm/sw.js')));
...
console.log('\n— tester449 (v34.8.16: درخواست دیگر + مبالغ مودال پیشنهاد) —');
