#!/usr/bin/env node
'use strict';
/* v34.7.47 — دکمهٔ مجزای «بارگذاری از درخواست دیگر» + جداکننده هزارگان /
...
/* ---------- نسخه ---------- */
T('VERSION.json = v34.7.47', ver.crm_version === 'v34.7.47', ver.crm_version);
T('index.html PTF_CRM_RELEASE = v34.7.47', /window\.PTF_CRM_RELEASE = 'v34\.7\.47'/.test(read('crm/index.html')));
T('sw.js RELEASE = v34.7.47', /RELEASE = 'v34\.7\.47'/.test(read('crm/sw.js')));
...
console.log('\n— tester449 (v34.7.47: درخواست دیگر + مبالغ مودال پیشنهاد) —');
