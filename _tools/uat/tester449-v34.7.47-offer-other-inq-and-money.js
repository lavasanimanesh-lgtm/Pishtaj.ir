#!/usr/bin/env node
'use strict';
/* v34.8.4 — دکمهٔ مجزای «بارگذاری از درخواست دیگر» + جداکننده هزارگان /
...
T('index.html PTF_CRM_RELEASE = v34.8.4', /window\.PTF_CRM_RELEASE = 'v34\.8\.4'/.test(read('crm/index.html')));
T('sw.js RELEASE = v34.8.4', /RELEASE = 'v34\.8\.4'/.test(read('crm/sw.js')));
...
console.log('\n— tester449 (v34.8.4: درخواست دیگر + مبالغ مودال پیشنهاد) —');
