...
T('index.html PTF_CRM_RELEASE = v34.38.0', /window\.PTF_CRM_RELEASE = 'v34\.38\.0'/.test(read('crm/index.html')));
T('sw.js RELEASE = v34.38.0', /RELEASE = 'v34\.38\.0'/.test(read('crm/sw.js')));
