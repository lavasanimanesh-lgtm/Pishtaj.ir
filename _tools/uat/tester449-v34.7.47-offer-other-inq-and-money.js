...
T('index.html PTF_CRM_RELEASE = v34.38.21', /window\.PTF_CRM_RELEASE = 'v34\.38\.21'/.test(read('crm/index.html')));
T('sw.js RELEASE = v34.38.21', /RELEASE = 'v34\.38\.21'/.test(read('crm/sw.js')));
