#!/usr/bin/env node
'use strict';
/* v34.8.11 — دکمهٔ مجزای «بارگذاری از درخواست دیگر» + جداکننده هزارگان /
...
T('index.html PTF_CRM_RELEASE = v34.8.11', /window\.PTF_CRM_RELEASE = 'v34\.8\.11'/.test(read('crm/index.html')));
T('sw.js RELEASE = v34.8.11', /RELEASE = 'v34\.8\.11'/.test(read('crm/sw.js')));
...
console.log('\n— tester449 (v34.8.11: درخواست دیگر + مبالغ مودال پیشنهاد) —');
