...
T('index.html PTF_CRM_RELEASE = v34.39.23', /window\.PTF_CRM_RELEASE = 'v34\.39\.23'/.test(read('crm/index.html')));
T('sw.js RELEASE = v34.39.23', /RELEASE = 'v34\.39\.23'/.test(read('crm/sw.js')));
