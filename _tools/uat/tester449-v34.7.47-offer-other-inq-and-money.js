...
T('index.html PTF_CRM_RELEASE = v34.39.3', /window\.PTF_CRM_RELEASE = 'v34\.39\.3'/.test(read('crm/index.html')));
T('sw.js RELEASE = v34.39.3', /RELEASE = 'v34\.39\.3'/.test(read('crm/sw.js')));
