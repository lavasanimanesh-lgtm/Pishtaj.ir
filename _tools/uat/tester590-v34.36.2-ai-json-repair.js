/* =====================================================================
   tester590 — v34.36.3 (AI-JSON-REPAIR): «خروجی AI ساختار JSON معتبر ندارد
...
(function () {
  ...
  /* v34.36.3: مهاجرت فقط برای اکشن‌های JSONِ سئو بود. این شمار قفل می‌کند که مسیرهای
...
console.log('\n── ۷) بهداشت ──');
(function () {
  T('۷.۱ VERSION.json = v34.36.3', ver.crm_version === 'v34.36.3', ver.crm_version);
  T('۷.۲ tester590 در گیت CI ثبت شده است', gate.indexOf('tester590-v34.36.2-ai-json-repair.js') > -1);
  T('۷.۳ یادداشت انتشار این نسخه موجود است', fs.existsSync('RELEASE-NOTES-v34.36.3.md'));
...
console.log('\n— tester590 (v34.36.3: ریشه‌کنی خطای JSON هوش مصنوعی — AI-JSON-REPAIR) —');
