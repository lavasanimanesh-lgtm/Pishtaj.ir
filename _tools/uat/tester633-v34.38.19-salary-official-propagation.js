/* tester633 — v34.38.21 (DATA-QUALITY SH-SALARY-FIX — گزارش کارفرما: «تب کیفیت داده
...
console.log('── salary-official cross-month propagation (v34.38.21) ──');
...
console.log('PASS tester633 v34.38.21 salary-official cross-month propagation');
