/* tester633 — v34.39.11 (DATA-QUALITY SH-SALARY-FIX — گزارش کارفرما: «تب کیفیت داده
...
console.log('── salary-official cross-month propagation (v34.39.11) ──');
...
console.log('PASS tester633 v34.39.11 salary-official cross-month propagation');
