/* tester633 — v34.39.4 (DATA-QUALITY SH-SALARY-FIX — گزارش کارفرما: «تب کیفیت داده
...
console.log('── salary-official cross-month propagation (v34.39.4) ──');
...
console.log('PASS tester633 v34.39.4 salary-official cross-month propagation');
