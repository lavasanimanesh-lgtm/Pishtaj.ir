/* tester633 — v34.39.27 (DATA-QUALITY SH-SALARY-FIX — گزارش کارفرما: «تب کیفیت داده
...
console.log('── salary-official cross-month propagation (v34.39.27) ──');
...
console.log('PASS tester633 v34.39.27 salary-official cross-month propagation');
