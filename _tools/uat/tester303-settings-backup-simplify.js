...
T('جعبهٔ وضعیت دستگاه (v34.27.0): انتقال یک‌باره + پاک‌سازی کش — بدون دکمهٔ خاموش/روشن قدیمی',
...
T('عنوان وضعیت دستگاه با نشان 🖥 و دو حالت روشن/در انتظار (v34.27.0)', bak.indexOf('🖥 وضعیت دستگاه: سرور-محور فعال') > -1 && bak.indexOf('🖥 وضعیت دستگاه: در انتظار انتقال یک‌باره') > -1);
T('راهنمای اعلان پاک‌سازی به جعبهٔ وضعیت دستگاه ارجاع می‌دهد (v34.27.0)',
