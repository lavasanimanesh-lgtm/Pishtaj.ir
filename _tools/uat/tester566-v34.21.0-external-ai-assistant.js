#!/usr/bin/env node
'use strict';
/* tester566 — v34.29.4: دستیار هوش مصنوعی خارجی
...
T('PRM: صفحه — موضوع از فرم + بخش + مخاطب + گیت موضوع خالی', PGP.indexOf("g('pgTopic') || g('pgTitle')") > -1 && PGP.indexOf('folderLb') > -1 && PGP.indexOf('مخاطب: ') > -1 && PGP.indexOf('ابتدا «موضوع برای AI»') > -1);
...
T('APPLY: گیت خروجی بی‌نشانگر با پیام فارسی', PGA.indexOf('نشانگرها پیدا نشد') > -1 && cms.indexOf('window.cmsExtErr = function') > -1); /* v34.29.4: پیام درون‌مودال به‌جای alert */
