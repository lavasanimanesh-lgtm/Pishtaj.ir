#!/usr/bin/env node
'use strict';
/* tester566 — v34.30.0: دستیار هوش مصنوعی خارجی
...
T('APPLY: گیت خروجی بی‌نشانگر با پیام فارسی', PGA.indexOf('نشانگرها پیدا نشد') > -1 && cms.indexOf('window.cmsExtErr = function') > -1); /* v34.30.0: پیام درون‌مودال به‌جای alert */
