#!/usr/bin/env node
'use strict';
/* v34.24.0 — مبنای ریالی ارجاع فاکتور به حسابدار.
...
T('salesfiles.js cache-bust 34.24.0', /salesfiles\.js\?v=34\.24.0/.test(idx));
T('official-invoice-v2.js cache-bust 34.24.0', /official-invoice-v2\.js\?v=34\.24.0/.test(idx));
...
console.log('\n— tester478 (v34.24.0: مبنای ریالی ارجاع فاکتور به حسابدار) —');
