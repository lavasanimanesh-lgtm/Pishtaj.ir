#!/usr/bin/env node
'use strict';
/* v34.26.1 — مبنای ریالی ارجاع فاکتور به حسابدار.
...
T('salesfiles.js cache-bust 34.26.1', /salesfiles\.js\?v=34\.26.1/.test(idx));
T('official-invoice-v2.js cache-bust 34.26.1', /official-invoice-v2\.js\?v=34\.26.1/.test(idx));
...
console.log('\n— tester478 (v34.26.1: مبنای ریالی ارجاع فاکتور به حسابدار) —');
