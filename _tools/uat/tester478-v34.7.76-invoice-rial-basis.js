#!/usr/bin/env node
'use strict';
/* v34.7.92 — مبنای ریالی ارجاع فاکتور به حسابدار.
...
T('salesfiles.js cache-bust 34.7.92', /salesfiles\.js\?v=34\.7\.92/.test(idx));
T('official-invoice-v2.js cache-bust 34.7.92', /official-invoice-v2\.js\?v=34\.7\.92/.test(idx));
...
console.log('\n— tester478 (v34.7.92: مبنای ریالی ارجاع فاکتور به حسابدار) —');
