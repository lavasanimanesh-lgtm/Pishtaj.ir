#!/usr/bin/env node
'use strict';
/* v34.38.0 — مبنای ریالی ارجاع فاکتور به حسابدار.
...
T('salesfiles.js cache-bust 34.39.10', /salesfiles\.js\?v=34\.39\.10/.test(idx));
T('official-invoice-v2.js cache-bust 34.39.10', /official-invoice-v2\.js\?v=34\.39\.10/.test(idx));
...
/* v34.38.0 (INV-REF-CONFIRM): امضا به (cd, sendSms) تغییر کرد — تصمیم پیامک از
...
/* v34.38.0: پس از ساخت نسخهٔ ریالی دیگر مستقیم commit نمی‌شود — مودال تایید با
...
console.log('\n— tester478 (v34.38.0: مبنای ریالی ارجاع فاکتور به حسابدار) —');
