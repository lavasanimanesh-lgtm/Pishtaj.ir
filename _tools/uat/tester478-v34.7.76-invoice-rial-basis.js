#!/usr/bin/env node
'use strict';
/* v34.27.0 — مبنای ریالی ارجاع فاکتور به حسابدار.
...
T('salesfiles.js cache-bust 34.27.0', /salesfiles\.js\?v=34\.27.0/.test(idx));
...
console.log('\n— tester478 (v34.27.0: مبنای ریالی ارجاع فاکتور به حسابدار) —');
