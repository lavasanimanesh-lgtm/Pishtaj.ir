#!/usr/bin/env node
'use strict';
/* v34.7.86 — مبنای ریالی ارجاع فاکتور به حسابدار.
...
T('salesfiles.js cache-bust 34.7.86', /salesfiles\.js\?v=34\.7\.86/.test(idx));
...
console.log('\n— tester478 (v34.7.86: مبنای ریالی ارجاع فاکتور به حسابدار) —');
