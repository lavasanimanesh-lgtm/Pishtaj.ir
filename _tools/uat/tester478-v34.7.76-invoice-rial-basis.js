#!/usr/bin/env node
'use strict';
/* v34.29.4 — مبنای ریالی ارجاع فاکتور به حسابدار.
...
T('salesfiles.js cache-bust 34.29.4', /salesfiles\.js\?v=34\.29.4/.test(idx));
T('official-invoice-v2.js cache-bust 34.29.4', /official-invoice-v2\.js\?v=34\.29.4/.test(idx));
...
console.log('\n— tester478 (v34.29.4: مبنای ریالی ارجاع فاکتور به حسابدار) —');
