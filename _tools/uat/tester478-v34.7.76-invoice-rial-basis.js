#!/usr/bin/env node
'use strict';
/* v34.8.31 — مبنای ریالی ارجاع فاکتور به حسابدار.
...
T('salesfiles.js cache-bust 34.8.31', /salesfiles\.js\?v=34\.8\.31/.test(idx));
T('official-invoice-v2.js cache-bust 34.8.31', /official-invoice-v2\.js\?v=34\.8\.31/.test(idx));
...
console.log('\n— tester478 (v34.8.31: مبنای ریالی ارجاع فاکتور به حسابدار) —');
