#!/usr/bin/env node
'use strict';
/* v34.37.2 — مبنای ریالی ارجاع فاکتور به حسابدار.
...
T('salesfiles.js cache-bust 34.37.2', /salesfiles\.js\?v=34\.37\.2/.test(idx));
T('official-invoice-v2.js cache-bust 34.37.2', /official-invoice-v2\.js\?v=34\.37\.2/.test(idx));
...
/* v34.37.2 (INV-REF-CONFIRM): امضا به (cd, sendSms) تغییر کرد — تصمیم پیامک از
...
/* v34.37.2: پس از ساخت نسخهٔ ریالی دیگر مستقیم commit نمی‌شود — مودال تایید با
...
console.log('\n— tester478 (v34.37.2: مبنای ریالی ارجاع فاکتور به حسابدار) —');
