...
T('دکمهٔ سند برای افزودن/مدیریت مدرک در هر ردیف وجود دارد', ox.indexOf("opexAction('attach', '📎', fileCount ? fileCount + ' سند' : 'سند'") > -1 && ox.indexOf('window.ptfOpexAttachOpen = function') > -1);
