#!/usr/bin/env node
'use strict';
/* tester578 — v34.29.3: ریشه‌کنی واقعی «تب‌های خالی» مدیریت سایت — برخورد نام کلاس CSS
...
T('FIX: PTF_CMS_JS_VER = v34.29.3 (سپر نسخهٔ کهنه، همسو با VER پوسته)', cms.indexOf("window.PTF_CMS_JS_VER = 'v34.29.3';") > -1);
...
/* ── ۳) گیت و نسخه ── */
T('GATE: tester578 در run-ci-gate.js ثبت است', read('_tools/uat/run-ci-gate.js').indexOf('tester578-v34.29.3-cms-css-visibility.js') > -1);
T('VER: VERSION.json = v34.29.3', JSON.parse(read('VERSION.json')).crm_version === 'v34.29.3');
T('VER: RELEASE-NOTES-v34.29.3.md موجود و RCA را توضیح می‌دهد', fs.existsSync(path.join(ROOT, 'RELEASE-NOTES-v34.29.3.md')) && /display:none/.test(read('RELEASE-NOTES-v34.29.3.md')));
