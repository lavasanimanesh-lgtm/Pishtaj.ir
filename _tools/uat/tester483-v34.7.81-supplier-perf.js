...
T('index.html PTF_CRM_RELEASE = v34.38.6', /window\.PTF_CRM_RELEASE = 'v34\.38\.6'/.test(idx));
T('sw.js RELEASE = v34.38.6', /RELEASE = 'v34\.38\.6'/.test(sw));
T('cache-bust در index.html = 34.38.6', /bridge\.js\?v=34\.38\.6/.test(idx) && /supplier-finance\.js\?v=34\.38\.6/.test(idx));
