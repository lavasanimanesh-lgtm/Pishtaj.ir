...
T('index.html PTF_CRM_RELEASE = v34.39.5', /window\.PTF_CRM_RELEASE = 'v34\.39\.5'/.test(idx));
T('sw.js RELEASE = v34.39.5', /RELEASE = 'v34\.39\.5'/.test(sw));
T('cache-bust در index.html = 34.39.5', /bridge\.js\?v=34\.39\.5/.test(idx) && /supplier-finance\.js\?v=34\.39\.5/.test(idx));
