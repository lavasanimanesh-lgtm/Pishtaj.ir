#!/usr/bin/env node
'use strict';
/* v34.8.30 — سرعت بخشیدن به ماژول تامین‌کنندگان + ثبت‌نام‌های سایت (SUP-PERF-001).
   بررسی می‌کند که:
...
T('index.html PTF_CRM_RELEASE = v34.8.30', /window\.PTF_CRM_RELEASE = 'v34\.8\.30'/.test(idx));
T('sw.js RELEASE = v34.8.30', /RELEASE = 'v34\.8\.30'/.test(sw));
T('cache-bust در index.html = 34.8.30', /bridge\.js\?v=34\.8\.30/.test(idx) && /supplier-finance\.js\?v=34\.8\.30/.test(idx));
...
console.log('\n— tester483 (v34.8.30: سرعت ماژول تامین‌کنندگان + ثبت‌نام سایت — SUP-PERF-001) —');
