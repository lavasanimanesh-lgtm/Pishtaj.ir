...
T('index.html PTF_CRM_RELEASE = v34.39.24', /window\.PTF_CRM_RELEASE = 'v34\.39\.24'/.test(idx));
T('sw.js RELEASE = v34.39.24', /RELEASE = 'v34\.39\.24'/.test(sw));
T('cache-bust در index.html = 34.39.24', /bridge\.js\?v=34\.39\.24/.test(idx) && /supplier-finance\.js\?v=34\.39\.24/.test(idx));
