#!/usr/bin/env node
'use strict';
/* tester539 — v34.36.4 (T5-2b — DEV→IDB): تکمیل بخش دوم T5-2 رودمپ نازک‌سازی.
...
T('مهاجرت boot برای پیشوندهای تشخیصی صدا زده می‌شود', /ptfDevKvMigratePrefixes\(\[[\s\S]{0,500}'ptf_sales_command_'[\s\S]{0,300}'ptf_offer_post_ack_warning_'/.test(sd)); /* v34.36.4: فهرست ۸پیشوندی کامل در tester541 */
...
function finish() {
  console.log('\n— tester539 (v34.36.4: T5-2b DEV→IDB — تشخیصی‌های فرمان در IndexedDB) —');
