#!/usr/bin/env node
'use strict';
/* tester539 — v34.8.39 (T5-2b — DEV→IDB): تکمیل بخش دوم T5-2 رودمپ نازک‌سازی.
...
T('مهاجرت boot برای هر دو پیشوند صدا زده می‌شود', /ptfDevKvMigratePrefixes\(\['ptf_sales_command_', 'ptf_offer_post_ack_warning_'\]\)/.test(sd));
...
function finish() {
  console.log('\n— tester539 (v34.8.39: T5-2b DEV→IDB — تشخیصی‌های فرمان در IndexedDB) —');
