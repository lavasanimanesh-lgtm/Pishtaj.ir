...
/* =============================================================================
   ...
   ۱) STRUCTURE — هر ۴۲۱ مقالهٔ ایندکس‌پذیر (پس از بچ ۱۴ +۱۰ و مقالهٔ تست هیدرواستاتیک PE) دقیقاً یک <main id="main-content">
...
T('۶.۲ دامنهٔ تستر همان ۴۲۱ مقالهٔ ایندکس‌پذیر است', scope.length === 421, String(scope.length));
