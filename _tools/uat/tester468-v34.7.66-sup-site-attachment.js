#!/usr/bin/env node
'use strict';
/* v34.8.25 — تب جداگانهٔ «درخواست‌های سایت» + نمایش فایل پیوست ثبت‌نام تامین‌کننده.
...
T('cheques.js cache-bust 34.8.25', /cheques\.js\?v=34\.8\.25/.test(idx));
...
console.log('\n— tester468 (v34.8.25: تب درخواست‌های سایت + فایل پیوست تامین‌کننده) —');
