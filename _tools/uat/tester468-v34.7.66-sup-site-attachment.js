#!/usr/bin/env node
'use strict';
/* v34.7.97 — تب جداگانهٔ «درخواست‌های سایت» + نمایش فایل پیوست ثبت‌نام تامین‌کننده.
...
T('bridge.js cache-bust 34.7.97', /bridge\.js\?v=34\.7\.97/.test(idx));
T('cheques.js cache-bust 34.7.97', /cheques\.js\?v=34\.7\.97/.test(idx));
...
console.log('\n— tester468 (v34.7.97: تب درخواست‌های سایت + فایل پیوست تامین‌کننده) —');
