#!/usr/bin/env node
'use strict';
/* v34.7.89 — تب جداگانهٔ «درخواست‌های سایت» + نمایش فایل پیوست ثبت‌نام تامین‌کننده.
...
T('cheques.js cache-bust 34.7.89', /cheques\.js\?v=34\.7\.89/.test(idx));
...
console.log('\n— tester468 (v34.7.89: تب درخواست‌های سایت + فایل پیوست تامین‌کننده) —');
