#!/usr/bin/env node
'use strict';
/* v34.7.90 — تب جداگانهٔ «درخواست‌های سایت» + نمایش فایل پیوست ثبت‌نام تامین‌کننده.
...
T('cheques.js cache-bust 34.7.90', /cheques\.js\?v=34\.7\.90/.test(idx));
...
console.log('\n— tester468 (v34.7.90: تب درخواست‌های سایت + فایل پیوست تامین‌کننده) —');
