#!/usr/bin/env node
'use strict';
/* v34.8.16 — تب جداگانهٔ «درخواست‌های سایت» + نمایش فایل پیوست ثبت‌نام تامین‌کننده.
...
T('bridge.js cache-bust 34.8.16', /bridge\.js\?v=34\.8\.16/.test(idx));
T('cheques.js cache-bust 34.8.16', /cheques\.js\?v=34\.8\.16/.test(idx));
...
console.log('\n— tester468 (v34.8.16: تب درخواست‌های سایت + فایل پیوست تامین‌کننده) —');
