...
/* =============================================================================
   ...
   تثبیت دو خواستۀ کارفرما روی پنل فاکتورهای رسمی (v34.38.0):
...
head('۱. تراز ستون‌ها روی خروجی رندر');
{
  ...
  /* v34.38.0 (INV-PANEL-COL-CLIP): قالب ستون‌ها تکامل یافت — clip و shrink در
...
console.log('\n— tester600 (v34.38.0: حذف فوری ردیف پس از لغو ارجاع + تراز ستون‌های پنل فاکتور) —');
