/* tester632 — v34.39.32 (F-4 — eligibilitySince + جبران کنترل‌شدهٔ ماه‌های غایب حقوق):
...
console.log('── F-4 eligibilitySince + controlled salary backfill (v34.39.32) ──');
...
console.log('PASS tester632 v34.39.32 F-4 eligibilitySince + controlled backfill');
