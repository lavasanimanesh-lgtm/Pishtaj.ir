...
SECTION('نسخه و ثبت');
T('نسخه v17.3+', (function(){var m=idx.match(/window.PTF_CRM_RELEASE = 'v([0-9.]+)'/);return m&&parseFloat(m[1])>=17.3;})());
T('کش sw >= v17.3', (function(){var m=sw.match(/var RELEASE = 'v([0-9.]+)';/);return m&&parseFloat(m[1])>=17.3;})());
(function () {
