#!/usr/bin/env node
'use strict';
/* v34.37.7 — تست رفتاری «ارزش افزوده فصلی» (VAT-LEDGER-002).
...
T('vat-quarterly.js cache-bust 34.37.7', /vat-quarterly\.js\?v=34\.37\.7/.test(idx));
...
console.log('\n— tester493 (v34.37.7: رفتار ارزش افزوده فصلی — VAT-LEDGER-002) —');
