#!/usr/bin/env node
'use strict';
/* v34.12.0 — تست رفتاری «ارزش افزوده فصلی» (VAT-LEDGER-002).
...
T('vat-quarterly.js cache-bust 34.12.0', /vat-quarterly\.js\?v=34\.12.0/.test(idx));
...
console.log('\n— tester493 (v34.12.0: رفتار ارزش افزوده فصلی — VAT-LEDGER-002) —');
