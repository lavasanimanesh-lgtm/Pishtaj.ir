#!/usr/bin/env node
'use strict';
/* v34.8.40 — تست رفتاری «ارزش افزوده فصلی» (VAT-LEDGER-002).
...
T('vat-quarterly.js cache-bust 34.8.40', /vat-quarterly\.js\?v=34\.8.40/.test(idx));
...
console.log('\n— tester493 (v34.8.40: رفتار ارزش افزوده فصلی — VAT-LEDGER-002) —');
