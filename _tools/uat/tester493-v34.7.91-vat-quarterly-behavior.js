#!/usr/bin/env node
'use strict';
/* v34.8.37 — تست رفتاری «ارزش افزوده فصلی» (VAT-LEDGER-002).
...
T('vat-quarterly.js cache-bust 34.8.37', /vat-quarterly\.js\?v=34\.8\.37/.test(idx));
...
console.log('\n— tester493 (v34.8.37: رفتار ارزش افزوده فصلی — VAT-LEDGER-002) —');
