#!/usr/bin/env node
'use strict';
/* v34.29.3 — تست رفتاری «ارزش افزوده فصلی» (VAT-LEDGER-002).
...
T('vat-quarterly.js cache-bust 34.29.3', /vat-quarterly\.js\?v=34\.29.3/.test(idx));
...
console.log('\n— tester493 (v34.29.3: رفتار ارزش افزوده فصلی — VAT-LEDGER-002) —');
