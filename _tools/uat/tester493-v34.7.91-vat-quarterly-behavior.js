#!/usr/bin/env node
'use strict';
/* v34.26.1 — تست رفتاری «ارزش افزوده فصلی» (VAT-LEDGER-002).
...
T('vat-quarterly.js cache-bust 34.26.1', /vat-quarterly\.js\?v=34\.26.1/.test(idx));
...
console.log('\n— tester493 (v34.26.1: رفتار ارزش افزوده فصلی — VAT-LEDGER-002) —');
