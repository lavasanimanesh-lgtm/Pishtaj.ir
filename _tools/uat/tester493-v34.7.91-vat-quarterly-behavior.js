#!/usr/bin/env node
'use strict';
/* v34.7.101 — تست رفتاری «ارزش افزوده فصلی» (VAT-LEDGER-002).
...
T('vat-quarterly.js cache-bust 34.7.101', /vat-quarterly\.js\?v=34\.7\.101/.test(idx));
...
console.log('\n— tester493 (v34.7.101: رفتار ارزش افزوده فصلی — VAT-LEDGER-002) —');
