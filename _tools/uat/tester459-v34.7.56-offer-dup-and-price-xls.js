#!/usr/bin/env node
'use strict';
/* v34.37.7 — BUG-OFFER-DUP-SKIP-267:
...
T('offers.js cache-bust 34.37.7', idx.indexOf('offers.js?v=34.37.7') > -1);
...
console.log('\n— tester459 (v34.37.7: رفع حذف کاذب اقلام هم‌محتوا + قیمت از اکسل) —');
