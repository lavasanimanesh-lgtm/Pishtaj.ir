#!/usr/bin/env node
'use strict';
/* v34.7.71 — BUG-OFFER-DUP-SKIP-267:
...
T('offers.js cache-bust 34.7.71', idx.indexOf('offers.js?v=34.7.71') > -1);
...
console.log('\n— tester459 (v34.7.71: رفع حذف کاذب اقلام هم‌محتوا + قیمت از اکسل) —');
