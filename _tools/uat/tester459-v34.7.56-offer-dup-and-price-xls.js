#!/usr/bin/env node
'use strict';
/* v34.15.0 — BUG-OFFER-DUP-SKIP-267:
...
T('offers.js cache-bust 34.15.0', idx.indexOf('offers.js?v=34.15.0') > -1);
...
console.log('\n— tester459 (v34.15.0: رفع حذف کاذب اقلام هم‌محتوا + قیمت از اکسل) —');
