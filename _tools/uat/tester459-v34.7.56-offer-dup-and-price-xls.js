#!/usr/bin/env node
'use strict';
/* v34.29.3 — BUG-OFFER-DUP-SKIP-267:
...
T('offers.js cache-bust 34.29.3', idx.indexOf('offers.js?v=34.29.3') > -1);
...
console.log('\n— tester459 (v34.29.3: رفع حذف کاذب اقلام هم‌محتوا + قیمت از اکسل) —');
