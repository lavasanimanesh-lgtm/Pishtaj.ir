#!/usr/bin/env node
'use strict';
/* v34.8.21 — BUG-OFFER-DUP-SKIP-267:
...
T('offers.js cache-bust 34.8.21', idx.indexOf('offers.js?v=34.8.21') > -1);
...
console.log('\n— tester459 (v34.8.21: رفع حذف کاذب اقلام هم‌محتوا + قیمت از اکسل) —');
