#!/usr/bin/env node
'use strict';
/* v34.8.5 — BUG-OFFER-DUP-SKIP-267:
...
T('offers.js cache-bust 34.8.5', idx.indexOf('offers.js?v=34.8.5') > -1);
...
console.log('\n— tester459 (v34.8.5: رفع حذف کاذب اقلام هم‌محتوا + قیمت از اکسل) —');
