#!/usr/bin/env node
'use strict';
/* v34.7.77 — BUG-OFFER-DUP-SKIP-267:
...
T('offers.js cache-bust 34.7.77', idx.indexOf('offers.js?v=34.7.77') > -1);
...
console.log('\n— tester459 (v34.7.77: رفع حذف کاذب اقلام هم‌محتوا + قیمت از اکسل) —');
