...
/* v34.8.7: phase-queryهای موقتی با بامپ واقعی نسخه حذف شدند؛ دارایی‌های فاز ۶/۸
   مثل بقیه زیر ?v=34.8.7 لود و precache می‌شوند (قوی‌تر از دورزدن کش). */
...
assert.ok(/data-quality\.js\?v=34\.8\.7/.test(index) && /sales-domain-v2\.js\?v=34\.8\.7/.test(index), 'phase six/eight assets carry the real release version');
