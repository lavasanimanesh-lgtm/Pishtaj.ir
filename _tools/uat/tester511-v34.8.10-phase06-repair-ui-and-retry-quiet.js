/* tester511 — v34.8.27/F6: repair manifest UI and quiet background retry contract. */
'use strict';
var fs = require('fs');
...
/* v34.8.27: phase-queryهای موقتی با بامپ واقعی نسخه حذف شدند؛ دارایی‌های فاز ۶/۸
   مثل بقیه زیر ?v=34.8.27 لود و precache می‌شوند (قوی‌تر از دورزدن کش). */
...
assert.ok(/data-quality\.js\?v=34\.8\.27/.test(index) && /sales-domain-v2\.js\?v=34\.8\.27/.test(index), 'phase six/eight assets carry the real release version');
...
console.log('PASS tester511 v34.8.27 phase06 repair UI and retry quiet');
