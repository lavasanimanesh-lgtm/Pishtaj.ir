...
var SUITE = [
  ...
  { g: 'سایت/SEO (38.20): SEO-CRAWL-HYGIENE — بهداشتِ کراول از خروجی کراولر بیرونی: سه صفحهٔ orphan واقعی (دو پست وبلاگ EPC/پایپینگ + راهنمای ترانسمیترها) لینکِ ورودیِ استاتیک گرفتند، ۱۴ عنوان بلند (>۶۵) و ۱۲ توضیح بلند (>۱۶۵) کوتاه شدند، و en/careers.html دادهٔ ساختاریافتهٔ Organization+BreadcrumbList+WebPage گرفت (استاب‌های ریدایرکتِ noindex مستثنا هستند — عمدی)', f: '_tools/uat/tester648-v34.38.20-seo-crawl-hygiene.js' }
];
