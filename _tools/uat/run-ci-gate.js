...
var SUITE = [
  ...
  { g: 'امنیت/PII users_get', f: '_tools/uat/tester519-v34.8.24-users-get-pii-guard.js' },
  { g: 'T0/T1 قراردادهای نازک‌سازی', f: '_tools/uat/tester520-v34.8.24-thin-client-t0t1.js' },
  { g: 'کارتابل/حلقهٔ یادآور', f: '_tools/uat/tester521-v34.8.24-cartable-reminder-loop.js' },
  { g: 'کارتابل/حلقهٔ دینگ', f: '_tools/uat/tester522-v34.8.24-ding-loop.js' },
  { g: 'استقرار/بنر استیجینگ', f: '_tools/uat/tester523-v34.8.24-staging-banner-lift.js' },
  { g: 'همگام/اتحاد notifs', f: '_tools/uat/tester524-v34.8.24-notifs-union.js' },
  { g: 'W1/روتر فرمانی سه موجودیت', f: '_tools/uat/tester525-v34.8.24-w1-entity-router.js' },
  { g: 'W1-iterate + صف IDB', f: '_tools/uat/tester526-v34.8.24-w1-iterate-outbox-idb.js' },
  { g: 'W2/مهاجرت شش کلید', f: '_tools/uat/tester527-v34.8.24-w2-migration.js' },
