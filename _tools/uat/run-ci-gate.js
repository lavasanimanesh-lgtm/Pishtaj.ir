...
var SUITE = [
  ...
  { g: 'سایت/SEO (38.20): KC-STRUCTURE-HYGIENE — پاک‌سازیِ ساختار مرکز دانش: ممیزی ۴۶۳ مقاله نشان داد ۵۹ مقالهٔ ایندکس‌پذیر «الگویی» بودند (مقدمهٔ قالبی + بخش‌های بایت‌به‌بایت تکراری). اصلاح سه‌دسته: ۲۸ صفحه با خواهرِ غنی → noindex+canonical (تجمیع)، ۶ صفحهٔ ترکیبی → حذف بخشِ الگویی و حفظ محتوای واقعی، ۲۵ صفحهٔ کاملاً الگویی → بازنویسی با محتوای تخصصیِ یکتا (≥۵۰۰ واژه)؛ قفل: هیچ مقالهٔ ایندکس‌پذیرِ KC بخشِ الگویی ندارد، تجمیع‌ها noindex+canonicalِ درست و خارج از سایت‌مپ، بازنویسی‌ها ایندکس‌پذیر و در سایت‌مپ', f: '_tools/uat/tester649-v34.38.20-kc-structure-hygiene.js' }
];
