...
var SUITE = [
  ...
  { g: 'UX (28.0): ریشه‌کنی تب‌های خالی CMS — رندر مستقیم cmsTab بدون goPanelByName/دکمهٔ سایدبار', f: '_tools/uat/tester574-v34.29.6-cms-tab-direct.js' },
  { g: 'UX (29.0): جستجوی فهرست محصولات CMS + عکس هوشمند + سپر نسخهٔ کهنه + دو صفحهٔ محصول استاندارد', f: '_tools/uat/tester575-v34.29.6-prod-search-smartimg-vershield.js' },
  { g: 'UX (29.1): آزمون اتصال GSC — علت دقیق ثبتِ ناموفق نقشه + فهرست پراپرتی‌ها + راهنمای رفع', f: '_tools/uat/tester576-v34.29.6-gsc-selftest.js' },
  { g: 'UX (29.2): راهنمای سئو برای کاربران ناآشنا — چک‌لیست زنده + ۶ گام + دکمه‌های اجرای ابزار', f: '_tools/uat/tester577-v34.29.6-seo-guide.js' },
  { g: 'UX (29.4): پارسر مقاوم خروجی هوش خارجی — بولد/جعبهٔ کد/بولت/دونقطهٔ کامل + خطای درون‌مودال', f: '_tools/uat/tester579-v34.29.6-ext-parse-hardened.js' },
  { g: 'UX (29.5): ریشه‌کنی برخورد شناسهٔ pgTitle + شمارنده‌های زندهٔ عنوان/نامک/محصول + شفاف‌سازی کف ۲۰۰', f: '_tools/uat/tester580-v34.29.6-cms-field-ids-and-counters.js' },
  { g: 'UX (29.6): یک‌کلیکی‌شدن یادآور (نوشتن محلی بی‌درنگ + پچ مینیمال ضد بازگشت) + کارت اعلان site_req برای درخواست‌های سایت', f: '_tools/uat/tester581-v34.29.6-rem-oneclick-and-site-notif.js' },
  { g: 'UX (29.3): ریشه‌کنی واقعی تب‌های خالی CMS — برخورد کلاس pn/tb با CSS سراسری (سنجش computed visibility)', f: '_tools/uat/tester578-v34.29.6-cms-css-visibility.js' },
