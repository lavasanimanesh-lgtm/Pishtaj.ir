...
var SUITE = [
  ...
  { g: 'UX (28.0): ریشه‌کنی تب‌های خالی CMS — رندر مستقیم cmsTab بدون goPanelByName/دکمهٔ سایدبار', f: '_tools/uat/tester574-v34.29.3-cms-tab-direct.js' },
  { g: 'UX (29.0): جستجوی فهرست محصولات CMS + عکس هوشمند + سپر نسخهٔ کهنه + دو صفحهٔ محصول استاندارد', f: '_tools/uat/tester575-v34.29.3-prod-search-smartimg-vershield.js' },
  { g: 'UX (29.1): آزمون اتصال GSC — علت دقیق ثبتِ ناموفق نقشه + فهرست پراپرتی‌ها + راهنمای رفع', f: '_tools/uat/tester576-v34.29.3-gsc-selftest.js' },
  { g: 'UX (29.2): راهنمای سئو برای کاربران ناآشنا — چک‌لیست زنده + ۶ گام + دکمه‌های اجرای ابزار', f: '_tools/uat/tester577-v34.29.3-seo-guide.js' },
  { g: 'UX (29.3): ریشه‌کنی واقعی تب‌های خالی CMS — برخورد کلاس pn/tb با CSS سراسری (سنجش computed visibility)', f: '_tools/uat/tester578-v34.29.3-cms-css-visibility.js' },
