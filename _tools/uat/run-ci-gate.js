...
var SUITE = [
  ...
  { g: 'امنیت/PII users_get', f: '_tools/uat/tester519-v34.8.23-users-get-pii-guard.js' },
  { g: 'T0/T1 قراردادهای نازک‌سازی', f: '_tools/uat/tester520-v34.8.23-thin-client-t0t1.js' },
  { g: 'کارتابل/حلقهٔ یادآور', f: '_tools/uat/tester521-v34.8.23-cartable-reminder-loop.js' },
  { g: 'کارتابل/حلقهٔ دینگ', f: '_tools/uat/tester522-v34.8.23-ding-loop.js' },
  { g: 'استقرار/بنر استیجینگ', f: '_tools/uat/tester523-v34.8.23-staging-banner-lift.js' },
  { g: 'همگام/اتحاد notifs', f: '_tools/uat/tester524-v34.8.23-notifs-union.js' },
  { g: 'W1/روتر فرمانی سه موجودیت', f: '_tools/uat/tester525-v34.8.23-w1-entity-router.js' },
  { g: 'W1-iterate + صف IDB', f: '_tools/uat/tester526-v34.8.23-w1-iterate-outbox-idb.js' },
