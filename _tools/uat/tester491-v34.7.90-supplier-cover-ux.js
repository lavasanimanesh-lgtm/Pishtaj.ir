#!/usr/bin/env node
'use strict';
/* v34.7.90 — منطق فاکتور صوری/پوششی + چیدمان مودال ثبت فاکتور (SUP-VAT-002 / SUP-UX-002).
...
T('tester491 در گیت CI', gate.indexOf('tester491-v34.7.90-supplier-cover-ux.js') > -1);

console.log('\n— tester491 (v34.7.90: منفعت پوششی + چیدمان مودال — SUP-VAT-002/SUP-UX-002) —');
