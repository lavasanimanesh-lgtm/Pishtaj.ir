...
SECTION('Release v34.29.1: پین‌های رسمی');
(function releasePins() {
  var ver = JSON.parse(read('VERSION.json'));
  var idx = read('crm/index.html'), sw = read('crm/sw.js');
  T('VERSION.json = v34.29.1', ver.crm_version === 'v34.29.1', ver.crm_version);
  T('index release و cache-bust روی 34.29.1 است', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.29.1'") > -1 && idx.indexOf('?v=34.7.96') === -1);
  T('service worker release/cache/assets روی 34.29.1 است', sw.indexOf("RELEASE = 'v34.29.1'") > -1 && sw.indexOf("ASSET_VERSION = '34.29.1'") > -1 && sw.indexOf("CACHE = 'ptf-crm-v34.29.1'") > -1);
  T('manifest.version = 34.29.1', JSON.parse(read('crm/manifest.json')).version === '34.29.1');
  T('clear-cache روی v34.29.1 است', read('crm/clear-cache.html').indexOf("window.VER = 'v34.29.1'") > -1);
  T('shell fallback روی v34.29.1 است', read('crm/shell.js').indexOf("'v34.29.1'") > -1);
  T('sales-domain service روی 34.29.1 است', read('api/sales-domain.php').indexOf("SD_SERVICE_VERSION = '34.29.1'") > -1);
})();
...
DONE('tester498-v34.29.1-ar-opex-reconcile');
