#!/usr/bin/env node
'use strict';
/* tester578 — v34.38.0: ریشه‌کنی واقعی «تب‌های خالی» مدیریت سایت — برخورد نام کلاس CSS
...
T('FIX: PTF_CMS_JS_VER = v34.38.15 (سپر نسخهٔ کهنه، همسو با VER پوسته)', cms.indexOf("window.PTF_CMS_JS_VER = 'v34.38.15';") > -1);
...
T('VER: VERSION.json = v34.38.15', JSON.parse(read('VERSION.json')).crm_version === 'v34.38.15');
