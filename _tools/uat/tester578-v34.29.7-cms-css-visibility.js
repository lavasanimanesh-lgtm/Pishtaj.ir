...
T('FIX: PTF_CMS_JS_VER = v34.39.7 (سپر نسخهٔ کهنه، همسو با VER پوسته)', cms.indexOf("window.PTF_CMS_JS_VER = 'v34.39.7';") > -1);
...
T('VER: VERSION.json = v34.39.7', JSON.parse(read('VERSION.json')).crm_version === 'v34.39.7');
