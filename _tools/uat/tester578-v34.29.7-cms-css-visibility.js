...
T('FIX: PTF_CMS_JS_VER = v34.39.24 (سپر نسخهٔ کهنه، همسو با VER پوسته)', cms.indexOf("window.PTF_CMS_JS_VER = 'v34.39.24';") > -1);
...
T('VER: VERSION.json = v34.39.24', JSON.parse(read('VERSION.json')).crm_version === 'v34.39.24');
