#!/usr/bin/env node
'use strict';
/* tester578 — v34.29.7: ریشه‌کنی واقعی «تب‌های خالی» مدیریت سایت — برخورد نام کلاس CSS
...
T('FIX: PTF_CMS_JS_VER = v34.29.7 (سپر نسخهٔ کهنه، همسو با VER پوسته)', cms.indexOf("window.PTF_CMS_JS_VER = 'v34.29.7';") > -1);
...
T('VER: VERSION.json = v34.29.7', JSON.parse(read('VERSION.json')).crm_version === 'v34.29.7');
T('VER: RELEASE-NOTES-v34.29.7.md موجود و RCA را توضیح می‌دهد', fs.existsSync(path.join(ROOT, 'RELEASE-NOTES-v34.29.7.md')) && /display:none/.test(read('RELEASE-NOTES-v34.29.7.md')));
