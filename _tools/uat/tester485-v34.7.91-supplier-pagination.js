#!/usr/bin/env node
'use strict';
/* v34.29.2 — صفحه‌بندی فهرست تامین‌کنندگان تاییدشده (SUP-PERF-002).
...
T('offers.js cache-bust 34.29.2', /offers\.js\?v=34\.29.2/.test(idx));
...
console.log('\n— tester485 (v34.29.2: صفحه‌بندی تامین‌کنندگان تاییدشده — SUP-PERF-002) —');
