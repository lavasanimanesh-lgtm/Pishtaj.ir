#!/usr/bin/env node
'use strict';
/* v34.7.95 — صفحه‌بندی فهرست تامین‌کنندگان تاییدشده (SUP-PERF-002).
...
T('offers.js cache-bust 34.7.95', /offers\.js\?v=34\.7\.95/.test(idx));
...
console.log('\n— tester485 (v34.7.95: صفحه‌بندی تامین‌کنندگان تاییدشده — SUP-PERF-002) —');
