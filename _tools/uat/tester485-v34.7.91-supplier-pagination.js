#!/usr/bin/env node
'use strict';
/* v34.9.0 — صفحه‌بندی فهرست تامین‌کنندگان تاییدشده (SUP-PERF-002).
...
T('offers.js cache-bust 34.9.0', /offers\.js\?v=34\.9.0/.test(idx));
...
console.log('\n— tester485 (v34.9.0: صفحه‌بندی تامین‌کنندگان تاییدشده — SUP-PERF-002) —');
