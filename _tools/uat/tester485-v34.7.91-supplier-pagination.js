#!/usr/bin/env node
'use strict';
/* v34.37.1 — صفحه‌بندی فهرست تامین‌کنندگان تاییدشده (SUP-PERF-002).
...
T('offers.js cache-bust 34.37.1', /offers\.js\?v=34\.37\.1/.test(idx));
...
console.log('\n— tester485 (v34.37.1: صفحه‌بندی تامین‌کنندگان تاییدشده — SUP-PERF-002) —');
