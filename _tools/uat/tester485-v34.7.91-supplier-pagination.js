#!/usr/bin/env node
'use strict';
/* v34.36.4 — صفحه‌بندی فهرست تامین‌کنندگان تاییدشده (SUP-PERF-002).
...
T('offers.js cache-bust 34.36.4', /offers\.js\?v=34\.36\.4/.test(idx));
...
console.log('\n— tester485 (v34.36.4: صفحه‌بندی تامین‌کنندگان تاییدشده — SUP-PERF-002) —');
