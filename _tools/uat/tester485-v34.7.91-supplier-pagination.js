#!/usr/bin/env node
'use strict';
/* v34.8.14 — صفحه‌بندی فهرست تامین‌کنندگان تاییدشده (SUP-PERF-002).
...
T('offers.js cache-bust 34.8.14', /offers\.js\?v=34\.8\.14/.test(idx));
...
console.log('\n— tester485 (v34.8.14: صفحه‌بندی تامین‌کنندگان تاییدشده — SUP-PERF-002) —');
