#!/usr/bin/env node
'use strict';
/* tester552 — v34.38.0 (FINAL): بنر مهاجرت + بستهٔ اثبات اصول E1..E7
   ...
   محدود · E7 یک موتور (فعلاً پرچم‌دار؛ اثبات نهایی = v34.38.0 با تله‌متری ≥۷ روز).
...
/* v34.38.20: قرارداد «فقط کهربایی/سبزِ ناتمام، سبزِ کامل/تازه هرگز» حفظ شد؛ پیاده‌سازی
...
T('بنر: فقط دستگاه کهربایی یا سبزِ ناتمام — سبزِ کامل/تازه هرگز نمی‌بیند (v34.38.0: synced هم لازم شد | v34.38.20: خودکار-اول)', ih.indexOf("? window.ptfBMigrationNeeded()") > -1 && ih.indexOf("(!((st.enabled && st.synced)) && !!st.localPayload)") > -1 && ih.indexOf("am.running || am.ok") > -1);
...
/* ═══ E7 — یک موتور (پرچم‌دار؛ نهایی در v34.38.0) ═══ */
