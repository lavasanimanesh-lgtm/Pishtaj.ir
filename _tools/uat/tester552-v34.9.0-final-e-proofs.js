...
/* v34.39.1: قرارداد «فقط کهربایی/سبزِ ناتمام، سبزِ کامل/تازه هرگز» حفظ شد؛ پیاده‌سازی
...
T('بنر: فقط دستگاه کهربایی یا سبزِ ناتمام — سبزِ کامل/تازه هرگز نمی‌بیند (v34.38.0: synced هم لازم شد | v34.39.1: خودکار-اول)', ih.indexOf("? window.ptfBMigrationNeeded()") > -1 && ih.indexOf("(!((st.enabled && st.synced)) && !!st.localPayload)") > -1 && ih.indexOf("am.running || am.ok") > -1);
