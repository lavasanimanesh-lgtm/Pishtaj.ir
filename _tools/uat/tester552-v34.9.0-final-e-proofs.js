#!/usr/bin/env node
'use strict';
/* tester552 — v34.37.7 (FINAL): بنر مهاجرت + بستهٔ اثبات اصول E1..E7
   ...
   محدود · E7 یک موتور (فعلاً پرچم‌دار؛ اثبات نهایی = v34.37.7 با تله‌متری ≥۷ روز).
...
T('بنر: فقط دستگاه کهربایی یا سبزِ ناتمام — سبزِ کامل/تازه هرگز نمی‌بیند (v34.37.7: synced هم لازم شد)', ih.indexOf('if ((st.enabled && st.synced) || !st.localPayload) { if (bar) bar.remove(); return; }') > -1);
...
/* ═══ E7 — یک موتور (پرچم‌دار؛ نهایی در v34.37.7) ═══ */
