/* tester654 — v34.39.40 (SH-SALARY-EDIT-PROPAGATE + SH-SALARY-ADVANCE):
...
console.log('── salary edit cross-month amount propagation + salary advance (v34.39.40) ──');
...
console.log('PASS tester654 v34.39.40 salary edit cross-month propagation + salary advance');
