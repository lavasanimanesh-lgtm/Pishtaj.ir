/* tester654 — v34.39.22 (SH-SALARY-EDIT-PROPAGATE + SH-SALARY-ADVANCE):
...
console.log('── salary edit cross-month amount propagation + salary advance (v34.39.22) ──');
...
console.log('PASS tester654 v34.39.22 salary edit cross-month propagation + salary advance');
