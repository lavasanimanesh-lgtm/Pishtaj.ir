...
T('۶.۱ VERSION.json = v34.39.23', ver.crm_version === 'v34.39.23', ver.crm_version);
T('۶.۲ tester613 در run-ci-gate.js ثبت است', gate.indexOf('tester613-v34.38.6-ntf-lifecycle-and-findings.js') > -1);
T('۶.۳ قرارداد UI/sw = 34.39.23',
  /window\.PTF_CRM_RELEASE = 'v34\.39\.23'/.test(idx) &&
  /CACHE = 'ptf-crm-v34\.39\.23'/.test(read('crm/sw.js')));
T('۶.۴ SD_SERVICE_VERSION = 34.39.23', /SD_SERVICE_VERSION = '34\.39\.23'/.test(read('api/sales-domain.php')));
