...
T('tools API status v33.3.2 است', /'version' => 'v3[0-9.]+'/.test(api));
...
T('CRM index tool-feedback را cache-bust v33.3.2 لود می‌کند', /tool-feedback.js\?v=3[0-9.]+/.test(idx) && /window\.VER = 'v3[0-9.]+'/.test(idx) && /ptf-crm-v3[0-9.]+/.test(sw));
