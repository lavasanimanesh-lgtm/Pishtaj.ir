...
T('CRM index tool-feedback را cache-bust v31.9 لود می‌کند', idx.indexOf('tool-feedback.js?v=31.9') > -1 && idx.indexOf("window.VER = 'v31.9'") > -1 && sw.indexOf('ptf-crm-v31.9') > -1);
