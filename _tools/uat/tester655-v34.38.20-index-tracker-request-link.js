/* tester655 — v34.39.5 (INDEX-TRACKER-REQUEST-LINK):
...
console.log('── درخواست ایندکسِ مستقیم برای ردیف‌های ایندکس‌نشدهٔ ردیاب (v34.39.5) ──');
...
console.log('PASS tester655 v34.39.5 index-tracker per-row request-indexing link');
