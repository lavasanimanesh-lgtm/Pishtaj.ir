/* tester655 — v34.39.8 (INDEX-TRACKER-REQUEST-LINK):
...
console.log('── درخواست ایندکسِ مستقیم برای ردیف‌های ایندکس‌نشدهٔ ردیاب (v34.39.8) ──');
...
console.log('PASS tester655 v34.39.8 index-tracker per-row request-indexing link');
