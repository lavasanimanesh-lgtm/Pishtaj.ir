/* tester655 — v34.39.27 (INDEX-TRACKER-REQUEST-LINK):
...
console.log('── درخواست ایندکسِ مستقیم برای ردیف‌های ایندکس‌نشدهٔ ردیاب (v34.39.27) ──');
...
console.log('PASS tester655 v34.39.27 index-tracker per-row request-indexing link');
