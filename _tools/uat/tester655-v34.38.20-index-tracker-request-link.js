/* tester655 — v34.38.21 (INDEX-TRACKER-REQUEST-LINK):
...
console.log('── درخواست ایندکسِ مستقیم برای ردیف‌های ایندکس‌نشدهٔ ردیاب (v34.38.21) ──');
...
console.log('PASS tester655 v34.38.21 index-tracker per-row request-indexing link');
