/* tester655 — v34.39.20 (INDEX-TRACKER-REQUEST-LINK):
...
console.log('── درخواست ایندکسِ مستقیم برای ردیف‌های ایندکس‌نشدهٔ ردیاب (v34.39.20) ──');
...
console.log('PASS tester655 v34.39.20 index-tracker per-row request-indexing link');
