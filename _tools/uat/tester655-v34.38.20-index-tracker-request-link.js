/* tester655 — v34.39.3 (INDEX-TRACKER-REQUEST-LINK):
...
console.log('── درخواست ایندکسِ مستقیم برای ردیف‌های ایندکس‌نشدهٔ ردیاب (v34.39.3) ──');
...
console.log('PASS tester655 v34.39.3 index-tracker per-row request-indexing link');
