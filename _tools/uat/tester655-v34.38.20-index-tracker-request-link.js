/* tester655 — v34.39.11 (INDEX-TRACKER-REQUEST-LINK):
...
console.log('── درخواست ایندکسِ مستقیم برای ردیف‌های ایندکس‌نشدهٔ ردیاب (v34.39.11) ──');
...
console.log('PASS tester655 v34.39.11 index-tracker per-row request-indexing link');
