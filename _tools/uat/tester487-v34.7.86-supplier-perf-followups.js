#!/usr/bin/env node
'use strict';
/* v34.7.86 — ادامه بهینه‌سازی تامین‌کنندگان:
...
T('supplier-finance.js cache-bust 34.7.86', /supplier-finance\.js\?v=34\.7\.86/.test(idx));
...
T('tester487 در گیت CI', gate.indexOf('tester487-v34.7.86-supplier-perf-followups.js') > -1);

console.log('\n— tester487 (v34.7.86: ادامه بهینه‌سازی تامین‌کنندگان — SUP-PERF-003/004) —');
