#!/usr/bin/env node
'use strict';
/* v34.8.42 — شرایط پرداخت تامین‌کننده (نقدی/تعهدی + بازهٔ اعتبار + امتیاز).
...
T('offers.js cache-bust 34.8.42', /offers\.js\?v=34\.8.42/.test(idx));
...
console.log('\n— tester481 (v34.8.42: شرایط پرداخت تامین‌کننده — نقدی/تعهدی + امتیاز) —');
