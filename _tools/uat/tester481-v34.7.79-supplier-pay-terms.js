#!/usr/bin/env node
'use strict';
/* v34.19.0 — شرایط پرداخت تامین‌کننده (نقدی/تعهدی + بازهٔ اعتبار + امتیاز).
...
T('offers.js cache-bust 34.19.0', /offers\.js\?v=34\.19.0/.test(idx));
...
console.log('\n— tester481 (v34.19.0: شرایط پرداخت تامین‌کننده — نقدی/تعهدی + امتیاز) —');
