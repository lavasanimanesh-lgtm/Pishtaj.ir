#!/usr/bin/env node
'use strict';
/* v34.29.4 — شرایط پرداخت تامین‌کننده (نقدی/تعهدی + بازهٔ اعتبار + امتیاز).
...
T('offers.js cache-bust 34.29.4', /offers\.js\?v=34\.29.4/.test(idx));
...
console.log('\n— tester481 (v34.29.4: شرایط پرداخت تامین‌کننده — نقدی/تعهدی + امتیاز) —');
