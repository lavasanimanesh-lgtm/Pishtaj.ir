#!/usr/bin/env node
'use strict';
/* v34.18.0 — شرایط پرداخت تامین‌کننده (نقدی/تعهدی + بازهٔ اعتبار + امتیاز).
...
T('offers.js cache-bust 34.18.0', /offers\.js\?v=34\.18.0/.test(idx));
...
console.log('\n— tester481 (v34.18.0: شرایط پرداخت تامین‌کننده — نقدی/تعهدی + امتیاز) —');
