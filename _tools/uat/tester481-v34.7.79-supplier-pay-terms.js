#!/usr/bin/env node
'use strict';
/* v34.7.80 — شرایط پرداخت تامین‌کننده (نقدی/تعهدی + بازهٔ اعتبار + امتیاز).
...
T('offers.js cache-bust 34.7.80', /offers\.js\?v=34\.7\.80/.test(idx));
...
console.log('\n— tester481 (v34.7.80: شرایط پرداخت تامین‌کننده — نقدی/تعهدی + امتیاز) —');
