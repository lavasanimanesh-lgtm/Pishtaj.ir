#!/usr/bin/env node
'use strict';
/* v34.36.0 — شرایط پرداخت تامین‌کننده (نقدی/تعهدی + بازهٔ اعتبار + امتیاز).
...
T('offers.js cache-bust 34.36.0', /offers\.js\?v=34\.35.0/.test(idx));
...
console.log('\n— tester481 (v34.36.0: شرایط پرداخت تامین‌کننده — نقدی/تعهدی + امتیاز) —');
