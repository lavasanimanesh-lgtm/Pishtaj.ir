...
SECTION('نسخه و ثبت');
T('نسخه v19.5+', (function () { var m = idx.match(/var VER = 'v([0-9.]+)'/); return m && parseFloat(m[1]) >= 19.5; })());
T('کش sw >= v19.5', (function () { var m = sw.match(/ptf-crm-v([0-9.]+)/); return m && parseFloat(m[1]) >= 19.5; })());
