...
test('release cache contract is aligned', version === 'v34.38.25' && index.indexOf("window.PTF_CRM_RELEASE = 'v34.38.25'") > -1 &&
  sw.indexOf("var RELEASE = 'v34.38.25'") > -1 && manifest.version === '34.38.25');
