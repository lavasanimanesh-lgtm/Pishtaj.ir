...
test('release cache contract is aligned', version === 'v34.39.5' && index.indexOf("window.PTF_CRM_RELEASE = 'v34.39.5'") > -1 &&
  sw.indexOf("var RELEASE = 'v34.39.5'") > -1 && manifest.version === '34.39.5');
