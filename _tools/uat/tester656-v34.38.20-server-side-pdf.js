/* tester656 — v34.39.30 (ADV-CV-SERVER-SIDE-PDF-001):
...
console.log('── PDF باینری سمت سرور برای گزارش نهایی ADV-CV (v34.39.30) ──');
...
assert.ok(idx.indexOf('tool-report-drafts.js?v=34.39.30') > -1, 'cache-bust فایل UI اعمال شده');
...
if (!phpOk || fs.existsSync(secretsPath)) {
  ...
  console.log('PASS tester656 v34.39.30 server-side-pdf (PHP behavior skipped)');
} else {
  var os = require('os');
  ...
  (async function () {
    ...
    if (process.exitCode) {
      console.log('FAIL tester656 v34.39.30 server-side-pdf');
      process.exit(1);
    }
    console.log('PASS tester656 v34.39.30 server-side-pdf');
