...
console.log('── PDF باینری سمت سرور برای گزارش نهایی ADV-CV (v34.38.21) ──');
...
assert.ok(idx.indexOf('tool-report-drafts.js?v=34.38.21') > -1, 'cache-bust فایل UI اعمال شده');
