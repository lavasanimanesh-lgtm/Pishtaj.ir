#!/usr/bin/env node
'use strict';
/* tester497 — v34.29.4 (RE-UPLOAD-QUEUE-001 فاز A)
...
/* ----- سناریو 7: گارد نقش — کاربر با نقش پایین رد شود (v34.29.4 RE-UPLOAD-QUEUE-002) ----- */
sb._role = 'sales';
...
console.log('\n— tester497 (v34.29.4: صف آپلود مجدد ردهٔ E — RE-UPLOAD-QUEUE-001) —');
