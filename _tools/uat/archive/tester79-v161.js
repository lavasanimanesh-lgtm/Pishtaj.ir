/* =====================================================================
   ...
   دلیل: به دستور صریح کارفرما (v33.4.2) گزینهٔ «نرخ سنا» به‌طور کامل از سامانه
   حذف شد (منبع سنا/ICE از ۲۲ دی ۱۴۰۴ توسط بانک مرکزی حذف شد). هر ۳ شکست این
   تستر دربارهٔ نگه‌داشتن/نمایش نرخ‌های سناست. قرارداد حذف سنا توسط
   tester177-v33.4.2-fx-sana-removal.js (ریشهٔ مخزن) پاس می‌شود.
   ===================================================================== */
