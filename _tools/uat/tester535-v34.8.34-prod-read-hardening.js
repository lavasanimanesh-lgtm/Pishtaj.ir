#!/usr/bin/env node
'use strict';
/* tester535 — v34.38.0: فیکس «کالاها نمایش داده نمی‌شوند».
...
T('قرارداد نسخهٔ UI/sw = 34.39.27', read('crm/index.html').indexOf("window.PTF_CRM_RELEASE = 'v34.39.27'") > -1 && read('crm/sw.js').indexOf("CACHE = 'ptf-crm-v34.39.27'") > -1);
