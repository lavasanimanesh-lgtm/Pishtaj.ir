...
'use strict';
/* =====================================================================
   tester593 — v34.37.4 · DELTA-FAILSAFE (مسیرِ استقرارِ افزایشیِ استیجینگ)

   چرا این تستر وجود دارد:
   وصلهٔ معوقِ v34.8.40 (DEPLOY-SPEEDUP) در v34.37.4 اعمال شد و **اولین اجرای
...
console.log('\n— tester593 (v34.37.4: DELTA-FAILSAFE — اجرای واقعیِ گامِ دلتا در ریپوی gitِ ایزوله) —');
