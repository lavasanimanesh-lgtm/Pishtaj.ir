...
T('رنگ مبلغ قرمز به‌صورت اجباری و مستقل از پروفایل چاپ اعمال می‌شود', prt.indexOf("var topAmtColor = '#b91c1c'")>-1 && prt.indexOf('.f-amt{color:#b91c1c!important')>-1 && prt.indexOf("L.amtColor = '#b91c1c'")>-1);
