...
head('۳. آزمون جهش (ثبوتِ بارِ تشخیص تست ۱)');
{
  ...
  if (i0 < 0 || i1 < 0) { T('۳.۰ بلوک reg در perms.js پیدا شد', false, 'i0=' + i0 + ' i1=' + i1); }
    ...
    const MUT = PERMS.slice(0, i0) +
      ...
      '    var _capB = window[buildName], _capR = window[renderName]; /* رفتار پیش از v34.37.7 */\n' +
...
console.log('\n— tester601 (v34.37.7: دیرهنگامِ بازدر مسیر allow-override + گارد تهی در رندر بازنشسته) —');
