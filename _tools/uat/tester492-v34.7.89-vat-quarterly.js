#!/usr/bin/env node
'use strict';
/* v34.7.89 — ارزش افزوده فصلی در هاب مالی + نرخ مصوب سال (VAT-LEDGER-001).
...
T('vat-shared.js و vat-quarterly.js در index', /vat-shared\.js\?v=34\.7\.89/.test(idx) && /vat-quarterly\.js\?v=34\.7\.89/.test(idx));
...
T('tester492 در گیت CI', gate.indexOf('tester492-v34.7.89-vat-quarterly.js') > -1);

console.log('\n— tester492 (v34.7.89: ارزش افزوده فصلی + نرخ مصوب سال — VAT-LEDGER-001) —');
