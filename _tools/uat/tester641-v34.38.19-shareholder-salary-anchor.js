/* tester641 — v34.39.21 (SH-SALARY-ANCHOR): رفع باگ «جبران حقوق برای یک سهامدار به‌جای ۳ ماه،
...
console.log('── SH-SALARY-ANCHOR: مبدأ احراز صریح + نرمال‌سازی ماه در جبران حقوق (v34.39.21) ──');
...
console.log('PASS tester641 v34.39.21 SH-SALARY-ANCHOR explicit anchor + month normalization');
