...
T('settings-accordion.js وجود دارد و نسخه/قرارداد جدید دارد', acc.indexOf('settings-accordion.js — v31.9') > -1 && acc.indexOf('MINIMAL-LINE-ICONS-DARK-FISCAL-001') > -1);
T('settings accordion بعد از همه ماژول‌ها در CRM لود می‌شود', idx.indexOf('settings-accordion.js?v=31.9') > idx.indexOf('sync.js?v=31.9'));
