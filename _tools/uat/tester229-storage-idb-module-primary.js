...
T('نسخه CRM و cache-bust v33.5.0 است', /window\.PTF_CRM_RELEASE\s*=\s*'v\d+(?:\.\d+)+'/.test(idx) && /ai-workbench.js\?v=3[0-9.]+/.test(idx) && /draftx.js\?v=3[0-9.]+/.test(idx) && /var RELEASE\s*=\s*'v\d+(?:\.\d+)+'/.test(sw));
