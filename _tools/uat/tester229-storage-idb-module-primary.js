...
T('نسخه CRM و cache-bust v31.9 است', idx.indexOf("window.VER = 'v31.9'") > -1 && idx.indexOf('ai-workbench.js?v=31.9') > -1 && idx.indexOf('draftx.js?v=31.9') > -1 && sw.indexOf('ptf-crm-v31.9') > -1);
