...
T('PHP: cta/footer محصول با cms_rel_links_fix اصلاح می‌شوند (لینک مرده → knowledge-center)', php.indexOf('function cms_rel_links_fix') > -1 && php.indexOf("cms_rel_links_fix($sk['cta']") > -1 && php.indexOf("cms_rel_links_fix($sk['footer']") > -1); /* v34.37.8: استخراج با هُلپر مقاوم */
