#!/usr/bin/env node
'use strict';
/* v34.7.59 — OFFICIAL-OFFER-OUTPUT-001 (بازپیاده‌سازی PR #57 روی main):
...
T('index PTF_CRM_RELEASE = v34.7.59', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.7.59'") > -1);
T('sw RELEASE = v34.7.59', sw.indexOf("RELEASE = 'v34.7.59'") > -1);
T('offers-pro.js cache-bust 34.7.59', idx.indexOf('offers-pro.js?v=34.7.59') > -1);
...
console.log('\n— tester461 (v34.7.59: خروجی چاپ/PDF رسمی بدون watermark) —');
