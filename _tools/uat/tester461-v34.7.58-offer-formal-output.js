#!/usr/bin/env node
'use strict';
/* v34.9.1 — OFFICIAL-OFFER-OUTPUT-001 (بازپیاده‌سازی PR #57 روی main):
...
T('offers-pro.js cache-bust 34.9.1', idx.indexOf('offers-pro.js?v=34.9.1') > -1);
...
console.log('\n— tester461 (v34.9.1: خروجی چاپ/PDF رسمی بدون watermark) —');
