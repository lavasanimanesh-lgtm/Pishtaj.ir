#!/usr/bin/env node
'use strict';
/* v34.8.0 — OFFICIAL-OFFER-OUTPUT-001 (بازپیاده‌سازی PR #57 روی main):
...
T('offers-pro.js cache-bust 34.8.0', idx.indexOf('offers-pro.js?v=34.8.0') > -1);
...
console.log('\n— tester461 (v34.8.0: خروجی چاپ/PDF رسمی بدون watermark) —');
