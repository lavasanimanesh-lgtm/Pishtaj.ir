#!/usr/bin/env node
'use strict';
/* tester571 — v34.37.0: ریشه‌کنی پنج علامت جریان محصول (بازخورد پروداکشن پس از دیپلوی)
...
/* ═══ ① تصویر مرئی در صفحه ═══ */
T('IMG: تصویر در صفحهٔ محصول — کارت هیرو (و بالای متن در حالت بازگشت)', SEG.indexOf('IMG-VIS') > -1 && SEG.indexOf('$imgHero = $imgTag0;') > -1 && SEG.indexOf("'<p style=\"text-align:center;margin:4px 0 18px\">' . $imgTag0") > -1); /* v34.37.0 (CMS-FIX R2) */
...
T('IDX: فراخوانی پس از هر انتشار + لاگ', SEG.indexOf('cms_products_index_rebuild($ROOT, $DATA, $header, $cta, $footer, $skStyle)') > -1 && IDXFN.indexOf("cms_log('products_index'") > -1); /* v34.37.0: پارامتر ششم = استایل درون‌خطی اسکلت */
