#!/usr/bin/env node
'use strict';
/* tester571 — v34.29.8: ریشه‌کنی پنج علامت جریان محصول (بازخورد پروداکشن پس از دیپلوی)
...
/* ═══ ① تصویر مرئی در صفحه ═══ */
T('IMG: تصویر بالای متن صفحه در رندر سرور (نه فقط og:image)', SEG.indexOf('IMG-VIS') > -1 && SEG.indexOf("'<p style=\"text-align:center;margin:4px 0 18px\"><img src=\"../'") > -1);
...
T('IDX: فراخوانی پس از هر انتشار + لاگ', SEG.indexOf('cms_products_index_rebuild($ROOT, $DATA, $header, $cta, $footer)') > -1 && IDXFN.indexOf("cms_log('products_index'") > -1);
