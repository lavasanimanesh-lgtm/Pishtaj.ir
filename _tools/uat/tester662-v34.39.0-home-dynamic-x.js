...
/* =============================================================================
   ...
   ⑤ SPEED: بدون کتابخانه/فونت/اسکریپت خارجی جدید؛ cache-bust v34.39.3؛
...
T('۵.۲ home.css با cache-bust v34.39.3 و ptf-motion با defer+version لود می‌شود',
...
DONE('tester662-v34.39.3-home-dynamic-x');
