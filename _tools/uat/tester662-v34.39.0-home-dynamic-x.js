...
/* =============================================================================
   ...
   ⑤ SPEED: بدون کتابخانه/فونت/اسکریپت خارجی جدید؛ cache-bust v34.39.2؛
...
T('۵.۲ home.css با cache-bust v34.39.2 و ptf-motion با defer+version لود می‌شود',
...
DONE('tester662-v34.39.2-home-dynamic-x');
