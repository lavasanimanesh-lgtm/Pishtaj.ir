...
/* =============================================================================
   ...
   ⑤ SPEED: بدون کتابخانه/فونت/اسکریپت خارجی جدید؛ cache-bust v34.39.0؛
...
T('۵.۲ home.css با cache-bust v34.39.0 و ptf-motion با defer+version لود می‌شود',
  /home\.css\?v=34\.39\.0/.test(idx) && /ptf-motion\.js\?v=34\.39\.0" defer/.test(idx));
...
DONE('tester662-v34.39.0-home-dynamic-x');
