#!/usr/bin/env node
'use strict';
/* v34.9.0 — STORAGE-INDEPENDENCE: پایان بن‌بست «۱۰۰٪ پر بودن localStorage».
...
T('مسیر رد «فاز فعال نیست» به انتقال یک‌باره ارجاع می‌دهد (v34.9.0)', /پس از «انتقال یک‌باره» ممکن است/.test(cs) && cs.indexOf('وضعیت دستگاه → «انتقال یک‌بارهٔ داده‌های این دستگاه»') > -1);
...
console.log('\n— tester514 (v34.9.0: پایان وابستگی به localStorage) —');
