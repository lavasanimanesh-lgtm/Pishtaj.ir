...
T('بنر: شرط کامل شد — فقط enabled && synced بنر را برمی‌دارد (v34.38.25: خودکار-اول، نوار فقط انسان/پس از سکوت بوت)', ih.indexOf('? window.ptfBMigrationNeeded()') > -1 && ih.indexOf('(!((st.enabled && st.synced)) && !!st.localPayload)') > -1);
