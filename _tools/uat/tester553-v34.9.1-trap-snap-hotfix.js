#!/usr/bin/env node
'use strict';
/* tester553 — v34.38.0 (HOTFIX): بستن پمپ snapshot + تلهٔ «سبزِ ناتمام» + شفافیت dirty + پیام خطای دقیق
...
T('بنر: شرط کامل شد — فقط enabled && synced بنر را برمی‌دارد (v34.38.19: خودکار-اول، نوار فقط انسان/پس از سکوت بوت)', ih.indexOf('? window.ptfBMigrationNeeded()') > -1 && ih.indexOf('(!((st.enabled && st.synced)) && !!st.localPayload)') > -1);
