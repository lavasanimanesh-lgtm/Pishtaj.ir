/* tester629 — v34.39.4 (OPEX-DUP-GUARD گام ۳/۴/۵ + SH-SALARY-MONTH-GAP): بستن دو شکافِ
   گزارش‌شدهٔ کارفرما:
...
console.log('── OPEX double-count guards + salary month-gap (v34.39.4) ──');
/* قرارداد استاتیک */
...
console.log('PASS tester629 v34.39.4 opex duplicate guards + salary month-gap');
