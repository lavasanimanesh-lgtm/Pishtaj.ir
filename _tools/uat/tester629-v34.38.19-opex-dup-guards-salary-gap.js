/* tester629 — v34.38.25 (OPEX-DUP-GUARD گام ۳/۴/۵ + SH-SALARY-MONTH-GAP): بستن دو شکافِ
   گزارش‌شدهٔ کارفرما:
...
console.log('── OPEX double-count guards + salary month-gap (v34.38.25) ──');
/* قرارداد استاتیک */
...
console.log('PASS tester629 v34.38.25 opex duplicate guards + salary month-gap');
