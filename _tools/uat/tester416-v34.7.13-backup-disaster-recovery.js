...
T('restore از conflict و zero-wipe guard قبلی نیز عبور می‌کند',push.indexOf('if (!$restore && !$allow_wipe')>-1&&push.indexOf('if (!$allow_wipe && !$restore && !$isSharedUnion)')>-1); /* v34.15.0: سپر داده‌صفر برای کلیدهای shared-union غیرفعال (RCA avatars) */
