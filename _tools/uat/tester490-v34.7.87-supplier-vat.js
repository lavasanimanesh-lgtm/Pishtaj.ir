#!/usr/bin/env node
'use strict';
/* v34.7.87 — فیلد ارزش افزوده فاکتور رسمی تامین‌کننده (SUP-VAT-001).
...
T('supplier-finance.js cache-bust 34.7.87', /supplier-finance\.js\?v=34\.7\.87/.test(idx));
...
T('درصد پیش‌فرض ۱۰ است', /id="slInvVatPct"[^>]*value="10"/.test(sf));
T('توضیح «مبلغ بدون ارزش افزوده» وجود دارد', sf.indexOf('بدون ارزش افزوده') > -1 && sf.indexOf('خالص/پایه') > -1);
...
T('tester490 در گیت CI', gate.indexOf('tester490-v34.7.87-supplier-vat.js') > -1);

console.log('\n— tester490 (v34.7.87: فیلد ارزش افزوده فاکتور رسمی تامین‌کننده — SUP-VAT-001) —');
