...
'use strict';
/* =============================================================================
   tester664 — v34.39.7 (HOME-DOCK-SUN)
   دستور کارفرما:
...
T('۵.۱ cache-bust: home.css و ptf-motion روی v34.39.7',
...
T('۵.۸ VERSION.json = v34.39.7', JSON.parse(read('VERSION.json')).crm_version === 'v34.39.7');

DONE('tester664-v34.39.7-dock-sun');
