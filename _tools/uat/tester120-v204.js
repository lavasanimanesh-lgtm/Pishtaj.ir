...
SECTION('نسخه و ثبت');
T('نسخه v20.4+', (function(){var m=idx.match(/var VER = 'v([0-9.]+)'/);return m&&parseFloat(m[1])>=20.4;})());
T('کش sw >= v20.4', (function(){var m=sw.match(/ptf-crm-v([0-9.]+)/);return m&&parseFloat(m[1])>=20.4;})());
