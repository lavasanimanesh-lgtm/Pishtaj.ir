'use strict';
/* ─────────────────────────────────────────────────────────────────────────────
   tester618 — v34.38.11 (ATOMIC-PULL-COMPLETION)
   ...
   ریشه‌ها (v34.38.11، مسیر pull اتمیک) که این تستر آن‌ها را قفل می‌کند:
...
(async function run() {
  ...
  test('نسخهٔ انتشار هم‌تراز است', version === 'v34.38.11');
