#!/usr/bin/env node
'use strict';
/* v34.29.3 — پایه‌ی «استارت سرد SPA» / سوادِ لود (LOAD-AUDIT-001، فقط استاتیک، بدون تغییر رفتار):
...
var wrongVer = localSrcs.filter(function (s) { return /\?v=/.test(s) && !/v=34\.29.3/.test(s); });
T('همه‌ی cache-bust ها = 34.29.3', wrongVer.length === 0, wrongVer.join(', '));
...
console.log('\n— tester489 (v34.29.3: پایه‌ی استارت سرد — LOAD-AUDIT-001) —');
