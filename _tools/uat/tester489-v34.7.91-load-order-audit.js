#!/usr/bin/env node
'use strict';
/* v34.35.0 — پایه‌ی «استارت سرد SPA» / سوادِ لود (LOAD-AUDIT-001، فقط استاتیک، بدون تغییر رفتار):
...
T('همه‌ی cache-bust ها = 34.35.0', wrongVer.length === 0, wrongVer.join(', '));
...
console.log('\n— tester489 (v34.35.0: پایه‌ی استارت سرد — LOAD-AUDIT-001) —');
