#!/usr/bin/env node
'use strict';
/* v34.7.53 — remap گروه B با تأیید دستی، بدون حذف فایل ابری */
...
T('index PTF_CRM_RELEASE = v34.7.53', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.7.53'") > -1);
T('sw RELEASE = v34.7.53', sw.indexOf("RELEASE = 'v34.7.53'") > -1);
T('storage.js cache-bust 34.7.53', idx.indexOf('storage.js?v=34.7.53') > -1);
...
console.log('\n— tester456 (v34.7.53: remap گروه B بدون حذف فایل) —');
