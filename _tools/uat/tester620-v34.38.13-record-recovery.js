'use strict';
/* ─────────────────────────────────────────────────────────────────────────────
   tester620 — v34.38.13 (RECORD-RECOVERY)
...
test('اسکریپت در index.html بارگذاری و در sw.js precache شده است',
  /restore-collection\.js\?v=34\.38\.13/.test(indexHtml) && sw.indexOf("'./restore-collection.js' + ASSET_QUERY") > -1);
...
test('نسخهٔ انتشار هم‌تراز است', version === 'v34.38.13');

console.log('');
if (failures) { console.log('=== tester620: ' + failures + ' FAIL ==='); process.exit(1); }
console.log('PASS tester620-v34.38.13-record-recovery');
