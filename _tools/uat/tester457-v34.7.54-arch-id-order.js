#!/usr/bin/env node
'use strict';
/* v34.7.57 — رفع تخلف A2 نگهبان معماری در ptfHarvestFileKeys (v34.7.52):
...
T('index PTF_CRM_RELEASE = v34.7.57', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.7.57'") > -1);
T('sw RELEASE = v34.7.57', sw.indexOf("RELEASE = 'v34.7.57'") > -1);
T('storage.js cache-bust 34.7.57', idx.indexOf('storage.js?v=34.7.57') > -1);
...
console.log('\n— tester457 (v34.7.57: رفع A2 و سبز شدن نگهبان معماری) —');
