#!/usr/bin/env node
'use strict';
/* v34.8.43 — ارزش افزوده فصلی در هاب مالی + نرخ مصوب سال (VAT-LEDGER-001).
...
T('vat-shared.js و vat-quarterly.js در index', /vat-shared\.js\?v=34\.8.43/.test(idx) && /vat-quarterly\.js\?v=34\.8.43/.test(idx));
...
console.log('\n— tester492 (v34.8.43: ارزش افزوده فصلی + نرخ مصوب سال — VAT-LEDGER-001) —');
