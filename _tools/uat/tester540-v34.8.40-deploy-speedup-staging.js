#!/usr/bin/env node
'use strict';
/* tester540 — v34.37.3 (DEPLOY-SPEEDUP + TRUTHFUL-GREEN برای استیجینگ)
...
function contract(st) {
  ...
  /* ---------- fallback کامل ---------- */
  /* v34.37.3: شرطِ پیشین `mode == 'full' || inc.outcome == 'failure'` بود و یک سوراخِ
...
console.log('\n— tester540 (v34.37.3: DEPLOY-SPEEDUP + TRUTHFUL-GREEN استیجینگ' + (wired ? '' : ' — حالت وصلهٔ معلق') + ') —');
