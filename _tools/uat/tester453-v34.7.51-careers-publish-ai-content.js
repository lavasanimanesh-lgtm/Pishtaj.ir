#!/usr/bin/env node
'use strict';
/* v34.10.0 — نمایش آگهی از API، شرح هوش مصنوعی، حذف CTA تکراری بنر، محتوای پروفایل/پروژه */
...
T('careers.js?v=34.10.0', /careers\.js\?v=34\.10.0/.test(idx));
...
console.log('\n— tester453 (v34.10.0: انتشار آگهی + شرح AI + محتوای سایت) —');
