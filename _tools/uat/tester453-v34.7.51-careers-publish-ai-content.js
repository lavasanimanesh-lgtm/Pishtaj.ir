#!/usr/bin/env node
'use strict';
/* v34.29.3 — نمایش آگهی از API، شرح هوش مصنوعی، حذف CTA تکراری بنر، محتوای پروفایل/پروژه */
...
T('careers.js?v=34.29.3', /careers\.js\?v=34\.29.3/.test(idx));
...
console.log('\n— tester453 (v34.29.3: انتشار آگهی + شرح AI + محتوای سایت) —');
