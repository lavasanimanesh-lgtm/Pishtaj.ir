#!/usr/bin/env node
'use strict';
/* v34.7.51 — نمایش آگهی از API، شرح هوش مصنوعی، حذف CTA تکراری بنر، محتوای پروفایل/پروژه */
...
T('sw RELEASE = v34.7.51', sw.indexOf("RELEASE = 'v34.7.51'") > -1);
T('careers.js?v=34.7.51', /careers\.js\?v=34\.7\.51/.test(idx));
...
console.log('\n— tester453 (v34.7.51: انتشار آگهی + شرح AI + محتوای سایت) —');
