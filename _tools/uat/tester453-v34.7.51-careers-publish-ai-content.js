#!/usr/bin/env node
'use strict';
/* v34.9.1 — نمایش آگهی از API، شرح هوش مصنوعی، حذف CTA تکراری بنر، محتوای پروفایل/پروژه */
...
T('careers.js?v=34.9.1', /careers\.js\?v=34\.9.1/.test(idx));
...
console.log('\n— tester453 (v34.9.1: انتشار آگهی + شرح AI + محتوای سایت) —');
