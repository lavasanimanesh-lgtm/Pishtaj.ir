#!/usr/bin/env node
'use strict';
/* v34.12.0 — نمایش آگهی از API، شرح هوش مصنوعی، حذف CTA تکراری بنر، محتوای پروفایل/پروژه */
...
T('careers.js?v=34.12.0', /careers\.js\?v=34\.12.0/.test(idx));
...
console.log('\n— tester453 (v34.12.0: انتشار آگهی + شرح AI + محتوای سایت) —');
