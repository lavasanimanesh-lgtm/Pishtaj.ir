#!/usr/bin/env node
'use strict';
/* v34.8.22 — نمایش آگهی از API، شرح هوش مصنوعی، حذف CTA تکراری بنر، محتوای پروفایل/پروژه */
...
T('careers.js?v=34.8.22', /careers\.js\?v=34\.8\.22/.test(idx));
...
console.log('\n— tester453 (v34.8.22: انتشار آگهی + شرح AI + محتوای سایت) —');
