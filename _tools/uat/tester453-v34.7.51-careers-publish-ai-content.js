#!/usr/bin/env node
'use strict';
/* v34.8.26 — نمایش آگهی از API، شرح هوش مصنوعی، حذف CTA تکراری بنر، محتوای پروفایل/پروژه */
...
T('careers.js?v=34.8.26', /careers\.js\?v=34\.8\.26/.test(idx));
...
console.log('\n— tester453 (v34.8.26: انتشار آگهی + شرح AI + محتوای سایت) —');
