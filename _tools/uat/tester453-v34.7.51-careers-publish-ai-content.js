#!/usr/bin/env node
'use strict';
/* v34.7.53 — نمایش آگهی از API، شرح هوش مصنوعی، حذف CTA تکراری بنر، محتوای پروفایل/پروژه */
...
T('careers.js?v=34.7.53', /careers\.js\?v=34\.7\.53/.test(idx));
...
console.log('\n— tester453 (v34.7.53: انتشار آگهی + شرح AI + محتوای سایت) —');
