...
'use strict';
/* =============================================================================
   tester666 — v34.39.5 (HOME-ACCORD-NIGHTMEGA)
   گزارش کارفرما:
...
SECTION('③ قرارداد کلی');
T('۳.۱ cache-bust روی v34.39.5', /home\.css\?v=34\.39\.5/.test(idx) && /ptf-motion\.js\?v=34\.39\.5" defer/.test(idx));
...
T('۳.۷ VERSION.json = v34.39.5', JSON.parse(read('VERSION.json')).crm_version === 'v34.39.5');

DONE('tester666-v34.39.5-accord-nightmega');
