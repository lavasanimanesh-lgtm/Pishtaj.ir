...
'use strict';
/* =============================================================================
   tester666 — v34.39.4 (HOME-ACCORD-NIGHTMEGA)
   گزارش کارفرما:
...
SECTION('③ قرارداد کلی');
T('۳.۱ cache-bust روی v34.39.4', /home\.css\?v=34\.39\.4/.test(idx) && /ptf-motion\.js\?v=34\.39\.4" defer/.test(idx));
...
T('۳.۷ VERSION.json = v34.39.4', JSON.parse(read('VERSION.json')).crm_version === 'v34.39.4');

DONE('tester666-v34.39.4-accord-nightmega');
