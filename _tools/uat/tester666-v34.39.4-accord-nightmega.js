...
'use strict';
/* =============================================================================
   tester666 — v34.39.27 (HOME-ACCORD-NIGHTMEGA)
   گزارش کارفرما:
...
T('۳.۷ VERSION.json = v34.39.27', JSON.parse(read('VERSION.json')).crm_version === 'v34.39.27');

DONE('tester666-v34.39.27-accord-nightmega');
