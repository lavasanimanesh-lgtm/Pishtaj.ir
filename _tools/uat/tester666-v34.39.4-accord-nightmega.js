...
'use strict';
/* =============================================================================
   tester666 — v34.39.6 (HOME-ACCORD-NIGHTMEGA)
   گزارش کارفرما:
...
SECTION('③ قرارداد کلی');
T('۳.۱ cache-bust روی v34.39.6', /home\.css\?v=34\.39\.6/.test(idx) && /ptf-motion\.js\?v=34\.39\.6" defer/.test(idx));
...
T('۳.۷ VERSION.json = v34.39.6', JSON.parse(read('VERSION.json')).crm_version === 'v34.39.6');

DONE('tester666-v34.39.6-accord-nightmega');
