#!/usr/bin/env node
'use strict';
/* v34.7.87 — خود-تشخیص همگام‌سازی (SYNC-DIAG-001).
...
T('sw.js RELEASE = v34.7.87', /RELEASE = 'v34\.7\.87'/.test(sw));
T('sync.js cache-bust 34.7.87', /sync\.js\?v=34\.7\.87/.test(idx));
T('backup.js cache-bust 34.7.87', /backup\.js\?v=34\.7\.87/.test(idx));
...
T('tester484 در گیت CI', gate.indexOf('tester484-v34.7.87-sync-diagnostics.js') > -1);

console.log('\n— tester484 (v34.7.87: خود-تشخیص همگام‌سازی — SYNC-DIAG-001) —');
