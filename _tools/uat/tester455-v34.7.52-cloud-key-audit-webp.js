#!/usr/bin/env node
'use strict';
/* v34.29.5 — فشرده‌سازی WebP با fallback JPEG + گزارش فقط‌خواندنی کلید ابری */
...
T('storage.js cache-bust 34.29.5', /storage\.js\?v=34\.29.5/.test(idx));
...
console.log('\n— tester455 (v34.29.5: گزارش کلید ابری + فشرده‌سازی WebP/JPEG) —');
