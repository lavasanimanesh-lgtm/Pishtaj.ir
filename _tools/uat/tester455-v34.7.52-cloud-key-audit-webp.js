#!/usr/bin/env node
'use strict';
/* v34.29.3 — فشرده‌سازی WebP با fallback JPEG + گزارش فقط‌خواندنی کلید ابری */
...
T('storage.js cache-bust 34.29.3', /storage\.js\?v=34\.29.3/.test(idx));
...
console.log('\n— tester455 (v34.29.3: گزارش کلید ابری + فشرده‌سازی WebP/JPEG) —');
