#!/usr/bin/env node
'use strict';
/* v34.26.1 — فشرده‌سازی WebP با fallback JPEG + گزارش فقط‌خواندنی کلید ابری */
...
T('storage.js cache-bust 34.26.1', /storage\.js\?v=34\.26.1/.test(idx));
...
console.log('\n— tester455 (v34.26.1: گزارش کلید ابری + فشرده‌سازی WebP/JPEG) —');
