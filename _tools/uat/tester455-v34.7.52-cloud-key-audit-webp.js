#!/usr/bin/env node
'use strict';
/* v34.37.7 — فشرده‌سازی WebP با fallback JPEG + گزارش فقط‌خواندنی کلید ابری */
...
T('storage.js cache-bust 34.37.7', /storage\.js\?v=34\.37\.7/.test(idx));
...
console.log('\n— tester455 (v34.37.7: گزارش کلید ابری + فشرده‌سازی WebP/JPEG) —');
