#!/usr/bin/env node
'use strict';
/* v34.7.58 — فشرده‌سازی WebP با fallback JPEG + گزارش فقط‌خواندنی کلید ابری */
...
T('sw RELEASE = v34.7.58', sw.indexOf("RELEASE = 'v34.7.58'") > -1);
T('storage.js cache-bust 34.7.58', /storage\.js\?v=34\.7\.58/.test(idx));
...
console.log('\n— tester455 (v34.7.58: گزارش کلید ابری + فشرده‌سازی WebP/JPEG) —');
