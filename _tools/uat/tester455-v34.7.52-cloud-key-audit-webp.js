#!/usr/bin/env node
'use strict';
/* v34.35.0 — فشرده‌سازی WebP با fallback JPEG + گزارش فقط‌خواندنی کلید ابری */
...
T('storage.js cache-bust 34.35.0', /storage\.js\?v=34\.35.0/.test(idx));
...
console.log('\n— tester455 (v34.35.0: گزارش کلید ابری + فشرده‌سازی WebP/JPEG) —');
