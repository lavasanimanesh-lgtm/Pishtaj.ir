#!/usr/bin/env node
'use strict';
/* v34.7.52 — فشرده‌سازی WebP با fallback JPEG + گزارش فقط‌خواندنی کلید ابری */
...
T('sw RELEASE = v34.7.52', sw.indexOf("RELEASE = 'v34.7.52'") > -1);
T('storage.js cache-bust 34.7.52', /storage\.js\?v=34\.7\.52/.test(idx));
...
console.log('\n— tester455 (v34.7.52: گزارش کلید ابری + فشرده‌سازی WebP/JPEG) —');
