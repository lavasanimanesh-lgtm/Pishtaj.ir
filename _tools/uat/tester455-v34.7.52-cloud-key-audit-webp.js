#!/usr/bin/env node
'use strict';
/* v34.7.53 — فشرده‌سازی WebP با fallback JPEG + گزارش فقط‌خواندنی کلید ابری */
...
T('sw RELEASE = v34.7.53', sw.indexOf("RELEASE = 'v34.7.53'") > -1);
T('storage.js cache-bust 34.7.53', /storage\.js\?v=34\.7\.53/.test(idx));
...
console.log('\n— tester455 (v34.7.53: گزارش کلید ابری + فشرده‌سازی WebP/JPEG) —');
