#!/usr/bin/env node
'use strict';
/* v34.8.39 — فشرده‌سازی WebP با fallback JPEG + گزارش فقط‌خواندنی کلید ابری */
...
T('storage.js cache-bust 34.8.39', /storage\.js\?v=34\.8\.39/.test(idx));
...
console.log('\n— tester455 (v34.8.39: گزارش کلید ابری + فشرده‌سازی WebP/JPEG) —');
