#!/usr/bin/env node
'use strict';
/* v34.9.2 — فشرده‌سازی WebP با fallback JPEG + گزارش فقط‌خواندنی کلید ابری */
...
T('storage.js cache-bust 34.9.2', /storage\.js\?v=34\.9.2/.test(idx));
...
console.log('\n— tester455 (v34.9.2: گزارش کلید ابری + فشرده‌سازی WebP/JPEG) —');
