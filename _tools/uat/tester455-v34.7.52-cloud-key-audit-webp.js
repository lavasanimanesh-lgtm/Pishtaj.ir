#!/usr/bin/env node
'use strict';
/* v34.7.57 — فشرده‌سازی WebP با fallback JPEG + گزارش فقط‌خواندنی کلید ابری */
...
T('sw RELEASE = v34.7.57', sw.indexOf("RELEASE = 'v34.7.57'") > -1);
T('storage.js cache-bust 34.7.57', /storage\.js\?v=34\.7\.57/.test(idx));
...
console.log('\n— tester455 (v34.7.57: گزارش کلید ابری + فشرده‌سازی WebP/JPEG) —');
