#!/usr/bin/env node
'use strict';
/* v34.7.71 — فشرده‌سازی WebP با fallback JPEG + گزارش فقط‌خواندنی کلید ابری */
...
T('storage.js cache-bust 34.7.71', /storage\.js\?v=34\.7\.71/.test(idx));
...
console.log('\n— tester455 (v34.7.71: گزارش کلید ابری + فشرده‌سازی WebP/JPEG) —');
