#!/usr/bin/env node
'use strict';
/* tester572 — v34.37.4: پوستهٔ مقاوم تب‌های CMS
...
T('GUARD: فرم جایگزین همهٔ فیلدهای لازم را دارد (folder/slug/topic/title/h1/desc/body/img)', ['pgFolder','pgSlug','pgTopic','cmsPgTitle','pgH1','pgDesc','pgBody','pgImg'] /* v34.37.4: عنوان فرم به cmsPgTitle تغییر نام یافت (برخورد با عنوان هدر) */.every(function (id) { return WRAP.indexOf('id="' + id + '"') > -1; }));
