...
T('۷.۰ VERSION.json = v34.39.31', ver.crm_version === 'v34.39.31', ver.crm_version);
T('۷.۱ tester616 در run-ci-gate.js ثبت است', gate.indexOf('tester616-v34.38.9-backup-blindspot-and-partial-recovery.js') > -1);
T('۷.۲ قرارداد UI/sw/SD = 34.39.31',
  /window\.PTF_CRM_RELEASE = 'v34\.39\.31'/.test(read('crm/index.html')) &&
  /CACHE = 'ptf-crm-v34\.39\.31'/.test(read('crm/sw.js')) &&
  /SD_SERVICE_VERSION = '34\.39\.31'/.test(read('api/sales-domain.php')));
