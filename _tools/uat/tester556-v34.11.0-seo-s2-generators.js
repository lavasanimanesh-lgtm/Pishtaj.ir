...
T('S2: اسکیمای Service بدون قیمت / Product + Offer فقط با قیمت مثبت (v34.39.32: Product بدون قیمت از نظر گوگل invalid است)', /case 'product_create'[\s\S]{0,9000}'@type' => \(\$price > 0 \? 'Product' : 'Service'\)[\s\S]{0,500}if \(\$price > 0\)[\s\S]{0,200}'offers'/.test(cmsPhp));
