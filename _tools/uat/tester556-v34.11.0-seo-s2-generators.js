#!/usr/bin/env node
'use strict';
/* tester556 — v34.37.8 (فاز S2 سئو): مولد صفحات
...
T('S2: قالب از اسکلت مرکز دانش (هدر/فوتر هم‌شکل)', /case 'product_create'[\s\S]{0,2600}cms_product_skeleton\(\$ROOT\)/.test(cmsPhp)); /* v34.37.8: هِلپر قالب محصولات با بازگشت به اسکلت مرکز دانش */
...
/* v34.37.8: فاصله‌محور نبود — سنجهٔ ترتیبیِ داخل بدنهٔ تابع (قرارداد نگهبان: «سنجه مبتنی بر فاصله کاراکتری در فایل فارسی‌دار غلط است») */
