...
}
{
  ...
  T('۲.۷ جمع مطالبه بازِ ردیف فقط فاکتورهای فعال است (۱۰۰ نه ۱۱۰)', html.indexOf('title="مطالبه باز">100<') > -1 && html.indexOf('مطالبه باز: 110') === -1);
...
console.log('\n— tester599 (v34.37.3: دیده‌شدن فاکتورهای ثبت‌شده/ارجاع‌شده) —');
