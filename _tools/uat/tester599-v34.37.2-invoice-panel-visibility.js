...
}
{
  ...
  T('۲.۷ جمع مطالبه بازِ ردیف فقط فاکتورهای فعال است (۱۰۰ نه ۱۱۰)', html.indexOf('title="ماندۀ وصولی‌نشده (ریال)">100<') > -1 && html.indexOf('مطالبه باز: 110') === -1); /* v34.37.6: برچسبِ title به «ماندۀ وصولی‌نشده (ریال)» تغییر کرد — لنگرِ همین سنجه هم هم‌نام شد */
...
console.log('\n— tester599 (v34.37.6: دیده‌شدن فاکتورهای ثبت‌شده/ارجاع‌شده) —');
