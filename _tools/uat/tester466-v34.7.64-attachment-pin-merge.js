#!/usr/bin/env node
'use strict';
/* v34.7.65 — ادغام دو آیکون ضمیمه در ردیف درخواست‌ها.
...
T('bridge.js cache-bust 34.7.65', /bridge\.js\?v=34\.7\.65/.test(idx));
T('inqreader.js cache-bust 34.7.65', /inqreader\.js\?v=34\.7\.65/.test(idx));
...
console.log('\n— tester466 (v34.7.65: ادغام آیکون ضمیمه ردیف درخواست) —');
