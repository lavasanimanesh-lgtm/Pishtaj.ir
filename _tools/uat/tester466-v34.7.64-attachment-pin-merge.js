#!/usr/bin/env node
'use strict';
/* v34.7.79 — ادغام دو آیکون ضمیمه در ردیف درخواست‌ها.
...
T('inqreader.js cache-bust 34.7.79', /inqreader\.js\?v=34\.7\.79/.test(idx));
...
console.log('\n— tester466 (v34.7.79: ادغام آیکون ضمیمه ردیف درخواست) —');
