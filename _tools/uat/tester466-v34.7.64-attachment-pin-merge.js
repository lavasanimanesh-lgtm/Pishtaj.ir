#!/usr/bin/env node
'use strict';
/* v34.7.76 — ادغام دو آیکون ضمیمه در ردیف درخواست‌ها.
...
T('inqreader.js cache-bust 34.7.76', /inqreader\.js\?v=34\.7\.76/.test(idx));
...
console.log('\n— tester466 (v34.7.76: ادغام آیکون ضمیمه ردیف درخواست) —');
