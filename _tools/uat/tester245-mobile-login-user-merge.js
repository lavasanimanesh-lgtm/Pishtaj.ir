...
T('users_get از منبع merged استفاده می‌کند و همچنان passhash برنمی‌گرداند', usersGetBlock.indexOf('$all_users = load_all_crm_users_sources();') > -1 && /'username'\s*=>\s*\$u\['username'\]/.test(usersGetBlock) && usersGetBlock.indexOf("'passhash' =>") === -1 && usersGetBlock.indexOf('passhash =>') === -1); /* 2026-08-13: فیلدهای امن با ?? و email شرطی-احراز بازنویسی شد */
