#!/usr/bin/env node
'use strict';
/* tester522 — v34.25.0 (DING-LOOP): پایان «دینگ هر چند ثانیه + 🔄 N بخش از دستگاه
   دیگر به‌روز شد».

   گزارش کارفرما پس از v34.25.0: تکرار کارت قطع شد ولی دینگ و پیام pull ادامه داشت.
...
T('قرارداد نسخهٔ UI/sw = 34.25.0', /window\.PTF_CRM_RELEASE = 'v34\.25.0'/.test(read('crm/index.html')) && /CACHE = 'ptf-crm-v34\.25.0'/.test(read('crm/sw.js')));

console.log('\n— tester522 (v34.25.0: DING-LOOP) —');
