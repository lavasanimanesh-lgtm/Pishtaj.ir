#!/usr/bin/env node
'use strict';
/* v34.29.2 — PROTECTED-CONFLICT-RESCUE.
...
T('v34.29.2: پذیرش verbatim کانونیکال وقتی لوکال از لحظهٔ ارسال تغییر نکرده', /sameSyncJson\(current, submittedStr\)\) \{\s*\n\s*merged = serverStr;/.test(sync));
T('v34.29.2: مسیر protected دیگر پاس tombstone ندارد (پایداری امضا)', (function () {
...
(function behavior() {
  ...
  /* v34.29.2: adopt canonical → next push identical signature → saved */
...
console.log('\n— tester515 (v34.29.2: نجات تعارض کلیدهای مالی محافظت‌شده در فاز B) —');
