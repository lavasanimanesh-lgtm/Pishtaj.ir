#!/usr/bin/env node
'use strict';
/* v34.8.10 — PROTECTED-CONFLICT-RESCUE.
...
T('حل‌کنندهٔ protected از ptfMergeProtectedFinanceConflict استفاده می‌کند', /ptfMergeProtectedFinanceConflict\(k, rd\(k\), typeof submittedStr[\s\S]{0,120}serverStr\)/.test(sync));
...
(function behavior() {
  ...
  /* v34.8.10: adopt canonical → next push identical signature → saved */
...
console.log('\n— tester515 (v34.8.10: نجات تعارض کلیدهای مالی محافظت‌شده در فاز B) —');
