#!/usr/bin/env node
'use strict';
/* v34.8.29 — PROTECTED-CONFLICT-RESCUE.
...
T('v34.8.29: پذیرش verbatim کانونیکال وقتی لوکال از لحظهٔ ارسال تغییر نکرده', /sameSyncJson\(current, submittedStr\)\) \{\s*\n\s*merged = serverStr;/.test(sync));
T('v34.8.29: مسیر protected دیگر پاس tombstone ندارد (پایداری امضا)', (function () {
...
(function behavior() {
  ...
  /* v34.8.29: adopt canonical → next push identical signature → saved */
...
console.log('\n— tester515 (v34.8.29: نجات تعارض کلیدهای مالی محافظت‌شده در فاز B) —');
