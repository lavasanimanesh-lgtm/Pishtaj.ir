...
T('pull قبل از token/401 با refresh auth retry کنترل‌شده دارد', sy.indexOf('retryPullAfterAuth(done, forceFull, opts)')>-1 && sy.indexOf('ptfSyncRefreshAuth')>-1); /* 2026-08-13: refresh اکنون reauth صریح است نه auth_login خاموش */
