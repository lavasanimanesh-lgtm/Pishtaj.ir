...
T('data_pull token ارسال می‌کند', sy.indexOf("fetch(API + '?action=data_pull&since=' + pullSince, { headers: authHeaders(false) })")>-1 && sy.indexOf('var pullSince = forceFull ? 0 : state.lastRev')>-1);
