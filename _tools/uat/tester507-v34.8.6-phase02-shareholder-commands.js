/* tester507 — v34.8.33/F2: server-owned salary registration and shareholder movements. */
'use strict';
var fs = require('fs');
var vm = require('vm');
...
/* v34.39.32 (TIME-INDEPENDENT): ماه draw/پرداخت حقوق در shareholders.js با faMonthNow()
...
returnPromise.then(function () {
  ...
  console.log('PASS tester507 v34.8.33 phase02 shareholder commands');
