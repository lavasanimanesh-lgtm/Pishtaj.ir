...
T('tools API status به v31.9 رسیده است', api.indexOf("'version' => 'v31.9'") > -1);

SECTION('CRM locked render UI');
T('CRM نسخه v31.9 است', idx.indexOf("window.VER = 'v31.9'") > -1 && sw.indexOf('ptf-crm-v31.9') > -1);
T('tool-report-drafts.js با v31.9 لود می‌شود', idx.indexOf('tool-report-drafts.js?v=31.9') > -1);
