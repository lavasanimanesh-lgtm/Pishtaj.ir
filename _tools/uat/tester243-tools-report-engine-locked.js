...
T('tools API status به v33.4.0 رسیده است', /'version' => 'v3[0-9.]+'/.test(api));

SECTION('CRM locked render UI');
T('CRM نسخه v33.4.0 است', /window\.VER = 'v3[0-9.]+'/.test(idx) && /ptf-crm-v3[0-9.]+/.test(sw));
T('tool-report-drafts.js با v33.4.0 لود می‌شود', /tool-report-drafts.js\?v=3[0-9.]+/.test(idx));
