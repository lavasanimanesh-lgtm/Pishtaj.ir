#!/usr/bin/env node
'use strict';
/* v34.7.72 — حذف قفل مرحله‌ای ارجاع فاکتور.
...
T('salesfiles.js cache-bust 34.7.72', /salesfiles\.js\?v=34\.7\.72/.test(idx));
...
console.log('\n— tester474 (v34.7.72: حذف قفل مرحله‌ای ارجاع فاکتور) —');
