...
T('۴.۱ ماژول با ?v=34.38.16 در پوسته لینک شد', /restore-contacts\.js\?v=34\.38\.16/.test(idx));
...
T('۵.۰ VERSION.json = v34.38.16', ver.crm_version === 'v34.38.16', ver.crm_version);
...
T('۵.۳ قرارداد نسخه 34.38.16 (UI/sw/SD)',
  /window\.PTF_CRM_RELEASE = 'v34\.38\.16'/.test(idx) && /CACHE = 'ptf-crm-v34\.38\.16'/.test(read('crm/sw.js')) && /SD_SERVICE_VERSION = '34\.38\.16'/.test(read('api/sales-domain.php')));
