...
T('۴.۱ ماژول با ?v=34.38.14 در پوسته لینک شد', /restore-contacts\.js\?v=34\.38\.14/.test(idx));
...
T('۵.۰ VERSION.json = v34.38.14', ver.crm_version === 'v34.38.14', ver.crm_version);
...
T('۵.۳ قرارداد نسخه 34.38.14 (UI/sw/SD)',
  /window\.PTF_CRM_RELEASE = 'v34\.38\.14'/.test(idx) && /CACHE = 'ptf-crm-v34\.38\.14'/.test(read('crm/sw.js')) && /SD_SERVICE_VERSION = '34\.38\.14'/.test(read('api/sales-domain.php')));
