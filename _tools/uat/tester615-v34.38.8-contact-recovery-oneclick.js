...
T('۴.۱ ماژول با ?v=34.39.32 در پوسته لینک شد', /restore-contacts\.js\?v=34\.39\.32/.test(idx));
...
T('۵.۰ VERSION.json = v34.39.32', ver.crm_version === 'v34.39.32', ver.crm_version);
...
T('۵.۳ قرارداد نسخه 34.39.32 (UI/sw/SD)',
  /window\.PTF_CRM_RELEASE = 'v34\.39\.32'/.test(idx) && /CACHE = 'ptf-crm-v34\.39\.32'/.test(read('crm/sw.js')) && /SD_SERVICE_VERSION = '34\.39\.32'/.test(read('api/sales-domain.php')));
