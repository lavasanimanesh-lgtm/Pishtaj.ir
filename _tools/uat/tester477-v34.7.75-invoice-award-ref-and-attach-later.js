#!/usr/bin/env node
'use strict';
/* v34.7.93 — ارجاع سند برد به حسابدار + افزودن سند فاکتور/مودیان پس از ثبت.
...
T('official-invoice-v2.js cache-bust 34.7.93', /official-invoice-v2\.js\?v=34\.7\.93/.test(idx));
...
console.log('\n— tester477 (v34.7.93: ارجاع سند برد + افزودن سند فاکتور/مودیان پس از ثبت) —');
