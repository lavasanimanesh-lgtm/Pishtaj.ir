#!/usr/bin/env node
'use strict';
/* v34.37.8 — ارجاع سند برد به حسابدار + افزودن سند فاکتور/مودیان پس از ثبت.
...
/* v34.37.8: پنل فاکتورها از فرم مینیفای به فرم خوانا بازنویسی شد (نمایش ردیفی).
...
console.log('\n— tester477 (v34.37.8: ارجاع سند برد + افزودن سند فاکتور/مودیان پس از ثبت) —');
