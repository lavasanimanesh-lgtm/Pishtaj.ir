...
(function () {
  ...
  /* v34.39.24 (CONTACT-STALE-HOOK — RCA 2026-09-17): قرارداد ۲.۹ قدیمی («بدون cd،
  ...
  T('۲.۹ بدون cd، هوک هیچ بازنویسی‌ای نمی‌کند (payload اصلی در-flight است — v34.39.24)',
...
T('۴.۱ VERSION.json = v34.39.24', ver.crm_version === 'v34.39.24', ver.crm_version);
