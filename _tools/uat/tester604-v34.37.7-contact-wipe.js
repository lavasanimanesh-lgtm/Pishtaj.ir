...
(function () {
  ...
  /* v34.39.31 (CONTACT-STALE-HOOK — RCA 2026-09-17): قرارداد ۲.۹ قدیمی («بدون cd،
  ...
  T('۲.۹ بدون cd، هوک هیچ بازنویسی‌ای نمی‌کند (payload اصلی در-flight است — v34.39.31)',
...
T('۴.۱ VERSION.json = v34.39.31', ver.crm_version === 'v34.39.31', ver.crm_version);
...
T('۴.۴ قرارداد UI/sw = 34.39.31',
  /window\.PTF_CRM_RELEASE = 'v34\.39\.31'/.test(idx) &&
  /CACHE = 'ptf-crm-v34\.39\.31'/.test(read('crm/sw.js')));
