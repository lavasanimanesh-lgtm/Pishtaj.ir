...
T('۴.۱ VERSION.json = v34.38.1', ver.crm_version === 'v34.38.1', ver.crm_version);
...
T('۴.۴ قرارداد UI/sw = 34.38.1',
  /window\.PTF_CRM_RELEASE = 'v34\.38\.1'/.test(idx) &&
  /CACHE = 'ptf-crm-v34\.38\.1'/.test(read('crm/sw.js')));
