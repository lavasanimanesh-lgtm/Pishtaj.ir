...
T('۴.۱ VERSION.json = v34.38.0', ver.crm_version === 'v34.38.0', ver.crm_version);
...
T('۴.۴ قرارداد UI/sw = 34.38.0',
  /window\.PTF_CRM_RELEASE = 'v34\.38\.0'/.test(idx) &&
  /CACHE = 'ptf-crm-v34\.38\.0'/.test(read('crm/sw.js')));
