...
T('۴.۱ VERSION.json = v34.37.8', ver.crm_version === 'v34.37.8', ver.crm_version);
...
T('۴.۴ قرارداد UI/sw = 34.37.8',
  /window\.PTF_CRM_RELEASE = 'v34\.37\.8'/.test(idx) &&
  /CACHE = 'ptf-crm-v34\.37\.8'/.test(read('crm/sw.js')));
