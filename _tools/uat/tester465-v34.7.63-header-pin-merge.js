#!/usr/bin/env node
'use strict';
/* v34.7.87 — ادغام آیکون‌های سرستون جدول‌ها.
...
T('sortable.js cache-bust 34.7.87', /sortable\.js\?v=34\.7\.87/.test(idx));
T('tables.js cache-bust 34.7.87', /tables\.js\?v=34\.7\.87/.test(idx));
...
console.log('\n— tester465 (v34.7.87: ادغام سنجاق سرستون) —');
