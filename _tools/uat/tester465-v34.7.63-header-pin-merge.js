#!/usr/bin/env node
'use strict';
/* v34.29.5 — ادغام آیکون‌های سرستون جدول‌ها.
...
T('sortable.js cache-bust 34.29.5', /sortable\.js\?v=34\.29.5/.test(idx));
T('tables.js cache-bust 34.29.5', /tables\.js\?v=34\.29.5/.test(idx));
...
console.log('\n— tester465 (v34.29.5: ادغام سنجاق سرستون) —');
