#!/usr/bin/env node
'use strict';
/* v34.37.4 — ادغام آیکون‌های سرستون جدول‌ها.
...
T('sortable.js cache-bust 34.37.4', /sortable\.js\?v=34\.37\.4/.test(idx));
T('tables.js cache-bust 34.37.4', /tables\.js\?v=34\.37\.4/.test(idx));
...
console.log('\n— tester465 (v34.37.4: ادغام سنجاق سرستون) —');
