#!/usr/bin/env node
'use strict';
/* v34.8.48 — ادغام آیکون‌های سرستون جدول‌ها.
...
T('sortable.js cache-bust 34.8.48', /sortable\.js\?v=34\.8.48/.test(idx));
T('tables.js cache-bust 34.8.48', /tables\.js\?v=34\.8.48/.test(idx));
...
console.log('\n— tester465 (v34.8.48: ادغام سنجاق سرستون) —');
