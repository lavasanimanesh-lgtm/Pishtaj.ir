#!/usr/bin/env node
'use strict';
/* v34.28.0 — ادغام آیکون‌های سرستون جدول‌ها.
...
T('sortable.js cache-bust 34.28.0', /sortable\.js\?v=34\.28.0/.test(idx));
T('tables.js cache-bust 34.28.0', /tables\.js\?v=34\.28.0/.test(idx));
...
console.log('\n— tester465 (v34.28.0: ادغام سنجاق سرستون) —');
