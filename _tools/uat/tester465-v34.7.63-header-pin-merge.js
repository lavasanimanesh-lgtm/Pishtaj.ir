#!/usr/bin/env node
'use strict';
/* v34.8.17 — ادغام آیکون‌های سرستون جدول‌ها.
...
T('sortable.js cache-bust 34.8.17', /sortable\.js\?v=34\.8\.17/.test(idx));
T('tables.js cache-bust 34.8.17', /tables\.js\?v=34\.8\.17/.test(idx));
...
console.log('\n— tester465 (v34.8.17: ادغام سنجاق سرستون) —');
