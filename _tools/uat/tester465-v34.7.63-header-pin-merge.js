#!/usr/bin/env node
'use strict';
/* v34.29.6 — ادغام آیکون‌های سرستون جدول‌ها.
...
T('sortable.js cache-bust 34.29.6', /sortable\.js\?v=34\.29.6/.test(idx));
T('tables.js cache-bust 34.29.6', /tables\.js\?v=34\.29.6/.test(idx));
...
console.log('\n— tester465 (v34.29.6: ادغام سنجاق سرستون) —');
