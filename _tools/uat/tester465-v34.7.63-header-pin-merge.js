#!/usr/bin/env node
'use strict';
/* v34.7.79 — ادغام آیکون‌های سرستون جدول‌ها.
...
T('sortable.js cache-bust 34.7.79', /sortable\.js\?v=34\.7\.79/.test(idx));
T('tables.js cache-bust 34.7.79', /tables\.js\?v=34\.7\.79/.test(idx));
...
console.log('\n— tester465 (v34.7.79: ادغام سنجاق سرستون) —');
