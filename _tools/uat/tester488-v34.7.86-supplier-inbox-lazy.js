#!/usr/bin/env node
'use strict';
/* v34.7.86 — فعال‌سازی صفحه‌بندی get_inbox در کلاینت (SUP-PERF-005).
...
T('tester488 در گیت CI', gate.indexOf('tester488-v34.7.86-supplier-inbox-lazy.js') > -1);

console.log('\n— tester488 (v34.7.86: فعال‌سازی صفحه‌بندی get_inbox در کلاینت — SUP-PERF-005) —');
