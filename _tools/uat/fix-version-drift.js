...
var rules = [
  ...
  /* ⚠️ v34.37.2: این قاعده در اجرای bumpِ همین نسخه، خطِ `var VER = 'v34.37.1';` را در tester591
     به `var VER = window.PTF_CRM_RELEASE34.37.2';` تبدیل کرد و فایل را از نظر نحوی می‌شکست (گیت قرمز).
