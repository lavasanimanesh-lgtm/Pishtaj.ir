#!/usr/bin/env node
'use strict';
/* tester541 — v34.9.1 (R2/T5-2c — DEV→IDB گام دوم): پیش‌نویس‌ها، آینهٔ پروفایل
   امضا و صف/پلن کدینگ دیگر مستقیم در localStorage نوشته نمی‌شوند؛ همه از نمای
   ptfDevKv (IndexedDB، ساخت v34.9.1) عبور می‌کنند و الگوی «کش سنکرون + پایدارسازی
...
/* ═══ انتها ═══ */
console.log('\n— tester541 (v34.9.1: R2/T5-2c — پیش‌نویس‌ها/امضا/کدینگ در Dev-KV) —');
