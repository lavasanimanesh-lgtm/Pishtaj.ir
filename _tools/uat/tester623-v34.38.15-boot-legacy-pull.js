...
/* ─────────────────────────────────────────────────────────────────────────────
   ...
   ۳) سپرهای حذف انبوه v34.38.12 (که برای بدترین عارضهٔ همین ریشه ساخته شدند)
      سرِ کار می‌مانند.
   ۴) قرارداد انتشار v34.39.5 (VERSION/index/sw/manifest/SD) هم‌تراز است.
...
test('قرارداد انتشار هم‌تراز v34.39.5 است',
  version === 'v34.39.5' && /window\.PTF_CRM_RELEASE = 'v34\.39\.5'/.test(idx) &&
  sw.indexOf("RELEASE = 'v34.39.5'") > -1 && manifest.version === '34.39.5' &&
  sd.indexOf("SD_SERVICE_VERSION = '34.39.5'") > -1);
