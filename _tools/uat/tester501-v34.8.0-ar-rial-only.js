...
T('نسخه رسمی v34.38.10 است', JSON.parse(read('VERSION.json')).crm_version === 'v34.38.10');
...
console.log('\n— tester501 (v34.38.0: مطالبات و وصولی‌های صرفاً ریالی) —');
