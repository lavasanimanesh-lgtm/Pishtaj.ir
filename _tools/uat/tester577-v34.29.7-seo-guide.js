...
T('GUIDE: toggle ماندگار از لایهٔ داده است (ptf_seo_guide_pref — بدون storage مستقیم طبق گارد A10)', cms.indexOf("setData('ptf_seo_guide_pref'") > -1 && cms.indexOf('cmsSeoGuideToggle') > -1); /* v34.36.0 (UX-R4): پیش‌فرض بسته */
...
T('BEHAV: رندر جعبه با دادهٔ نمونه — چیپ‌های وضعیت و دکمه‌ها', (function () {
  var slice = cms.slice(cms.indexOf('var _seoGuideMem'), cms.indexOf('function renderCmsSeo')); /* v34.36.0: از متغیر ماژول شروع می‌شود */
  global.window = {};
