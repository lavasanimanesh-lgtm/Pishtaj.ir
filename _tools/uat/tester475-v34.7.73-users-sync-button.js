#!/usr/bin/env node
'use strict';
/* v34.7.93 — دکمهٔ واقعی «همگام‌سازی کاربران» + تأیید سروری پس از تعریف کاربر.
...
T('rbac.js cache-bust 34.7.93', /rbac\.js\?v=34\.7\.93/.test(idx));
...
console.log('\n— tester475 (v34.7.93: دکمهٔ همگام‌سازی کاربران + تأیید سروری تعریف کاربر) —');
