#!/usr/bin/env node
'use strict';
/* v34.37.1 — دکمهٔ واقعی «همگام‌سازی کاربران» + تأیید سروری پس از تعریف کاربر.
...
T('rbac.js cache-bust 34.37.1', /rbac\.js\?v=34\.37\.1/.test(idx));
...
console.log('\n— tester475 (v34.37.1: دکمهٔ همگام‌سازی کاربران + تأیید سروری تعریف کاربر) —');
