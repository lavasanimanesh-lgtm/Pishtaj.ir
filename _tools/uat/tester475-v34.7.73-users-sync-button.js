#!/usr/bin/env node
'use strict';
/* v34.8.21 — دکمهٔ واقعی «همگام‌سازی کاربران» + تأیید سروری پس از تعریف کاربر.
...
T('rbac.js cache-bust 34.8.21', /rbac\.js\?v=34\.8\.21/.test(idx));
...
console.log('\n— tester475 (v34.8.21: دکمهٔ همگام‌سازی کاربران + تأیید سروری تعریف کاربر) —');
