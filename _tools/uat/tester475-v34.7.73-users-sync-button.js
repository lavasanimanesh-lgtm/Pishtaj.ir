#!/usr/bin/env node
'use strict';
/* v34.29.7 — دکمهٔ واقعی «همگام‌سازی کاربران» + تأیید سروری پس از تعریف کاربر.
...
T('rbac.js cache-bust 34.29.7', /rbac\.js\?v=34\.29.7/.test(idx));
...
console.log('\n— tester475 (v34.29.7: دکمهٔ همگام‌سازی کاربران + تأیید سروری تعریف کاربر) —');
