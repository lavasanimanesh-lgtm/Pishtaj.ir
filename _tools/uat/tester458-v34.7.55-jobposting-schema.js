#!/usr/bin/env node
'use strict';
/* v34.38.0 — اسکیمای کامل JobPosting برای رفع خطای GSC:
...
T('careers.js cache-bust 34.39.30', /careers\.js\?v=34\.39\.30/.test(idx));
...
console.log('\n— tester458 (v34.38.0: اسکیمای JobPosting برای GSC) —');
