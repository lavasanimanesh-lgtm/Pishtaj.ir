#!/usr/bin/env node
'use strict';
/* v34.7.77 — اسکیمای کامل JobPosting برای رفع خطای GSC:
...
T('careers.js cache-bust 34.7.77', /careers\.js\?v=34\.7\.77/.test(idx));
...
console.log('\n— tester458 (v34.7.77: اسکیمای JobPosting برای GSC) —');
