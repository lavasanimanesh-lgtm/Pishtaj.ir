#!/usr/bin/env node
'use strict';
/* v34.7.101 — اسکیمای کامل JobPosting برای رفع خطای GSC:
...
T('careers.js cache-bust 34.7.101', /careers\.js\?v=34\.7\.101/.test(idx));
...
console.log('\n— tester458 (v34.7.101: اسکیمای JobPosting برای GSC) —');
