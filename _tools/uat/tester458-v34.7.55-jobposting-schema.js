#!/usr/bin/env node
'use strict';
/* v34.37.1 — اسکیمای کامل JobPosting برای رفع خطای GSC:
...
T('careers.js cache-bust 34.37.1', /careers\.js\?v=34\.37\.1/.test(idx));
...
console.log('\n— tester458 (v34.37.1: اسکیمای JobPosting برای GSC) —');
