#!/usr/bin/env node
'use strict';
/* v34.17.0 — اسکیمای کامل JobPosting برای رفع خطای GSC:
...
T('careers.js cache-bust 34.17.0', /careers\.js\?v=34\.17.0/.test(idx));
...
console.log('\n— tester458 (v34.17.0: اسکیمای JobPosting برای GSC) —');
