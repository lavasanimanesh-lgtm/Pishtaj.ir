#!/usr/bin/env node
'use strict';
/* v34.9.1 — اسکیمای کامل JobPosting برای رفع خطای GSC:
...
T('careers.js cache-bust 34.9.1', /careers\.js\?v=34\.9.1/.test(idx));
...
console.log('\n— tester458 (v34.9.1: اسکیمای JobPosting برای GSC) —');
