#!/usr/bin/env node
'use strict';
/* v34.36.4 — اسکیمای کامل JobPosting برای رفع خطای GSC:
...
T('careers.js cache-bust 34.36.4', /careers\.js\?v=34\.36\.4/.test(idx));
...
console.log('\n— tester458 (v34.36.4: اسکیمای JobPosting برای GSC) —');
