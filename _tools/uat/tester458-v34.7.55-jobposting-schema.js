#!/usr/bin/env node
'use strict';
/* v34.29.3 — اسکیمای کامل JobPosting برای رفع خطای GSC:
...
T('careers.js cache-bust 34.29.3', /careers\.js\?v=34\.29.3/.test(idx));
...
console.log('\n— tester458 (v34.29.3: اسکیمای JobPosting برای GSC) —');
