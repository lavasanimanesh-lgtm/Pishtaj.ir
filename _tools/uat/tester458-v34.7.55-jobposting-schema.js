#!/usr/bin/env node
'use strict';
/* v34.8.41 — اسکیمای کامل JobPosting برای رفع خطای GSC:
...
T('careers.js cache-bust 34.8.41', /careers\.js\?v=34\.8.41/.test(idx));
...
console.log('\n— tester458 (v34.8.41: اسکیمای JobPosting برای GSC) —');
