#!/usr/bin/env node
'use strict';
/* v34.29.7 — اسکیمای کامل JobPosting برای رفع خطای GSC:
...
T('careers.js cache-bust 34.29.7', /careers\.js\?v=34\.29.7/.test(idx));
...
console.log('\n— tester458 (v34.29.7: اسکیمای JobPosting برای GSC) —');
