#!/usr/bin/env node
'use strict';
/* v34.8.14 — اسکیمای کامل JobPosting برای رفع خطای GSC:
...
T('careers.js cache-bust 34.8.14', /careers\.js\?v=34\.8\.14/.test(idx));
...
console.log('\n— tester458 (v34.8.14: اسکیمای JobPosting برای GSC) —');
