#!/usr/bin/env node
'use strict';
/* v34.7.55 — اسکیمای کامل JobPosting برای رفع خطای GSC:
...
T('careers.js cache-bust 34.7.55', /careers\.js\?v=34\.7\.55/.test(idx));
...
console.log('\n— tester458 (v34.7.55: اسکیمای JobPosting برای GSC) —');
