...
T('نسخه رسمی v34.7.99 است', ver.crm_version === 'v34.7.99', ver.crm_version);
T('index و service worker روی v34.7.99 هستند',
  idx.indexOf("window.PTF_CRM_RELEASE = 'v34.7.99'") > -1 &&
  sw.indexOf("RELEASE = 'v34.7.99'") > -1);
T('cache-bust هر دو فایل فرم تازه شده است',
  idx.indexOf('offers.js?v=34.7.99') > -1 && idx.indexOf('offers-pro.js?v=34.7.99') > -1);
...
console.log('\n— tester500 (v34.7.99: نمایش پایدار تاریخ اعتبار پیشنهاد) —');
