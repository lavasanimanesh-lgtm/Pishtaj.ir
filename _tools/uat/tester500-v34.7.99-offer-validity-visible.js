...
T('نسخه رسمی v34.39.4 است', ver.crm_version === 'v34.39.4', ver.crm_version);
T('index و service worker روی v34.39.4 هستند',
  idx.indexOf("window.PTF_CRM_RELEASE = 'v34.39.4'") > -1 &&
  sw.indexOf("RELEASE = 'v34.39.4'") > -1);
T('cache-bust هر دو فایل فرم تازه شده است',
  idx.indexOf('offers.js?v=34.39.4') > -1 && idx.indexOf('offers-pro.js?v=34.39.4') > -1);
