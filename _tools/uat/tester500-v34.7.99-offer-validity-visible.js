#!/usr/bin/env node
'use strict';
/* v34.8.19 — BUG-OFFER-VALIDITY-001
...
T('نسخه رسمی v34.8.19 است', ver.crm_version === 'v34.8.19', ver.crm_version);
T('index و service worker روی v34.8.19 هستند',
  idx.indexOf("window.PTF_CRM_RELEASE = 'v34.8.19'") > -1 &&
  sw.indexOf("RELEASE = 'v34.8.19'") > -1);
T('cache-bust هر دو فایل فرم تازه شده است',
  idx.indexOf('offers.js?v=34.8.19') > -1 && idx.indexOf('offers-pro.js?v=34.8.19') > -1);
...
console.log('\n— tester500 (v34.8.19: نمایش پایدار تاریخ اعتبار پیشنهاد) —');
