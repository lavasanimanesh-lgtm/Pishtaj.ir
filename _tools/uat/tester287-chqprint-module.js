/* tester287 — v33.17.0 (CHQ-PRINT): ماژول مستقل «چاپ چک فیزیکی» زیر گروه کالا و اسناد
...
/* v33.17.0: مبلغ دوم پایین-چپ + حالت گرافیکی درگ */
...
T('نسخه 33.17.0 در index/sw/clear-cache', idx.indexOf("window.VER = 'v33.17.0'") > -1 && sw.indexOf('ptf-crm-v33.17.0') > -1 && fs.readFileSync(path.join(BASE, 'clear-cache.html'), 'utf-8').indexOf("window.VER = 'v33.17.0'") > -1);
