...
'use strict';
/* =============================================================================
   tester667 — v34.39.6 (HOME-ICONMIN)
   گزارش کارفرما:
...
SECTION('⑤ قرارداد کلی');
T('۵.۱ cache-bust روی v34.39.6', /home\.css\?v=34\.39\.6/.test(idx) && /ptf-motion\.js\?v=34\.39\.6" defer/.test(idx));
...
DONE('tester667-v34.39.6-iconmin');
