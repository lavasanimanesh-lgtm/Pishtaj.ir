...
'use strict';
/* =============================================================================
   tester667 — v34.39.5 (HOME-ICONMIN)
   گزارش کارفرما:
...
SECTION('⑤ قرارداد کلی');
T('۵.۱ cache-bust روی v34.39.5', /home\.css\?v=34\.39\.5/.test(idx) && /ptf-motion\.js\?v=34\.39\.5" defer/.test(idx));
...
DONE('tester667-v34.39.5-iconmin');
