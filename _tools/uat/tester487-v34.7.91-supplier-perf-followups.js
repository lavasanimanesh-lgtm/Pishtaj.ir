#!/usr/bin/env node
'use strict';
/* v34.37.7 — ادامه بهینه‌سازی تامین‌کنندگان:
...
T('supplier-finance.js cache-bust 34.37.7', /supplier-finance\.js\?v=34\.37\.7/.test(idx));

/* ---------- SUP-PERF-003: lazy box ---------- */
/* v34.37.7: slBoxRows پارامتر query گرفت (جست‌وجو) — همان تابع، قراردادِ گسترده‌تر */
...
/* v34.37.7 (SUP-BOX-COLLAPSED — تصمیم کارفرما): پنل پیش‌فرض بسته است، پس محاسبه
...
/* v34.37.7: «باز بودن پیش‌فرض» خودش خواستهٔ اصلاح‌شدهٔ کارفرما بود ⇒ pin وارونه شد:
...
console.log('\n— tester487 (v34.37.7: ادامه بهینه‌سازی تامین‌کنندگان — SUP-PERF-003/004) —');
