...
T('tool-licenses.js در CRM با cache-bust v31.9 لود می‌شود', idx.indexOf('tool-licenses.js?v=31.9') > -1 && idx.indexOf("window.VER = 'v31.9'") > -1 && sw.indexOf('ptf-crm-v31.9') > -1);
