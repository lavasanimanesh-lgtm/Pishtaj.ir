...
T('status API به v33.4.1 رسیده است', /'version' => 'v3[0-9.]+'/.test(api));

SECTION('CRM admin UI');
T('tool-licenses.js در CRM با cache-bust v33.4.1 لود می‌شود', /tool-licenses.js\?v=3[0-9.]+/.test(idx) && /window\.VER = 'v3[0-9.]+'/.test(idx) && /ptf-crm-v3[0-9.]+/.test(sw));
