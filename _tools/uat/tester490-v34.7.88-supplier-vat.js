#!/usr/bin/env node
'use strict';
/* v34.7.88 — فیلد ارزش افزوده فاکتور رسمی تامین‌کننده (SUP-VAT-001).
...
T('tester490 در گیت CI', gate.indexOf('tester490-v34.7.88-supplier-vat.js') > -1);

console.log('\n— tester490 (v34.7.88: فیلد ارزش افزوده فاکتور رسمی تامین‌کننده — SUP-VAT-001) —');
