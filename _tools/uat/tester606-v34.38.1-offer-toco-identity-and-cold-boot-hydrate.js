...
head('۵. انطباق نسخه v34.38.13 و نگهبان گیت');
...
T('۵.۲ شاخص رهاسازی index.html روی v34.38.13 است',
  idx.indexOf("window.PTF_CRM_RELEASE = 'v34.38.13'") > -1);
T('۵.۳ سرویس‌ورکر روی v34.38.13 است',
  sw.indexOf("RELEASE = 'v34.38.13'") > -1 && sw.indexOf("CACHE = 'ptf-crm-v34.38.13'") > -1);
T('۵.۴ مانیفست روی 34.38.13 است', JSON.parse(read('crm/manifest.json')).version === '34.38.13');
T('۵.۵ sales-domain.php روی 34.38.13 است',
  read('api/sales-domain.php').indexOf("const SD_SERVICE_VERSION = '34.38.13'") > -1);
var busts = idx.match(/\?v=([0-9.]+)/g) || [];
var badBust = busts.filter(function (b) { return b !== '?v=34.38.13'; });
T('۵.۶ همه cache-bust های index.html یکدست 34.38.13 هستند',
