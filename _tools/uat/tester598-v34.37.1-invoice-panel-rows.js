#!/usr/bin/env node
'use strict';
/* ═══ tester598 — v34.37.7 (INV-PANEL-ROWS) ═══
   خواستهٔ کارفرما:
   ...
   `crm/official-invoice-v2.js` است و `crm/rbac.js` بازنویسی می‌شود. در v34.37.7
...
/* ═══ ⑥ ارجاع ریالیِ ساده نباید «پیشنهاد ارزی با نرخ ۰» نشان دهد ═══
   ...
   برمی‌گرداند؛ پیش از v34.37.7 پنل برای یک پیشنهاد ریالی هم خط «💱 … ارزی … نرخ ۰»
...
console.log('\n— tester598 (v34.37.7: پنل ردیفی فاکتورها + کشو + قفل ثبت دوباره) —');
