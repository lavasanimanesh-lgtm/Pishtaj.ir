#!/usr/bin/env node
'use strict';
/* v34.36.0 — PHASE-C3 گام۱: تکمیل یادآورها (ثبت) + مهاجرت سرنخ‌ها به فرمان سروری.
...
T('addReminder از فرمان سروری می‌گذرد (v34.36.0: router SaveCollection با reason rem-new)', /function addReminder\(r\) \{[\s\S]{0,1400}ptfEntitySaveCollection\('ptf_crm_reminders', rems, \{ reason: 'rem-new' \}\)/.test(leads));
...
console.log('\n— tester518 (v34.36.0: PHASE-C3 گام۱ — یادآور کامل + سرنخ‌ها) —');
