#!/usr/bin/env node
'use strict';
/* v34.7.74 — نمایش فایل پیوست تامین‌کننده در فهرست تاییدشده و کارت مشاهده.
...
T('offers.js cache-bust 34.7.74', /offers\.js\?v=34\.7\.74/.test(idx));
...
console.log('\n— tester471 (v34.7.74: نمایش فایل تامین‌کننده در فهرست/کارت) —');
