#!/usr/bin/env node
'use strict';
/* v34.7.89 — ورود اجباری با توکن سرور (AUTH-TOKEN-REQUIRED).
...
T('inqreader.js cache-bust 34.7.89', /inqreader\.js\?v=34\.7\.89/.test(idx));
...
T('tester486 در گیت CI', gate.indexOf('tester486-v34.7.89-auth-token-required.js') > -1);

console.log('\n— tester486 (v34.7.89: ورود اجباری توکن سرور — AUTH-TOKEN-REQUIRED) —');
