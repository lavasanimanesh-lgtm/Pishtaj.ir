...
T('index PTF_CRM_RELEASE = v34.39.9', /window\.PTF_CRM_RELEASE = 'v34\.39\.9'/.test(idx));
T('sw RELEASE/ASSET/CACHE = 34.39.9', sw.indexOf("RELEASE = 'v34.39.9'") > -1 && sw.indexOf("ASSET_VERSION = '34.39.9'") > -1 && sw.indexOf("CACHE = 'ptf-crm-v34.39.9'") > -1);
T('shell fallback نسخه 34.39.9', shell.indexOf("'v34.39.9'") > -1);
T('manifest.version = 34.39.9', man.version === '34.39.9', man.version);
T('clear-cache VER = v34.39.9', clr.indexOf("window.VER = 'v34.39.9'") > -1 && clr.indexOf('v34.39.9') > -1);
T('sales-domain SD_SERVICE_VERSION = 34.39.9', sd.indexOf("SD_SERVICE_VERSION = '34.39.9'") > -1);
...
T('careers.js در index و SHELL بعد از cms', /cms\.js\?v=34\.39\.9/.test(idx) && /careers\.js\?v=34\.39\.9/.test(idx) && sw.indexOf("./cms.js") < sw.indexOf("./careers.js"));
