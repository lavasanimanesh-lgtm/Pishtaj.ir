#!/usr/bin/env node
'use strict';
/* v34.35.0 — فرصت شغلی سایت و CRM: PDF ۵MB، OTP+کپچا، منوی پویا، نقش ارشد */
...
T('sw RELEASE/ASSET/CACHE = 34.35.0', sw.indexOf("RELEASE = 'v34.35.0'") > -1 && sw.indexOf("ASSET_VERSION = '34.35.0'") > -1 && sw.indexOf("CACHE = 'ptf-crm-v34.35.0'") > -1);
T('shell fallback نسخه 34.35.0', shell.indexOf("'v34.35.0'") > -1);
T('manifest.version = 34.35.0', man.version === '34.35.0', man.version);
T('clear-cache VER = v34.35.0', clr.indexOf("window.VER = 'v34.35.0'") > -1 && clr.indexOf('v34.35.0') > -1);
T('sales-domain SD_SERVICE_VERSION = 34.35.0', sd.indexOf("SD_SERVICE_VERSION = '34.35.0'") > -1);
...
console.log('\n— tester452 (v34.35.0: فرصت شغلی سایت و CRM) —');
