#!/usr/bin/env node
'use strict';
/* v34.8.21 — فرصت شغلی سایت و CRM: PDF ۵MB، OTP+کپچا، منوی پویا، نقش ارشد */
...
T('index PTF_CRM_RELEASE = v34.8.21', /window\.PTF_CRM_RELEASE = 'v34\.8\.21'/.test(idx));
T('sw RELEASE/ASSET/CACHE = 34.8.21', sw.indexOf("RELEASE = 'v34.8.21'") > -1 && sw.indexOf("ASSET_VERSION = '34.8.21'") > -1 && sw.indexOf("CACHE = 'ptf-crm-v34.8.21'") > -1);
T('shell fallback نسخه 34.8.21', shell.indexOf("'v34.8.21'") > -1);
T('manifest.version = 34.8.21', man.version === '34.8.21', man.version);
T('clear-cache VER = v34.8.21', clr.indexOf("window.VER = 'v34.8.21'") > -1 && clr.indexOf('v34.8.21') > -1);
T('sales-domain SD_SERVICE_VERSION = 34.8.21', sd.indexOf("SD_SERVICE_VERSION = '34.8.21'") > -1);
...
T('careers.js در index و SHELL بعد از cms', /cms\.js\?v=34\.8\.21/.test(idx) && /careers\.js\?v=34\.8\.21/.test(idx) && sw.indexOf("./cms.js") < sw.indexOf("./careers.js"));
...
console.log('\n— tester452 (v34.8.21: فرصت شغلی سایت و CRM) —');
