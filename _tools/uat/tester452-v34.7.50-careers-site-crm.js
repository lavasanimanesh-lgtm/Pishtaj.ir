...
T('sw RELEASE/ASSET/CACHE = 34.38.1', sw.indexOf("RELEASE = 'v34.38.1'") > -1 && sw.indexOf("ASSET_VERSION = '34.38.1'") > -1 && sw.indexOf("CACHE = 'ptf-crm-v34.38.1'") > -1);
T('shell fallback نسخه 34.38.1', shell.indexOf("'v34.38.1'") > -1);
T('manifest.version = 34.38.1', man.version === '34.38.1', man.version);
T('clear-cache VER = v34.38.1', clr.indexOf("window.VER = 'v34.38.1'") > -1 && clr.indexOf('v34.38.1') > -1);
T('sales-domain SD_SERVICE_VERSION = 34.38.1', sd.indexOf("SD_SERVICE_VERSION = '34.38.1'") > -1);
...
T('careers.js در index و SHELL بعد از cms', /cms\.js\?v=34\.38\.1/.test(idx) && /careers\.js\?v=34\.38\.1/.test(idx) && sw.indexOf("./cms.js") < sw.indexOf("./careers.js"));
