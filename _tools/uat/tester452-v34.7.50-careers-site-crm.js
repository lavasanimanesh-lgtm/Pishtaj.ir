...
T('index PTF_CRM_RELEASE = v34.38.11', /window\.PTF_CRM_RELEASE = 'v34\.38\.11'/.test(idx));
T('sw RELEASE/ASSET/CACHE = 34.38.11', sw.indexOf("RELEASE = 'v34.38.11'") > -1 && sw.indexOf("ASSET_VERSION = '34.38.11'") > -1 && sw.indexOf("CACHE = 'ptf-crm-v34.38.11'") > -1);
T('shell fallback نسخه 34.38.11', shell.indexOf("'v34.38.11'") > -1);
T('manifest.version = 34.38.11', man.version === '34.38.11', man.version);
T('clear-cache VER = v34.38.11', clr.indexOf("window.VER = 'v34.38.11'") > -1 && clr.indexOf('v34.38.11') > -1);
T('sales-domain SD_SERVICE_VERSION = 34.38.11', sd.indexOf("SD_SERVICE_VERSION = '34.38.11'") > -1);
...
T('careers.js در index و SHELL بعد از cms', /cms\.js\?v=34\.38\.11/.test(idx) && /careers\.js\?v=34\.38\.11/.test(idx) && sw.indexOf("./cms.js") < sw.indexOf("./careers.js"));
