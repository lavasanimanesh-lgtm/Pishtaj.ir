#!/usr/bin/env node
'use strict';
/* v34.36.0 — فرصت شغلی سایت و CRM: PDF ۵MB، OTP+کپچا، منوی پویا، نقش ارشد */
...
T('clear-cache VER = v34.36.0', clr.indexOf("window.VER = 'v34.36.0'") > -1 && clr.indexOf('v34.36.0') > -1);
T('sales-domain SD_SERVICE_VERSION = 34.36.0', sd.indexOf("SD_SERVICE_VERSION = '34.36.0'") > -1);
...
console.log('\n— tester452 (v34.36.0: فرصت شغلی سایت و CRM) —');
