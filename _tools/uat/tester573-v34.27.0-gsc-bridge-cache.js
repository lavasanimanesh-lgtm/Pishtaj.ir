#!/usr/bin/env node
'use strict';
/* tester573 — v34.37.5: کش‌سنجی + گارد مسیر + پل سرچ کنسول
...
/* ═══ A) کش‌سنجی ═══ */
T('CACHE: نشانگر نسخهٔ فایل (PTF_CMS_JS_VER) در بارگذاری ثبت می‌شود', cms.indexOf("window.PTF_CMS_JS_VER = 'v34.37.5';") > -1);
