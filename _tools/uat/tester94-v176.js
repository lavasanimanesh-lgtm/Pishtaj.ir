...
SECTION('نسخه و ثبت');
T('نسخه v17.6+', (function(){var m=idx.match(/window.PTF_CRM_RELEASE = 'v([0-9.]+)'/);return m&&parseFloat(m[1])>=17.6;})());
T('کش sw >= v17.6 + listclean در SHELL', (function(){var m=sw.match(/var RELEASE = 'v([0-9.]+)';/);return m&&parseFloat(m[1])>=17.6;})() && sw.indexOf("'./listclean.js'") > -1);
