...
SECTION('نسخه v21.1');
T('VER v21.1+', (function(){var m=idx.match(/window.PTF_CRM_RELEASE = 'v([0-9.]+)'/);return m&&parseFloat(m[1])>=21.1;})());
T('SW cache v21.1+', (function(){var m=sw.match(/var RELEASE = 'v([0-9.]+)'/);return m&&parseFloat(m[1])>=21.1;})());
