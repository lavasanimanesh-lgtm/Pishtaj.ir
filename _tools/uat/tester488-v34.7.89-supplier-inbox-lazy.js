#!/usr/bin/env node
'use strict';
/* v34.7.89 — فعال‌سازی صفحه‌بندی get_inbox در کلاینت (SUP-PERF-005).
...
T('bridge.js cache-bust 34.7.89', /bridge\.js\?v=34\.7\.89/.test(idx));
...
T('tester488 در گیت CI', gate.indexOf('tester488-v34.7.89-supplier-inbox-lazy.js') > -1);

console.log('\n— tester488 (v34.7.89: فعال‌سازی صفحه‌بندی get_inbox در کلاینت — SUP-PERF-005) —');
