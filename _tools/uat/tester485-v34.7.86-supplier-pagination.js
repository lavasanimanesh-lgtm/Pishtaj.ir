#!/usr/bin/env node
'use strict';
/* v34.7.86 — صفحه‌بندی فهرست تامین‌کنندگان تاییدشده (SUP-PERF-002).
...
T('offers.js cache-bust 34.7.86', /offers\.js\?v=34\.7\.86/.test(idx));
...
T('tester485 در گیت CI', gate.indexOf('tester485-v34.7.86-supplier-pagination.js') > -1);

console.log('\n— tester485 (v34.7.86: صفحه‌بندی تامین‌کنندگان تاییدشده — SUP-PERF-002) —');
