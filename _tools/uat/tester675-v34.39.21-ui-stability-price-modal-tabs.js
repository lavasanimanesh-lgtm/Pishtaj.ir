/* =====================================================================
   ...
   قرارداد UI-STABILITY (v34.39.32) — ریشه‌یابی و رفع ریشه‌ای دو باگ UI:
...
console.log('\n── E: پین‌های انتشار ──');
test('E1: VERSION.json crm_version = v34.39.32', (function () {
  try { return JSON.parse(read('VERSION.json')).crm_version === 'v34.39.32'; } catch (e) { return false; }
})());
test('E2: Service Worker + PTF_CRM_RELEASE/VER بامپ شده‌اند',
  swSrc.indexOf('v34.39.32') > -1 && indexHtml.indexOf("window.PTF_CRM_RELEASE = 'v34.39.32'; window.VER = 'v34.39.32';") > -1);
test('E3: پین‌های tester674/tester621 به نسخهٔ جدید به‌روز شده‌اند',
  tester674Src.indexOf("'v34.39.32'") > -1 && read('_tools/uat/tester621-v34.38.14-archive-uniqueness-restore.js').indexOf("'v34.39.32'") > -1);
