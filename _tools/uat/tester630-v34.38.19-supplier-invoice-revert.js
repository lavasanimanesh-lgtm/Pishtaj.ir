/* tester630 — v34.38.25 (SF-INVOICE-REVERT — گزارش کارفرما: «فاکتور تأمین کم شد؛ ویرایش
...
console.log('── supplier-invoice amount revert (v34.38.25) ──');
...
console.log('PASS tester630 v34.38.25 supplier-invoice amount revert');
