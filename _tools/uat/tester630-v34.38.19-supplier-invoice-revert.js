/* tester630 — v34.39.30 (SF-INVOICE-REVERT — گزارش کارفرما: «فاکتور تأمین کم شد؛ ویرایش
...
console.log('── supplier-invoice amount revert (v34.39.30) ──');
...
console.log('PASS tester630 v34.39.30 supplier-invoice amount revert');
