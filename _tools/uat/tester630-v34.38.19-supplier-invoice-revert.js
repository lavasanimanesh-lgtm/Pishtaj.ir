/* tester630 — v34.39.7 (SF-INVOICE-REVERT — گزارش کارفرما: «فاکتور تأمین کم شد؛ ویرایش
...
console.log('── supplier-invoice amount revert (v34.39.7) ──');
...
console.log('PASS tester630 v34.39.7 supplier-invoice amount revert');
