/* tester630 — v34.39.0 (SF-INVOICE-REVERT — گزارش کارفرما: «فاکتور تأمین کم شد؛ ویرایش
...
console.log('── supplier-invoice amount revert (v34.39.0) ──');
...
console.log('PASS tester630 v34.39.0 supplier-invoice amount revert');
