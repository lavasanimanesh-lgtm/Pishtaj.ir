...
T('۴.۱ VERSION.json روی نسخه v34.38.10 است', verJson.crm_version === 'v34.38.10');
T('۴.۲ شاخص رهاسازی در index.html روی v34.38.10 است', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.38.10'") > -1);
T('۴.۳ سرویس‌ورکر روی نسخه v34.38.10 است', read('crm/sw.js').indexOf("RELEASE = 'v34.38.10'") > -1);
T('۴.۴ مانیفست روی نسخه 34.38.10 است', JSON.parse(read('crm/manifest.json')).version === '34.38.10');
T('۴.۵ sales-domain.php روی نسخه 34.38.10 است', read('api/sales-domain.php').indexOf("const SD_SERVICE_VERSION = '34.38.10'") > -1);

console.log('\n=== tester605-v34.38.10: ' + p + ' PASS / ' + f + ' FAIL ===\n');
