#!/usr/bin/env node
'use strict';
/* v34.29.1 — منطق فاکتور صوری/پوششی + چیدمان مودال ثبت فاکتور (SUP-VAT-002 / SUP-UX-002).
...
T('supplier-finance.js cache-bust 34.29.1', /supplier-finance\.js\?v=34\.29.1/.test(idx));
...
console.log('\n— tester491 (v34.29.1: منفعت پوششی + چیدمان مودال — SUP-VAT-002/SUP-UX-002) —');
