...
T('index PTF_CRM_RELEASE = v34.39.1', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.39.1'") > -1);
T('sw RELEASE = v34.39.1', sw.indexOf("RELEASE = 'v34.39.1'") > -1);
T('letters.js cache-bust 34.39.1', /letters\.js\?v=34\.39\.1/.test(idx));
