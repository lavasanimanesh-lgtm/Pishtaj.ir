...
T('index PTF_CRM_RELEASE = v34.38.20', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.38.20'") > -1);
T('sw RELEASE = v34.38.20', sw.indexOf("RELEASE = 'v34.38.20'") > -1);
T('letters.js cache-bust 34.38.20', /letters\.js\?v=34\.38\.20/.test(idx));
