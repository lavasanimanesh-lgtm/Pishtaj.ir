...
/* v34.7.60 — LETTERHEAD-PASTE-001: متن آمادهٔ Word روی سربرگ رسمی.
   v34.37.7 — LETTERHEAD-PASTE-002: شمارهٔ نامه و پیوست (اختیاری) روی سربرگ +
...
T('index PTF_CRM_RELEASE = v34.37.7', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.37.7'") > -1);
T('sw RELEASE = v34.37.7', sw.indexOf("RELEASE = 'v34.37.7'") > -1);
T('letters.js cache-bust 34.37.7', /letters\.js\?v=34\.37\.7/.test(idx));
...
/* ---------- v34.37.7: رندر سربرگ شماره/پیوست ---------- */
...
console.log('\n— tester463 (v34.37.7: شماره و پیوست + مهر صفحهٔ آخر/همهٔ صفحات) —');
