...
T('index PTF_CRM_RELEASE = v34.38.24', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.38.24'") > -1);
T('sw RELEASE = v34.38.24', sw.indexOf("RELEASE = 'v34.38.24'") > -1);
T('letters.js cache-bust 34.38.24', /letters\.js\?v=34\.38\.24/.test(idx));
