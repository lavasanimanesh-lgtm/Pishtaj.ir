...
T('index PTF_CRM_RELEASE = v34.39.23', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.39.23'") > -1);
T('sw RELEASE = v34.39.23', sw.indexOf("RELEASE = 'v34.39.23'") > -1);
T('letters.js cache-bust 34.39.23', /letters\.js\?v=34\.39\.23/.test(idx));
