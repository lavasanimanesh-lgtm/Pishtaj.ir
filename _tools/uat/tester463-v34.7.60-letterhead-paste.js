...
/* v34.7.60 — LETTERHEAD-PASTE-001: متن آمادهٔ Word روی سربرگ رسمی.
   v34.7.77 — LETTERHEAD-PASTE-002: شمارهٔ نامه و پیوست (اختیاری) روی سربرگ +
...
T('index PTF_CRM_RELEASE = v34.7.77', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.7.77'") > -1);
T('sw RELEASE = v34.7.77', sw.indexOf("RELEASE = 'v34.7.77'") > -1);
T('letters.js cache-bust 34.7.77', /letters\.js\?v=34\.7\.77/.test(idx));
...
/* ---------- v34.7.77: رندر سربرگ شماره/پیوست ---------- */
...
console.log('\n— tester463 (v34.7.77: شماره و پیوست + مهر صفحهٔ آخر/همهٔ صفحات) —');
