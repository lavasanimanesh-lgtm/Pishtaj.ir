...
T('index PTF_CRM_RELEASE = v34.39.2', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.39.2'") > -1);
T('sw RELEASE = v34.39.2', sw.indexOf("RELEASE = 'v34.39.2'") > -1);
T('letters.js cache-bust 34.39.2', /letters\.js\?v=34\.39\.2/.test(idx));
