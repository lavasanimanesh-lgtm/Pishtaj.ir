...
T('index PTF_CRM_RELEASE = v34.39.0', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.39.0'") > -1);
T('sw RELEASE = v34.39.0', sw.indexOf("RELEASE = 'v34.39.0'") > -1);
T('letters.js cache-bust 34.39.0', /letters\.js\?v=34\.39\.0/.test(idx));
