...
T('index PTF_CRM_RELEASE = v34.38.12', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.38.12'") > -1);
T('sw RELEASE = v34.38.12', sw.indexOf("RELEASE = 'v34.38.12'") > -1);
T('letters.js cache-bust 34.38.12', /letters\.js\?v=34\.38\.12/.test(idx));
