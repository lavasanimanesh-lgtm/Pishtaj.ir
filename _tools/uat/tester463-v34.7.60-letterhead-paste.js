...
/* v34.7.60 — LETTERHEAD-PASTE-001: متن آمادهٔ Word روی سربرگ رسمی.
   v34.7.73 — LETTERHEAD-PASTE-002: شمارهٔ نامه و پیوست (اختیاری) روی سربرگ +
...
T('letters.js cache-bust 34.7.73', /letters\.js\?v=34\.7\.73/.test(idx));
...
/* ---------- v34.7.73: رندر سربرگ شماره/پیوست ---------- */
...
console.log('\n— tester463 (v34.7.73: شماره و پیوست + مهر صفحهٔ آخر/همهٔ صفحات) —');
