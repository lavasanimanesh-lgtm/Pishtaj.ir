...
T('index PTF_CRM_RELEASE = v34.39.3', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.39.3'") > -1);
T('sw RELEASE = v34.39.3', sw.indexOf("RELEASE = 'v34.39.3'") > -1);
T('letters.js cache-bust 34.39.3', /letters\.js\?v=34\.39\.3/.test(idx));
