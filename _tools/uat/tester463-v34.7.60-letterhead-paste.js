...
/* v34.7.60 — LETTERHEAD-PASTE-001: متن آمادهٔ Word روی سربرگ رسمی.
   v34.7.99 — LETTERHEAD-PASTE-002: شمارهٔ نامه و پیوست (اختیاری) روی سربرگ +
...
T('letters.js cache-bust 34.7.99', /letters\.js\?v=34\.7\.99/.test(idx));
...
/* ---------- v34.7.99: رندر سربرگ شماره/پیوست ---------- */
...
console.log('\n— tester463 (v34.7.99: شماره و پیوست + مهر صفحهٔ آخر/همهٔ صفحات) —');
