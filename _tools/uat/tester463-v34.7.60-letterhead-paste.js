...
/* v34.7.60 — LETTERHEAD-PASTE-001: متن آمادهٔ Word روی سربرگ رسمی.
   v34.8.47 — LETTERHEAD-PASTE-002: شمارهٔ نامه و پیوست (اختیاری) روی سربرگ +
...
T('letters.js cache-bust 34.8.47', /letters\.js\?v=34\.8.47/.test(idx));
...
/* ---------- v34.8.47: رندر سربرگ شماره/پیوست ---------- */
...
console.log('\n— tester463 (v34.8.47: شماره و پیوست + مهر صفحهٔ آخر/همهٔ صفحات) —');
