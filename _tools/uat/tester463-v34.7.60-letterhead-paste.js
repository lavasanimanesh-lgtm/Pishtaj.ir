...
/* v34.7.60 — LETTERHEAD-PASTE-001: متن آمادهٔ Word روی سربرگ رسمی.
   v34.11.0 — LETTERHEAD-PASTE-002: شمارهٔ نامه و پیوست (اختیاری) روی سربرگ +
...
T('index PTF_CRM_RELEASE = v34.11.0', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.11.0'") > -1);
T('sw RELEASE = v34.11.0', sw.indexOf("RELEASE = 'v34.11.0'") > -1);
T('letters.js cache-bust 34.11.0', /letters\.js\?v=34\.11.0/.test(idx));
...
/* ---------- v34.11.0: رندر سربرگ شماره/پیوست ---------- */
...
console.log('\n— tester463 (v34.11.0: شماره و پیوست + مهر صفحهٔ آخر/همهٔ صفحات) —');
