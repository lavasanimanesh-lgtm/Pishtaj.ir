...
T('index PTF_CRM_RELEASE = v34.38.11', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.38.11'") > -1);
T('sw RELEASE = v34.38.11', sw.indexOf("RELEASE = 'v34.38.11'") > -1);
T('letters.js cache-bust 34.38.11', /letters\.js\?v=34\.38\.11/.test(idx));
