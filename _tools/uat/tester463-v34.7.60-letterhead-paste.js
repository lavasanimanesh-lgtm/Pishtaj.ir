...
T('index PTF_CRM_RELEASE = v34.38.25', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.38.25'") > -1);
T('sw RELEASE = v34.38.25', sw.indexOf("RELEASE = 'v34.38.25'") > -1);
T('letters.js cache-bust 34.38.25', /letters\.js\?v=34\.38\.25/.test(idx));
