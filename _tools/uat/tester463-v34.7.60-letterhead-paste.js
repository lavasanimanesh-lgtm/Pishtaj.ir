...
/* v34.7.60 — LETTERHEAD-PASTE-001: متن آمادهٔ Word روی سربرگ رسمی.
   v34.7.68 — LETTERHEAD-PASTE-002: شمارهٔ نامه و پیوست (اختیاری) روی سربرگ +
...
T('index PTF_CRM_RELEASE = v34.7.68', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.7.68'") > -1);
T('sw RELEASE = v34.7.68', sw.indexOf("RELEASE = 'v34.7.68'") > -1);
T('letters.js cache-bust 34.7.68', /letters\.js\?v=34\.7\.68/.test(idx));
...
/* ---------- v34.7.68: رندر سربرگ شماره/پیوست ---------- */
...
console.log('\n— tester463 (v34.7.68: شماره و پیوست + مهر صفحهٔ آخر/همهٔ صفحات) —');
