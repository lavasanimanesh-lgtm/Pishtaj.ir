...
T('index PTF_CRM_RELEASE = v34.38.8', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.38.8'") > -1);
T('sw RELEASE = v34.38.8', sw.indexOf("RELEASE = 'v34.38.8'") > -1);
T('letters.js cache-bust 34.38.8', /letters\.js\?v=34\.38\.8/.test(idx));
