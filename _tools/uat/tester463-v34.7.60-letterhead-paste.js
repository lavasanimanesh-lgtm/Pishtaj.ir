...
T('index PTF_CRM_RELEASE = v34.39.31', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.39.31'") > -1);
T('sw RELEASE = v34.39.31', sw.indexOf("RELEASE = 'v34.39.31'") > -1);
T('letters.js cache-bust 34.39.31', /letters\.js\?v=34\.39\.31/.test(idx));
