...
/* v34.7.60 — LETTERHEAD-PASTE-001: متن آمادهٔ Word روی سربرگ رسمی.
   v34.36.4 — LETTERHEAD-PASTE-002: شمارهٔ نامه و پیوست (اختیاری) روی سربرگ +
...
T('index PTF_CRM_RELEASE = v34.36.4', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.36.4'") > -1);
T('sw RELEASE = v34.36.4', sw.indexOf("RELEASE = 'v34.36.4'") > -1);
T('letters.js cache-bust 34.36.4', /letters\.js\?v=34\.36\.4/.test(idx));
...
/* ---------- v34.36.4: رندر سربرگ شماره/پیوست ---------- */
...
console.log('\n— tester463 (v34.36.4: شماره و پیوست + مهر صفحهٔ آخر/همهٔ صفحات) —');
