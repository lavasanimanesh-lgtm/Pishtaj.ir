...
/* v34.7.60 — LETTERHEAD-PASTE-001: متن آمادهٔ Word روی سربرگ رسمی.
   v34.8.29 — LETTERHEAD-PASTE-002: شمارهٔ نامه و پیوست (اختیاری) روی سربرگ +
...
T('index PTF_CRM_RELEASE = v34.8.29', idx.indexOf("window.PTF_CRM_RELEASE = 'v34.8.29'") > -1);
T('sw RELEASE = v34.8.29', sw.indexOf("RELEASE = 'v34.8.29'") > -1);
T('letters.js cache-bust 34.8.29', /letters\.js\?v=34\.8\.29/.test(idx));
...
/* ---------- v34.8.29: رندر سربرگ شماره/پیوست ---------- */
...
console.log('\n— tester463 (v34.8.29: شماره و پیوست + مهر صفحهٔ آخر/همهٔ صفحات) —');
