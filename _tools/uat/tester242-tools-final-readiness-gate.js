...
T('CRM نسخه v31.9 و tool-report-drafts cache-bust دارد', idx.indexOf("window.VER = 'v31.9'") > -1 && idx.indexOf('tool-report-drafts.js?v=31.9') > -1 && sw.indexOf('ptf-crm-v31.9') > -1);
