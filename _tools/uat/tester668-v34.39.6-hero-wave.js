...
T('۲.۲ cache-bust روی v34.39.8', /home\.css\?v=34\.39\.8/.test(idx) && /ptf-motion\.js\?v=34\.39\.8" defer/.test(idx));
...
T('۲.۵ VERSION.json = v34.39.8', JSON.parse(read('VERSION.json')).crm_version === 'v34.39.8');

DONE('tester668-v34.39.8-hero-wave');
