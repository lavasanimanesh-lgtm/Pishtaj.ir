#!/usr/bin/env node
'use strict';
/* tester535 — v34.8.33: فیکس «کالاها نمایش داده نمی‌شوند».
...
T('قرارداد نسخهٔ UI/sw = 34.8.33', read('crm/index.html').indexOf("window.PTF_CRM_RELEASE = 'v34.8.33'") > -1 && read('crm/sw.js').indexOf("CACHE = 'ptf-crm-v34.8.33'") > -1);

console.log('\n— tester535 (v34.8.33: products read hardening) —');
