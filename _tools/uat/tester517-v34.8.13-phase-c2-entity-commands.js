#!/usr/bin/env node
'use strict';
/* v34.8.30 — PHASE-C2: زیرساخت فرمان عمومی موجودیت (مسیر نازک نوشتن).
...
T('SD_SERVICE_VERSION = 34.8.30', /SD_SERVICE_VERSION = '34\.8\.30'/.test(api));
...
console.log('\n— tester517 (v34.8.30: PHASE-C2 فرمان عمومی موجودیت) —');
