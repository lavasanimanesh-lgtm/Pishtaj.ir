#!/usr/bin/env node
'use strict';
/* v34.9.0 — PHASE-C2: زیرساخت فرمان عمومی موجودیت (مسیر نازک نوشتن).
...
T('SD_SERVICE_VERSION = 34.9.0', /SD_SERVICE_VERSION = '34\.9.0'/.test(api));
...
console.log('\n— tester517 (v34.9.0: PHASE-C2 فرمان عمومی موجودیت) —');
