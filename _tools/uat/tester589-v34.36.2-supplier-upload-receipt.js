/* =====================================================================
   tester589 — v34.37.5 (SUP-UPLOAD-RCA): «در صفحهٔ ثبت‌نام تامین‌کنندگان فایل آپلود نمی‌شود»
   ---------------------------------------------------------------------
...
(async function () {
  ...
  await (async function () {
    ...
    /* v34.37.5 (D4): accept با allowlist سرور و ATTACH_EXT یکی شد — تصویر هم مجاز است
  ...
  /* v34.37.5: همان گارد، به‌علاوهٔ !$supWillReject — چون در مسیر duplicate اصلاً آپلودی
  ...
  /* v34.37.5 (SUP-UPLOAD-ORDER): شرط‌های بازیابی «پیش از» آپلود محاسبه می‌شوند تا در
  ...
  /* v34.37.5 (SUP-ATTACH-PHONE): تطابق شماره روی هر سه فیلدی که خودِ dedup می‌سنجد
  ...
  T('۱۰.۱ VERSION.json = v34.37.5', ver.crm_version === 'v34.37.5', ver.crm_version);
  T('۱۰.۲ tester589 در گیت CI ثبت شده است', gate.indexOf('tester589-v34.36.2-supplier-upload-receipt.js') > -1);
  T('۱۰.۳ یادداشت انتشار این نسخه موجود است', fs.existsSync('RELEASE-NOTES-v34.37.5.md'));
  ...
  console.log('\n— tester589 (v34.37.5: رسید پیوست ثبت‌نام تامین‌کننده — SUP-UPLOAD-RCA) —');
