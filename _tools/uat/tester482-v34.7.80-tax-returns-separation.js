#!/usr/bin/env node
'use strict';
/* v34.7.101 — جداسازی اظهارنامه‌ها از بخش فاکتورها + پنل مستقل «📁 اظهارنامه‌ها».
...
T('tax-returns.js cache-bust 34.7.101', /tax-returns\.js\?v=34\.7\.101/.test(idx));
...
console.log('\n— tester482 (v34.7.101: جداسازی اظهارنامه‌ها از فاکتورها + پنل مستقل) —');
