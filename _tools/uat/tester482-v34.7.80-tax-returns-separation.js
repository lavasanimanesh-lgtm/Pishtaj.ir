#!/usr/bin/env node
'use strict';
/* v34.14.0 — جداسازی اظهارنامه‌ها از بخش فاکتورها + پنل مستقل «📁 اظهارنامه‌ها».
...
T('tax-returns.js cache-bust 34.14.0', /tax-returns\.js\?v=34\.14.0/.test(idx));
...
console.log('\n— tester482 (v34.14.0: جداسازی اظهارنامه‌ها از فاکتورها + پنل مستقل) —');
