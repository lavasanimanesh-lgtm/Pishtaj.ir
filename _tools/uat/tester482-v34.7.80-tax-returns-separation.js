#!/usr/bin/env node
'use strict';
/* v34.8.8 — جداسازی اظهارنامه‌ها از بخش فاکتورها + پنل مستقل «📁 اظهارنامه‌ها».
...
T('tax-returns.js cache-bust 34.8.8', /tax-returns\.js\?v=34\.8\.8/.test(idx));
...
console.log('\n— tester482 (v34.8.8: جداسازی اظهارنامه‌ها از فاکتورها + پنل مستقل) —');
