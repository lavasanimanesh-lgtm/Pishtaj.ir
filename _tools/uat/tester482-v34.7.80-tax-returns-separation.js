#!/usr/bin/env node
'use strict';
/* v34.38.0 — جداسازی اظهارنامه‌ها از بخش فاکتورها + پنل مستقل «📁 اظهارنامه‌ها».
...
T('tax-returns.js cache-bust 34.38.25', /tax-returns\.js\?v=34\.38\.25/.test(idx));
...
/* v34.38.0: ثبت پنل‌ها از capture به دیرهنگام‌بندیِ نام‌محور (PTF_PERM_PANELS) عوض شد؛
...
console.log('\n— tester482 (v34.38.0: جداسازی اظهارنامه‌ها از فاکتورها + پنل مستقل) —');
