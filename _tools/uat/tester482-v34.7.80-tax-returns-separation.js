#!/usr/bin/env node
'use strict';
/* v34.36.4 — جداسازی اظهارنامه‌ها از بخش فاکتورها + پنل مستقل «📁 اظهارنامه‌ها».
...
T('tax-returns.js cache-bust 34.36.4', /tax-returns\.js\?v=34\.36\.4/.test(idx));
...
console.log('\n— tester482 (v34.36.4: جداسازی اظهارنامه‌ها از فاکتورها + پنل مستقل) —');
