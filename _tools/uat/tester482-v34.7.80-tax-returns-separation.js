#!/usr/bin/env node
'use strict';
/* v34.9.2 — جداسازی اظهارنامه‌ها از بخش فاکتورها + پنل مستقل «📁 اظهارنامه‌ها».
...
T('tax-returns.js cache-bust 34.9.2', /tax-returns\.js\?v=34\.9.2/.test(idx));
...
console.log('\n— tester482 (v34.9.2: جداسازی اظهارنامه‌ها از فاکتورها + پنل مستقل) —');
