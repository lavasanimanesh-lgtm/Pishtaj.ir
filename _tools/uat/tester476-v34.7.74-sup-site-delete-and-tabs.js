#!/usr/bin/env node
'use strict';
/* v34.29.6 — انتقال فهرست «ثبت‌نام‌شده از سایت» به زیر تب‌ها + حذف رکورد ثبت‌نام.
...
T('cheques.js cache-bust 34.29.6', /cheques\.js\?v=34\.29.6/.test(idx));
T('bridge.js cache-bust 34.29.6', /bridge\.js\?v=34\.29.6/.test(idx));
...
T('حذف محلی از ptf_site_suppliers (از v34.29.6/R3 از طریق لایهٔ کش ptfCache — siteCacheSet)', brg.indexOf("siteCacheSet('ptf_site_suppliers'") > -1);
...
console.log('\n— tester476 (v34.29.6: انتقال ثبت‌نام‌های سایت زیر تب‌ها + حذف رکورد) —');
