...
'use strict';
/* =============================================================================
   tester665 — v34.39.40 (HOME-NIGHT-READ + Sheet-reparent)
   گزارش کارفرما:
...
T('۴.۷ VERSION.json = v34.39.40', JSON.parse(read('VERSION.json')).crm_version === 'v34.39.40');
...
DONE('tester665-v34.39.40-night-read');
