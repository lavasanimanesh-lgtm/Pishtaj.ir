...
'use strict';
/* =============================================================================
   tester665 — v34.39.31 (HOME-NIGHT-READ + Sheet-reparent)
   گزارش کارفرما:
...
T('۴.۷ VERSION.json = v34.39.31', JSON.parse(read('VERSION.json')).crm_version === 'v34.39.31');
...
DONE('tester665-v34.39.31-night-read');
