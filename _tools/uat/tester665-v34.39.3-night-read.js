...
'use strict';
/* =============================================================================
   tester665 — v34.39.32 (HOME-NIGHT-READ + Sheet-reparent)
   گزارش کارفرما:
...
T('۴.۷ VERSION.json = v34.39.32', JSON.parse(read('VERSION.json')).crm_version === 'v34.39.32');
...
DONE('tester665-v34.39.32-night-read');
