...
'use strict';
/* =============================================================================
   tester665 — v34.39.3 (HOME-NIGHT-READ + Sheet-reparent)
   گزارش کارفرما:
...
SECTION('④ قرارداد کلی');
T('۴.۱ cache-bust: home.css و ptf-motion روی v34.39.3',
...
T('۴.۷ VERSION.json = v34.39.3', JSON.parse(read('VERSION.json')).crm_version === 'v34.39.3');
...
DONE('tester665-v34.39.3-night-read');
