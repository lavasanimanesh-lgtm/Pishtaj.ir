...
'use strict';
/* =============================================================================
   tester665 — v34.39.9 (HOME-NIGHT-READ + Sheet-reparent)
   گزارش کارفرما:
...
SECTION('④ قرارداد کلی');
T('۴.۱ cache-bust: home.css و ptf-motion روی v34.39.9',
...
T('۴.۷ VERSION.json = v34.39.9', JSON.parse(read('VERSION.json')).crm_version === 'v34.39.9');
...
DONE('tester665-v34.39.9-night-read');
