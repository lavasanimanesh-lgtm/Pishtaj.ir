...
'use strict';
/* =============================================================================
   tester665 — v34.39.8 (HOME-NIGHT-READ + Sheet-reparent)
   گزارش کارفرما:
...
T('۲.۴ بقیهٔ حلقه‌ها (CTA/فایندر/دکمه‌ها) دست‌نخورده‌اند',
  /animation:ptfCurS 8s linear infinite/.test(home) && /animation:ptfCurS 5s linear infinite/.test(home));
...
SECTION('④ قرارداد کلی');
T('۴.۱ cache-bust: home.css و ptf-motion روی v34.39.8',
...
T('۴.۷ VERSION.json = v34.39.8', JSON.parse(read('VERSION.json')).crm_version === 'v34.39.8');
...
DONE('tester665-v34.39.8-night-read');
