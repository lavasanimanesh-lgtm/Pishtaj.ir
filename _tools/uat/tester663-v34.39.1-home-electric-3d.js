...
'use strict';
/* =============================================================================
   tester663 — v34.39.32 (HOME-ELECTRIC-3D)
   دستور کارفرما:
...
T('۲.۳ داک پنج‌تایی (خانه جای خود را به منو داد) — RFQ وسط بازگشت (v34.39.32)', (function () {
...
T('۲.۴ منو اسلات اول، استعلام وسط (dock-cta) و مروف ✕ روی همان دکمه (v34.39.32)',
...
SECTION('۳. روز/شب');
T('۳.۱ کلید تم از هدر حذف و داخل منو (#mainNav) نشسته، با aria-pressed و برچسب tt-txt (v34.39.32)',
...
T('۵.۶ VERSION.json = v34.39.32', JSON.parse(read('VERSION.json')).crm_version === 'v34.39.32');
...
DONE('tester663-v34.39.32-home-electric-3d');
