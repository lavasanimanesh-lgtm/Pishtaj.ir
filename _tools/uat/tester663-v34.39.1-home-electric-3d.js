...
'use strict';
/* =============================================================================
   tester663 — v34.39.10 (HOME-ELECTRIC-3D)
   دستور کارفرما:
...
T('۲.۳ داک پنج‌تایی (خانه جای خود را به منو داد) — RFQ وسط بازگشت (v34.39.10)', (function () {
...
T('۲.۴ منو اسلات اول، استعلام وسط (dock-cta) و مروف ✕ روی همان دکمه (v34.39.10)',
...
SECTION('۳. روز/شب');
T('۳.۱ کلید تم از هدر حذف و داخل منو (#mainNav) نشسته، با aria-pressed و برچسب tt-txt (v34.39.10)',
...
T('۵.۱ cache-bust: home.css و ptf-motion روی v34.39.10',
  /home\.css\?v=34\.39\.10/.test(idx) && /ptf-motion\.js\?v=34\.39\.10" defer/.test(idx));
...
DONE('tester663-v34.39.10-home-electric-3d');
