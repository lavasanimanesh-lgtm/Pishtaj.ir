...
T('پیام علت در Storage Meter — نسخهٔ مبسوط در v33.22.2 به راهنمای کوتاه کاربرمحور ساده شد (دیتابیس MySQL فعال است)', bak.indexOf('فقط کش دستگاه شما پر شده') > -1 && bak.indexOf('اگر «پاک‌سازی امن» و «مهاجرت» حجم را کم نکردند') === -1);
