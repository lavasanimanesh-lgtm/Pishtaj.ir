...
SECTION('نسخه و ثبت');
T('نسخه v19.2+', (function () { var m = idx.match(/window.PTF_CRM_RELEASE = 'v([0-9.]+)'/); return m && parseFloat(m[1]) >= 19.2; })());
T('کش sw >= v19.2', (function () { var m = sw.match(/var RELEASE = 'v([0-9.]+)'/); return m && parseFloat(m[1]) >= 19.2; })());
