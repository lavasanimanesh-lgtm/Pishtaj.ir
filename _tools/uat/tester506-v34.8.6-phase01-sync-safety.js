/* tester506 — v34.8.27/F0-1: Phase-B single transport, financial projection safety
...
console.log('PASS tester506 v34.8.27 phase01 sync safety');
...
function clientContext() {
  ...
  var c = {
    ...
    /* v34.8.27 (T3-3): صف آفلاین حالا روی IDB است — استور کوچک برای تست */
    _idb: {},
...
(async function () {
  ...
  /* v34.8.27: صف روی IDB — seed از LS هنوز انجام نشده است (اولین flush همین است) */
