...
T('index PTF_CRM_RELEASE = v34.39.32 (با کوتیشن)', /window\.PTF_CRM_RELEASE = 'v34\.39\.32'/.test(idx));
T('sw.js RELEASE/CACHE = v34.39.32', /RELEASE = 'v34\.39\.32'/.test(sw) && /CACHE = 'ptf-crm-v34\.39\.32'/.test(sw));
