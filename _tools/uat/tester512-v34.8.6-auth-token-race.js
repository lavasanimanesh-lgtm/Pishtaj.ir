#!/usr/bin/env node
'use strict';
/* v34.8.9 — AUTH-TOKEN-RACE / AUTH-LOGOUT-REVOKE / AUTH-401-HYGIENE.
...
T('index PTF_CRM_RELEASE = v34.8.9 (با کوتیشن)', /window\.PTF_CRM_RELEASE = 'v34\.8\.9'/.test(idx));
T('sw.js RELEASE/CACHE = v34.8.9', /RELEASE = 'v34\.8\.9'/.test(sw) && /CACHE = 'ptf-crm-v34\.8\.9'/.test(sw));
...
console.log('\n— tester512 (v34.8.9: ریشه‌یابی حلقهٔ «توکن معتبر وجود ندارد») —');
