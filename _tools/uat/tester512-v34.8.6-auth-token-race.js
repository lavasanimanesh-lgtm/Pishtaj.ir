...
T('index PTF_CRM_RELEASE = v34.38.25 (با کوتیشن)', /window\.PTF_CRM_RELEASE = 'v34\.38\.25'/.test(idx));
T('sw.js RELEASE/CACHE = v34.38.25', /RELEASE = 'v34\.38\.25'/.test(sw) && /CACHE = 'ptf-crm-v34\.38\.25'/.test(sw));
