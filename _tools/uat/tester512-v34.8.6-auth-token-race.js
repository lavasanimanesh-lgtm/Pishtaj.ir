...
T('index PTF_CRM_RELEASE = v34.39.21 (با کوتیشن)', /window\.PTF_CRM_RELEASE = 'v34\.39\.21'/.test(idx));
T('sw.js RELEASE/CACHE = v34.39.21', /RELEASE = 'v34\.39\.21'/.test(sw) && /CACHE = 'ptf-crm-v34\.39\.21'/.test(sw));
