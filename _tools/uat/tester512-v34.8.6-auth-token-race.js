#!/usr/bin/env node
'use strict';
/* v34.8.36 — AUTH-TOKEN-RACE / AUTH-LOGOUT-REVOKE / AUTH-401-HYGIENE.
...
T('index PTF_CRM_RELEASE = v34.8.36 (با کوتیشن)', /window\.PTF_CRM_RELEASE = 'v34\.8\.36'/.test(idx));
T('sw.js RELEASE/CACHE = v34.8.36', /RELEASE = 'v34\.8\.36'/.test(sw) && /CACHE = 'ptf-crm-v34\.8\.36'/.test(sw));
...
console.log('\n— tester512 (v34.8.36: ریشه‌یابی حلقهٔ «توکن معتبر وجود ندارد») —');
