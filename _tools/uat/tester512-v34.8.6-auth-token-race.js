...
T('index PTF_CRM_RELEASE = v34.39.31 (با کوتیشن)', /window\.PTF_CRM_RELEASE = 'v34\.39\.31'/.test(idx));
T('sw.js RELEASE/CACHE = v34.39.31', /RELEASE = 'v34\.39\.31'/.test(sw) && /CACHE = 'ptf-crm-v34\.39\.31'/.test(sw));
