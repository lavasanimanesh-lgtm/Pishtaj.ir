...
T('index PTF_CRM_RELEASE = v34.39.5 (با کوتیشن)', /window\.PTF_CRM_RELEASE = 'v34\.39\.5'/.test(idx));
T('sw.js RELEASE/CACHE = v34.39.5', /RELEASE = 'v34\.39\.5'/.test(sw) && /CACHE = 'ptf-crm-v34\.39\.5'/.test(sw));
