...
T('index PTF_CRM_RELEASE = v34.39.3 (با کوتیشن)', /window\.PTF_CRM_RELEASE = 'v34\.39\.3'/.test(idx));
T('sw.js RELEASE/CACHE = v34.39.3', /RELEASE = 'v34\.39\.3'/.test(sw) && /CACHE = 'ptf-crm-v34\.39\.3'/.test(sw));
