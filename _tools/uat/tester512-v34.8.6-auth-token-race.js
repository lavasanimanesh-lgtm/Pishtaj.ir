...
T('index PTF_CRM_RELEASE = v34.38.20 (با کوتیشن)', /window\.PTF_CRM_RELEASE = 'v34\.38\.20'/.test(idx));
T('sw.js RELEASE/CACHE = v34.38.20', /RELEASE = 'v34\.38\.20'/.test(sw) && /CACHE = 'ptf-crm-v34\.38\.20'/.test(sw));
