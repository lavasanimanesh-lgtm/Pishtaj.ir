...
T('index PTF_CRM_RELEASE = v34.39.4 (با کوتیشن)', /window\.PTF_CRM_RELEASE = 'v34\.39\.4'/.test(idx));
T('sw.js RELEASE/CACHE = v34.39.4', /RELEASE = 'v34\.39\.4'/.test(sw) && /CACHE = 'ptf-crm-v34\.39\.4'/.test(sw));
