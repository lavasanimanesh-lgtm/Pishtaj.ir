...
T('index PTF_CRM_RELEASE = v34.39.22 (با کوتیشن)', /window\.PTF_CRM_RELEASE = 'v34\.39\.22'/.test(idx));
T('sw.js RELEASE/CACHE = v34.39.22', /RELEASE = 'v34\.39\.22'/.test(sw) && /CACHE = 'ptf-crm-v34\.39\.22'/.test(sw));
