...
T('index PTF_CRM_RELEASE = v34.39.40 (با کوتیشن)', /window\.PTF_CRM_RELEASE = 'v34\.39\.40'/.test(idx));
T('sw.js RELEASE/CACHE = v34.39.40', /RELEASE = 'v34\.39\.40'/.test(sw) && /CACHE = 'ptf-crm-v34\.39\.40'/.test(sw));
