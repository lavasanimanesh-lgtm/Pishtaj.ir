#!/usr/bin/env node
'use strict';
/* v34.34.0 — خود-تشخیص همگام‌سازی (SYNC-DIAG-001).
...
T('sync.js cache-bust 34.34.0', /sync\.js\?v=34\.34.0/.test(idx));
T('backup.js cache-bust 34.34.0', /backup\.js\?v=34\.34.0/.test(idx));
...
console.log('\n— tester484 (v34.34.0: خود-تشخیص همگام‌سازی — SYNC-DIAG-001) —');
