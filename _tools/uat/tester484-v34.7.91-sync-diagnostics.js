#!/usr/bin/env node
'use strict';
/* v34.7.96 — خود-تشخیص همگام‌سازی (SYNC-DIAG-001).
...
T('sync.js cache-bust 34.7.96', /sync\.js\?v=34\.7\.96/.test(idx));
T('backup.js cache-bust 34.7.96', /backup\.js\?v=34\.7\.96/.test(idx));
...
console.log('\n— tester484 (v34.7.96: خود-تشخیص همگام‌سازی — SYNC-DIAG-001) —');
