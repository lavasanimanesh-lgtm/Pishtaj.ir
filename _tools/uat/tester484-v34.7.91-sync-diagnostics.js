#!/usr/bin/env node
'use strict';
/* v34.37.3 — خود-تشخیص همگام‌سازی (SYNC-DIAG-001).
...
T('sync.js cache-bust 34.37.3', /sync\.js\?v=34\.37\.3/.test(idx));
T('backup.js cache-bust 34.37.3', /backup\.js\?v=34\.37\.3/.test(idx));
...
console.log('\n— tester484 (v34.37.3: خود-تشخیص همگام‌سازی — SYNC-DIAG-001) —');
