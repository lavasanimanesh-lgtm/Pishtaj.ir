#!/usr/bin/env node
'use strict';
/* v34.29.2 — خود-تشخیص همگام‌سازی (SYNC-DIAG-001).
...
T('sync.js cache-bust 34.29.2', /sync\.js\?v=34\.29.2/.test(idx));
T('backup.js cache-bust 34.29.2', /backup\.js\?v=34\.29.2/.test(idx));
...
console.log('\n— tester484 (v34.29.2: خود-تشخیص همگام‌سازی — SYNC-DIAG-001) —');
