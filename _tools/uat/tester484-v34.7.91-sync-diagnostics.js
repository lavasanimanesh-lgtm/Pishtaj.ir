#!/usr/bin/env node
'use strict';
/* v34.7.91 — خود-تشخیص همگام‌سازی (SYNC-DIAG-001).
...
T('sync.js cache-bust 34.7.91', /sync\.js\?v=34\.7\.91/.test(idx));
T('backup.js cache-bust 34.7.91', /backup\.js\?v=34\.7\.91/.test(idx));
...
console.log('\n— tester484 (v34.7.91: خود-تشخیص همگام‌سازی — SYNC-DIAG-001) —');
