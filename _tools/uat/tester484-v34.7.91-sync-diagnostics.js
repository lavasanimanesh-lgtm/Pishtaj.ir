#!/usr/bin/env node
'use strict';
/* v34.38.0 — خود-تشخیص همگام‌سازی (SYNC-DIAG-001).
...
T('sync.js cache-bust 34.39.10', /sync\.js\?v=34\.39\.10/.test(idx));
T('backup.js cache-bust 34.39.10', /backup\.js\?v=34\.39\.10/.test(idx));
...
console.log('\n— tester484 (v34.38.0: خود-تشخیص همگام‌سازی — SYNC-DIAG-001) —');
