#!/usr/bin/env node
'use strict';
/* v34.8.15 — خود-تشخیص همگام‌سازی (SYNC-DIAG-001).
...
T('sync.js cache-bust 34.8.15', /sync\.js\?v=34\.8\.15/.test(idx));
T('backup.js cache-bust 34.8.15', /backup\.js\?v=34\.8\.15/.test(idx));
...
console.log('\n— tester484 (v34.8.15: خود-تشخیص همگام‌سازی — SYNC-DIAG-001) —');
