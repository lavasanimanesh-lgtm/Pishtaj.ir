#!/usr/bin/env node
'use strict';
/* v34.26.1 — خود-تشخیص همگام‌سازی (SYNC-DIAG-001).
...
T('sync.js cache-bust 34.26.1', /sync\.js\?v=34\.26.1/.test(idx));
T('backup.js cache-bust 34.26.1', /backup\.js\?v=34\.26.1/.test(idx));
...
console.log('\n— tester484 (v34.26.1: خود-تشخیص همگام‌سازی — SYNC-DIAG-001) —');
