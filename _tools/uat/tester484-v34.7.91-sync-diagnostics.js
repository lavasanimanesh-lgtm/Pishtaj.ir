#!/usr/bin/env node
'use strict';
/* v34.8.36 — خود-تشخیص همگام‌سازی (SYNC-DIAG-001).
...
T('sync.js cache-bust 34.8.36', /sync\.js\?v=34\.8\.36/.test(idx));
T('backup.js cache-bust 34.8.36', /backup\.js\?v=34\.8\.36/.test(idx));
...
console.log('\n— tester484 (v34.8.36: خود-تشخیص همگام‌سازی — SYNC-DIAG-001) —');
