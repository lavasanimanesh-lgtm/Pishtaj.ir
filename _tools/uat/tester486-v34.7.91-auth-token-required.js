#!/usr/bin/env node
'use strict';
/* v34.8.15 — ورود اجباری با توکن سرور (AUTH-TOKEN-REQUIRED).
...
T('inqreader.js cache-bust 34.8.15', /inqreader\.js\?v=34\.8\.15/.test(idx));
...
console.log('\n— tester486 (v34.8.15: ورود اجباری توکن سرور — AUTH-TOKEN-REQUIRED) —');
