#!/usr/bin/env node
'use strict';
/* v34.7.92 — ورود اجباری با توکن سرور (AUTH-TOKEN-REQUIRED).
...
T('inqreader.js cache-bust 34.7.92', /inqreader\.js\?v=34\.7\.92/.test(idx));
...
console.log('\n— tester486 (v34.7.92: ورود اجباری توکن سرور — AUTH-TOKEN-REQUIRED) —');
