#!/usr/bin/env node
'use strict';
/* v34.7.100 — ورود اجباری با توکن سرور (AUTH-TOKEN-REQUIRED).
...
T('inqreader.js cache-bust 34.7.100', /inqreader\.js\?v=34\.7\.100/.test(idx));
...
console.log('\n— tester486 (v34.7.100: ورود اجباری توکن سرور — AUTH-TOKEN-REQUIRED) —');
