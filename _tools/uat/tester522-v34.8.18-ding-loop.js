#!/usr/bin/env node
'use strict';
/* tester522 — v34.8.18 (DING-LOOP): پایان «دینگ هر چند ثانیه + 🔄 N بخش از دستگاه
   دیگر به‌روز شد».

   گزارش کارفرما پس از v34.8.18: تکرار کارت قطع شد ولی دینگ و پیام pull ادامه داشت.
...
(function behavior() {
  ...
  var checkSrc = extract(/\/\* v34\.8\.18 \(DING-LOOP\)/, /\/\* v34\.8\.1[78] \(CARTABLE-LOOP\): خودترمیم/);
