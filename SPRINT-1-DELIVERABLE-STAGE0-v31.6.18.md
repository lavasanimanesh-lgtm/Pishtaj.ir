...
- `node --check crm/oppo.js`, `salesfiles.js`, `offers.js`, `procurement-link.js`, `surplus.js`, `backup.js`: PASS
...
| regression evidence | PASS — ۱۵۰ فایل، ۳۷۲۶ چک، صفر FAIL |
...
## الحاقیه hardening backup v31.6.18
