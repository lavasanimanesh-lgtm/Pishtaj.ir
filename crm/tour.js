...
(function () {
  ...
  var DESC = {
    ...
    cart: { t: 'کارتابل من', d: 'فقط کارهایی که اقدام شما لازم است اینجاست — عدد قرمز یعنی مورد باز دارید.' },
  ...
  var MNV_STEPS = [
    ...
    { tab: 'cart', t: 'کارتابل', d: 'فقط اقدام‌های باز شما — خبرهای ثبت و تایید اینجا نمی‌آیند.' },
