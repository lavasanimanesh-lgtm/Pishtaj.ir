...
(function () {
  ...
  var URGENT_SYNC_KEYS = [
    ...
    'ptf_crm_shareholders', 'ptf_crm_sharetx', 'ptf_crm_personnel', 'ptf_crm_personnel_tx', 'ptf_crm_offers', 'ptf_crm_deals',
  ...
  window.ptfSyncMergeServerProjection = function (key, localStr, remoteStr) {
    if (key !== 'ptf_crm_sharetx' && key !== 'ptf_crm_shareholders' && key !== 'ptf_crm_personnel' && key !== 'ptf_crm_personnel_tx') return remoteStr;
