...
(function () {
  ...
  window.ptfSyncKrevs = krevs; /* v34.39.40 (CONTACT-SYNC-DIAG-2 / A10): دسترسی عمومی فقط‌خواندنی به نقشهٔ rev ها از لایهٔ داده — UI (مثل contact-sync-diag) دیگر LS را مستقیم نمی‌خواند */
