...
/* v34.7.68: نگاشت توکن فونت → پشتهٔ CSS واقعی (برای ابزار قالب‌بندی و چاپ) */
...
/* v34.7.68: پاک‌سازی ایمن استایل inline — فقط ویژگی‌های تایپوگرافی امن حفظ می‌شوند */
...
/* ===== v34.7.68 LETTER-FORMAT-001: قالب‌بندی حرفه‌ای متن نامه =====
...
/* ===== v34.7.68: همان قالب‌بندی نامهٔ صادره برای «متن آماده روی سربرگ» =====
...
function letPrintObj(l, isPreview) {
  ...
  /* v34.7.68: فاصلهٔ خطوط، فونت و حاشیهٔ قابل تنظیم (کل نامه) */
  var lh = s.lh || 2.1;
...
window.ptfLetterheadPastePrint = function () {
  ...
  /* v34.7.68: تنظیمات دستی قالب (فونت/اندازه/فاصلهٔ خطوط/چینش/بولد/ایتالیک/حاشیه) */
  var fs = ((document.getElementById('lhpFs') || {}).value || '');
  var lh = ((document.getElementById('lhpLh') || {}).value || '');
