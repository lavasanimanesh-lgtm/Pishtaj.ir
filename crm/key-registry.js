...
(function () {
  ...
  var DEV = ['ptf_autodraft_offer_', 'ptf_code_tmp_queue', 'ptf_code_duplicate_plan', 'ptf_code_duplicate_ack', 'ptf_sales_command_not_committed_', 'ptf_sales_command_recovered_', 'ptf_sales_command_uncertain_', 'ptf_offer_post_ack_warning_', 'ptf_personal_cheques_', 'sigRecovery_', 'ptf_backup_local', 'ptf_backup_prerestore', 'ptf_tour_done_', 'ptf_tour_mnv_done_', 'ptf_crm_prefs_'];
