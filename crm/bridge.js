...
(function () {
  ...
  var SITE_SUP_PAGE = 50; /* v34.7.87/86 (SUP-PERF-004): اندازهٔ صفحهٔ سروری صندوق سایت */
  ...
  window.syncServerInbox = function (cb) {
    ...
    /* v34.7.81 (SUP-PERF-001): کلاینت آخرین امضای صندوق را می‌فرستد؛ وقتی داده‌ها
       ...
       v34.7.87 (SUP-PERF-005): بوت/پول فقط صفحهٔ اول (۵۰) suppliers را می‌گیرد و
  ...
  window.renderSupPending = function () {
    ...
    var totalAll = siteSupTotal() || all.length; /* v34.7.87 (SUP-PERF-005): تعداد کل سروری، نه فقط لودشده */
  ...
  window.supPendingMore = function () {
    /* v34.7.87 (SUP-PERF-005): اگر هنوز کل رکوردها از سرور لود نشده، صفحهٔ بعدی را
