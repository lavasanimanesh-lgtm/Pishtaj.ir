...
(function () {
  'use strict';
  function ptfGoLiveAuthHeaders(json) { var h = json ? { 'Content-Type': 'application/json' } : {}; try { h['X-CRM-Role'] = curRole(); var t = localStorage.getItem('ptf_crm_token'); if (t) h['X-CRM-Token'] = t; } catch (e) {} return h; }
  ...
  var WIPE_KEYS = [
    ...
    'ptf_crm_invoices', 'ptf_crm_petty', 'ptf_crm_petty_tx', 'ptf_crm_petty_periods', 'ptf_crm_sharetx', 'ptf_crm_fiscal_snapshots','ptf_crm_management_actions', 'ptf_crm_opex', 'ptf_crm_supplier_finance', 'ptf_crm_cheques',
