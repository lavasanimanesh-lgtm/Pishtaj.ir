...
(function () {
  ...
  function finIcon(kind) {
    var p = {
      ...
      personnel: '<rect x="3" y="5" width="18" height="14" rx="2"/><circle cx="9" cy="10.5" r="2"/><path d="M5.5 16c.5-1.8 2-3 3.5-3s3 1.2 3.5 3M14 9.5h5M14 13h5"/>',
  ...
  window.finHubApply = function () {
    ...
    show('personnelBox', t === 'personnel');
    if (t === 'personnel' && typeof window.ptfPersonnelRefresh === 'function') window.ptfPersonnelRefresh();
    show('fiscalBox', t === 'fiscal');
    /* v34.7.91 (VAT-LEDGER-001): باکس «ارزش افزوده فصلی» + تنظیم نرخ مصوب سال.
  ...
  window.finHubOrder = function () {
    try {
      ...
      var ids = ['opexBox', 'slLiquidity', 'ptToolbar', 'ptAccount', 'ptPeriods', 'ptSummary', 'ptWrap',
        'shareBox', 'personnelBox', 'fiscalBox', 'ptfTaxPlannerBox', 'vatBox', 'slFinanceHubBox', 'cfFinanceHubBox', 'wcFinanceHubBox',
  ...
  function hook() {
    ...
    window.buildPetty = function () { return bar() + _bp() + (typeof window.ptfLedgerReportHtml === 'function' ? window.ptfLedgerReportHtml() : '') + (typeof window.ptfTreasuryHtml === 'function' ? window.ptfTreasuryHtml() : '') + (typeof window.ptfCommissionHtml === 'function' ? window.ptfCommissionHtml() : '') + (typeof window.ptfPersonnelHtml === 'function' ? window.ptfPersonnelHtml() : '') + (typeof ptfDataQualityHtml === 'function' ? ptfDataQualityHtml() : '') + (typeof window.ptfChequePanelHtml === 'function' ? window.ptfChequePanelHtml() : '') + (typeof window.ptfVatQuarterlyHtml === 'function' ? window.ptfVatQuarterlyHtml() : ''); };
