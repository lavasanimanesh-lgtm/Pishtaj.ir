...
var SHELL = [
  ...
  './client-server.js', './settings-accordion.js', './mobile-actions.js', './mobile-table-labels.js', './storage-quota.js', './tool-feedback.js', './tool-licenses.js', './tool-report-drafts.js', './unofficial-invoice.js',
  './manifest.json',
