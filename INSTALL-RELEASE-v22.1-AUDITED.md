# Install Guide — v22.1 Audited Flat Package
...
7. Confirm the visible version badge shows:
   - `v22.1`
8. Open AI Workbench and confirm the new default tab exists:
   - `🧠 دستیار فنی`
...
## Notes
- This release includes the **AI Technical Assistant Foundation** only.
- It does **not** yet generate final Technical Proposal outputs.
- It does **not** yet execute engineering calculations.
