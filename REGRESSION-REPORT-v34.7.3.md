# گزارش رگرسیون کامل — v34.7.3

**تاریخ اجرا:** 2026-08-15T11:23:27.459Z
**نسخه کد:** v34.7.3
...
⚠️ **بدهی تاریخی سوئیت کامل پابرجاست؛ نسبت به baseline v34.7.2 شکست جدیدی ایجاد نشده است. گیت متمرکز ریلیز مستقل و سبز است.**

## تعهد بعدی

گیت متمرکز v34.7.3 (`run-ci-gate.js`) باید 27/27 سبز بماند؛ FAILهای تاریخی سوئیت کامل جداگانه باید نوسازی شوند.