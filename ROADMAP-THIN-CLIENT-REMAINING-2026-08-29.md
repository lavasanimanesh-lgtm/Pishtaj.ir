...
- **مشاهدهٔ پروداکشن (۲۰۲۶-۰۸-۳۰، → v34.9.1):** نوار قرمز writeFailures روی موبایلِ سبز — فقط کلید ptf_crm_audit ناموفق (زنجیرهٔ E5 صادقانه کار کرد؛ کلید کسب‌وکاری شکست نخورد). الگوی بهسازی: audit لاگِ هرس‌پذیر است و نباید کاربر را با بنر قرمز بترساند — در شکست نوشتن، compact تهاجمی خودش (مثلاً هرس به ۲۰۰ ردیف) + retry، و بنر قرمز فقط برای کلیدهای کسب‌وکاری.
